...
int main(int argn, char* argv[]) {
  ...
  14:	7e858593          	addi	a1,a1,2024 # 7f8 <malloc+0xe8>
  18:	4509                	li	a0,2
  1a:	00000097          	auipc	ra,0x0
  1e:	60a080e7          	jalr	1546(ra) # 624 <fprintf>
    exit(1);
  22:	4505                	li	a0,1
  24:	00000097          	auipc	ra,0x0
  28:	2a6080e7          	jalr	678(ra) # 2ca <exit>
  }
  ...
  3c:	7e050513          	addi	a0,a0,2016 # 818 <malloc+0x108>
  40:	00000097          	auipc	ra,0x0
  44:	612080e7          	jalr	1554(ra) # 652 <printf>
  sleep(sleepNum);
  48:	8526                	mv	a0,s1
  4a:	00000097          	auipc	ra,0x0
  4e:	310080e7          	jalr	784(ra) # 35a <sleep>
  exit(0);
  52:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3c2:	48a50513          	addi	a0,a0,1162 # 848 <digits>
 3c6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 48e:	3beb8b93          	addi	s7,s7,958 # 848 <digits>
 ...
 5ce:	27690913          	addi	s2,s2,630 # 840 <malloc+0x130>
        while(*s != 0){
...
free(void *ap)
{
 ...
 696:	1ce7b783          	ld	a5,462(a5) # 860 <freep>
 ...
 6c4:	00e6ea63          	bltu	a3,a4,6d8 <free+0x50>
{
 ...
 706:	14f73f23          	sd	a5,350(a4) # 860 <freep>
}
 70a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 738:	12c53503          	ld	a0,300(a0) # 860 <freep>
 ...
 760:	10490913          	addi	s2,s2,260 # 860 <freep>
  if(p == (char*)-1)
 764:	5afd                	li	s5,-1
 766:	a88d                	j	7d8 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 768:	00000797          	auipc	a5,0x0
 76c:	10078793          	addi	a5,a5,256 # 868 <base>
 770:	00000717          	auipc	a4,0x0
 774:	0ef73823          	sd	a5,240(a4) # 860 <freep>
 778:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 79a:	0ca73523          	sd	a0,202(a4) # 860 <freep>
      return (void*)(p + 1);
