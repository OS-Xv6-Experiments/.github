...
00000000000011b2 <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    1270:	ed478793          	addi	a5,a5,-300 # 8140 <malloc+0x24b2>
...
0000000000002cdc <sbrk8000>:
{
  ...
  *(top-1) = *(top-1) + 1;
    2cfc:	fff54783          	lbu	a5,-1(a0) # ffffffff7fffffff <__BSS_END__+0xffffffff7fff1257>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    53c8:	d9c78793          	addi	a5,a5,-612 # 8160 <malloc+0x24d2>
    53cc:	bd040713          	addi	a4,s0,-1072
    53d0:	00003317          	auipc	t1,0x3
    53d4:	18030313          	addi	t1,t1,384 # 8550 <malloc+0x28c2>
  ...
  if(fail){
    ...
    557a:	bea78793          	addi	a5,a5,-1046 # 8160 <malloc+0x24d2>
    557e:	bd040713          	addi	a4,s0,-1072
    5582:	00003317          	auipc	t1,0x3
    5586:	fce30313          	addi	t1,t1,-50 # 8550 <malloc+0x28c2>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5b46:	bdf9                	j	5a24 <vprintf+0x60>
          s = "(null)";
    5b48:	00003917          	auipc	s2,0x3
    5b4c:	a0890913          	addi	s2,s2,-1528 # 8550 <malloc+0x28c2>
        while(*s != 0){
