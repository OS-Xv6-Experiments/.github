...
main(int argc, char *argv[])
{
  ...
  12:	7da50513          	addi	a0,a0,2010 # 7e8 <malloc+0xea>
  16:	00000097          	auipc	ra,0x0
  1a:	08c080e7          	jalr	140(ra) # a2 <strlen>
  1e:	0005061b          	sext.w	a2,a0
  22:	00000597          	auipc	a1,0x0
  26:	7c658593          	addi	a1,a1,1990 # 7e8 <malloc+0xea>
  2a:	4509                	li	a0,2
  2c:	00000097          	auipc	ra,0x0
  30:	2bc080e7          	jalr	700(ra) # 2e8 <write>
  ...
  3a:	292080e7          	jalr	658(ra) # 2c8 <exit>
    }
    // 把字符串型参数转换为整型
    int time = atoi(argv[1]);
  3e:	6588                	ld	a0,8(a1)
  40:	00000097          	auipc	ra,0x0
  44:	18c080e7          	jalr	396(ra) # 1cc <atoi>
    // 调用系统调用 sleep 函数，传入整型参数
    sleep(time);
  48:	00000097          	auipc	ra,0x0
  4c:	310080e7          	jalr	784(ra) # 358 <sleep>
    // 正常退出程序
    exit(0);
  50:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b0:	45c50513          	addi	a0,a0,1116 # 808 <digits>
 3b4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 47c:	390b8b93          	addi	s7,s7,912 # 808 <digits>
 ...
 5bc:	24890913          	addi	s2,s2,584 # 800 <malloc+0x102>
        while(*s != 0){
...
free(void *ap)
{
 ...
 684:	1a07b783          	ld	a5,416(a5) # 820 <freep>
 ...
 6b2:	00e6ea63          	bltu	a3,a4,6c6 <free+0x50>
{
 ...
 6f4:	12f73823          	sd	a5,304(a4) # 820 <freep>
}
 6f8:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 726:	0fe53503          	ld	a0,254(a0) # 820 <freep>
 ...
 74e:	0d690913          	addi	s2,s2,214 # 820 <freep>
  if(p == (char*)-1)
 752:	5afd                	li	s5,-1
 754:	a88d                	j	7c6 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 756:	00000797          	auipc	a5,0x0
 75a:	0d278793          	addi	a5,a5,210 # 828 <base>
 75e:	00000717          	auipc	a4,0x0
 762:	0cf73123          	sd	a5,194(a4) # 820 <freep>
 766:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 788:	08a73e23          	sd	a0,156(a4) # 820 <freep>
      return (void*)(p + 1);
 ...
 7d6:	b7e080e7          	jalr	-1154(ra) # 350 <sbrk>
  if(p == (char*)-1)
