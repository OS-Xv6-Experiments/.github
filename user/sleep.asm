...
int main(int argn, char* argv[]) {
  ...
  1e:	612080e7          	jalr	1554(ra) # 62c <fprintf>
    exit(1);
  22:	4505                	li	a0,1
  ...
  3c:	7e850513          	addi	a0,a0,2024 # 820 <malloc+0x108>
  40:	00000097          	auipc	ra,0x0
  44:	61a080e7          	jalr	1562(ra) # 65a <printf>
  sleep(sleepNum);
  48:	8526                	mv	a0,s1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ca:	48a50513          	addi	a0,a0,1162 # 850 <digits>
 3ce:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 496:	3beb8b93          	addi	s7,s7,958 # 850 <digits>
 ...
 5d6:	27690913          	addi	s2,s2,630 # 848 <malloc+0x130>
        while(*s != 0){
...
free(void *ap)
{
 ...
 69e:	1ce7b783          	ld	a5,462(a5) # 868 <freep>
 ...
 6cc:	00e6ea63          	bltu	a3,a4,6e0 <free+0x50>
{
 ...
 70e:	14f73f23          	sd	a5,350(a4) # 868 <freep>
}
 712:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 740:	12c53503          	ld	a0,300(a0) # 868 <freep>
 ...
 768:	10490913          	addi	s2,s2,260 # 868 <freep>
  if(p == (char*)-1)
 76c:	5afd                	li	s5,-1
 76e:	a88d                	j	7e0 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 770:	00000797          	auipc	a5,0x0
 774:	10078793          	addi	a5,a5,256 # 870 <base>
 778:	00000717          	auipc	a4,0x0
 77c:	0ef73823          	sd	a5,240(a4) # 868 <freep>
 780:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7a2:	0ca73523          	sd	a0,202(a4) # 868 <freep>
      return (void*)(p + 1);
