...
primes()
{
  ...
  5e:	3b2080e7          	jalr	946(ra) # 40c <read>
  ...
  74:	8b050513          	addi	a0,a0,-1872 # 920 <malloc+0xe6>
  78:	00000097          	auipc	ra,0x0
  7c:	704080e7          	jalr	1796(ra) # 77c <printf>
    pipe(fd);
  80:	fe040513          	addi	a0,s0,-32
  84:	00000097          	auipc	ra,0x0
  88:	380080e7          	jalr	896(ra) # 404 <pipe>
    if (fork() == 0)
  8c:	00000097          	auipc	ra,0x0
  90:	360080e7          	jalr	864(ra) # 3ec <fork>
  ...
  b0:	360080e7          	jalr	864(ra) # 40c <read>
  ...
  d0:	348080e7          	jalr	840(ra) # 414 <write>
  d4:	bfc1                	j	a4 <primes+0x5a>
      wait(NULL);
  d6:	4501                	li	a0,0
  d8:	00000097          	auipc	ra,0x0
  dc:	324080e7          	jalr	804(ra) # 3fc <wait>
      mapping(0, fd);
...
main(int argc, char* argv[])
{
 ...
 10a:	2fe080e7          	jalr	766(ra) # 404 <pipe>
  // 创建进程
  if (fork() == 0)
 10e:	00000097          	auipc	ra,0x0
 112:	2de080e7          	jalr	734(ra) # 3ec <fork>
 ...
 13c:	2dc080e7          	jalr	732(ra) # 414 <write>
    for (int i = 2; i < 36; i++)
 ...
 15a:	2a6080e7          	jalr	678(ra) # 3fc <wait>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4ec:	45050513          	addi	a0,a0,1104 # 938 <digits>
 4f0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5b8:	384b8b93          	addi	s7,s7,900 # 938 <digits>
 ...
 6f8:	23c90913          	addi	s2,s2,572 # 930 <malloc+0xf6>
        while(*s != 0){
...
free(void *ap)
{
 ...
 7c0:	1947b783          	ld	a5,404(a5) # 950 <freep>
 ...
 7ee:	00e6ea63          	bltu	a3,a4,802 <free+0x50>
{
 ...
 830:	12f73223          	sd	a5,292(a4) # 950 <freep>
}
 834:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 862:	0f253503          	ld	a0,242(a0) # 950 <freep>
 ...
 88a:	0ca90913          	addi	s2,s2,202 # 950 <freep>
  if(p == (char*)-1)
 88e:	5afd                	li	s5,-1
 890:	a88d                	j	902 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 892:	00000797          	auipc	a5,0x0
 896:	0c678793          	addi	a5,a5,198 # 958 <base>
 89a:	00000717          	auipc	a4,0x0
 89e:	0af73b23          	sd	a5,182(a4) # 950 <freep>
 8a2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8c4:	08a73823          	sd	a0,144(a4) # 950 <freep>
      return (void*)(p + 1);
