...
kfree(void *pa)
{
  ...
  acquire(&kmem.lock);
    ...
    8000005e:	378080e7          	jalr	888(ra) # 800063d2 <acquire>
  ...
  release(&kmem.lock);
    ...
    80000072:	418080e7          	jalr	1048(ra) # 80006486 <release>
}
    ...
    8000008e:	dfe080e7          	jalr	-514(ra) # 80005e88 <panic>
...
00000000800000dc <kinit>:
{
  ...
  initlock(&kmem.lock, "kmem");
    ...
    800000f8:	24e080e7          	jalr	590(ra) # 80006342 <initlock>
...
kalloc(void)
{
  ...
  acquire(&kmem.lock);
    ...
    80000130:	2a6080e7          	jalr	678(ra) # 800063d2 <acquire>
  r = kmem.freelist;
  ...
  release(&kmem.lock);
    ...
    80000148:	342080e7          	jalr	834(ra) # 80006486 <release>
  ...
  release(&kmem.lock);
    ...
    80000172:	318080e7          	jalr	792(ra) # 80006486 <release>
  if(r)
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    80000360:	b76080e7          	jalr	-1162(ra) # 80005ed2 <printf>
  ...
  scheduler();        
    ...
    80000388:	a16080e7          	jalr	-1514(ra) # 80005d9a <consoleinit>
    printfinit();
    8000038c:	00006097          	auipc	ra,0x6
    80000390:	d2c080e7          	jalr	-724(ra) # 800060b8 <printfinit>
    printf("\n");
    80000394:	00008517          	auipc	a0,0x8
    80000398:	cb450513          	addi	a0,a0,-844 # 80008048 <etext+0x48>
    8000039c:	00006097          	auipc	ra,0x6
    800003a0:	b36080e7          	jalr	-1226(ra) # 80005ed2 <printf>
    printf("xv6 kernel is booting\n");
    800003a4:	00008517          	auipc	a0,0x8
    800003a8:	c7c50513          	addi	a0,a0,-900 # 80008020 <etext+0x20>
    800003ac:	00006097          	auipc	ra,0x6
    800003b0:	b26080e7          	jalr	-1242(ra) # 80005ed2 <printf>
    printf("\n");
    800003b4:	00008517          	auipc	a0,0x8
    800003b8:	c9450513          	addi	a0,a0,-876 # 80008048 <etext+0x48>
    800003bc:	00006097          	auipc	ra,0x6
    800003c0:	b16080e7          	jalr	-1258(ra) # 80005ed2 <printf>
    ...
    80000420:	066080e7          	jalr	102(ra) # 80005482 <virtio_disk_init>
    userinit();      // first user process
...
walk(pagetable_t pagetable, uint64 va, int alloc)
{
  ...
  if(va >= MAXVA)
    ...
    80000492:	9fa080e7          	jalr	-1542(ra) # 80005e88 <panic>
...
mappages(pagetable_t pagetable, uint64 va, uint64 size, uint64 pa, int perm)
{
  ...
  a = PGROUNDDOWN(va);
    ...
    *pte = PA2PTE(pa) | perm | PTE_V;
    ...
    8000058a:	902080e7          	jalr	-1790(ra) # 80005e88 <panic>
      panic("mappages: remap");
    8000058e:	00008517          	auipc	a0,0x8
    80000592:	ada50513          	addi	a0,a0,-1318 # 80008068 <etext+0x68>
    80000596:	00006097          	auipc	ra,0x6
    8000059a:	8f2080e7          	jalr	-1806(ra) # 80005e88 <panic>
    a += PGSIZE;
...
00000000800005e8 <kvmmap>:
{
  ...
  if(mappages(kpgtbl, va, sz, pa, perm) != 0)
    ...
    80000614:	878080e7          	jalr	-1928(ra) # 80005e88 <panic>
...
uvminit(pagetable_t pagetable, uchar *src, uint sz)
{
  ...
  memmove(mem, src, sz);
    ...
    8000086e:	61e080e7          	jalr	1566(ra) # 80005e88 <panic>
...
freewalk(pagetable_t pagetable)
{
  ...
  for(int i = 0; i < 512; i++){
    ...
    800009b0:	4dc080e7          	jalr	1244(ra) # 80005e88 <panic>
    }
  }
...
uvmclear(pagetable_t pagetable, uint64 va)
{
  ...
  *pte &= ~PTE_U;
    ...
    80000b06:	386080e7          	jalr	902(ra) # 80005e88 <panic>
...
proc_mapstacks(pagetable_t kpgtbl) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000d68:	124080e7          	jalr	292(ra) # 80005e88 <panic>
...
procinit(void)
{
  ...
  initlock(&pid_lock, "nextpid");
    ...
    80000d94:	5b2080e7          	jalr	1458(ra) # 80006342 <initlock>
  initlock(&wait_lock, "wait_lock");
    ...
    80000dac:	59a080e7          	jalr	1434(ra) # 80006342 <initlock>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000de2:	564080e7          	jalr	1380(ra) # 80006342 <initlock>
      p->kstack = KSTACK((int) (p - proc));
...
myproc(void) {
  ...
  push_off();
    ...
    80000e56:	534080e7          	jalr	1332(ra) # 80006386 <push_off>
  ...
  pop_off();
    ...
    80000e70:	5ba080e7          	jalr	1466(ra) # 80006426 <pop_off>
  return p;
}
...
forkret(void)
{
  ...
  release(&myproc()->lock);
    ...
    80000e94:	5f6080e7          	jalr	1526(ra) # 80006486 <release>

  if (first) {
    80000e98:	00008797          	auipc	a5,0x8
    80000e9c:	9f87a783          	lw	a5,-1544(a5) # 80008890 <first.1672>
  ...
  usertrapret();
    ...
    80000eb6:	9c07af23          	sw	zero,-1570(a5) # 80008890 <first.1672>
    fsinit(ROOTDEV);
...
allocpid() {
  ...
  acquire(&pid_lock);
    ...
    80000ee0:	4f6080e7          	jalr	1270(ra) # 800063d2 <acquire>
  pid = nextpid;
    80000ee4:	00008797          	auipc	a5,0x8
    80000ee8:	9b078793          	addi	a5,a5,-1616 # 80008894 <nextpid>
  ...
  release(&pid_lock);
    ...
    80000efa:	590080e7          	jalr	1424(ra) # 80006486 <release>
}
...
0000000080001052 <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001074:	362080e7          	jalr	866(ra) # 800063d2 <acquire>
    if(p->state == UNUSED) {
    ...
    80001082:	408080e7          	jalr	1032(ra) # 80006486 <release>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  return p;
    ...
    80001100:	38a080e7          	jalr	906(ra) # 80006486 <release>
    return 0;
    ...
    80001118:	372080e7          	jalr	882(ra) # 80006486 <release>
    return 0;
...
0000000080001120 <userinit>:
{
  ...
  uvminit(p->pagetable, initcode, sizeof(initcode));
    ...
    80001144:	76058593          	addi	a1,a1,1888 # 800088a0 <initcode>
  ...
  release(&p->lock);
    ...
    80001194:	2f6080e7          	jalr	758(ra) # 80006486 <release>
}
...
0000000080001216 <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  for(i = 0; i < NOFILE; i++)
    ...
    800012ac:	1de080e7          	jalr	478(ra) # 80006486 <release>
    return -1;
  ...
  release(&np->lock);
    ...
    800012fe:	18c080e7          	jalr	396(ra) # 80006486 <release>
  acquire(&wait_lock);
    ...
    80001310:	0c6080e7          	jalr	198(ra) # 800063d2 <acquire>
  np->parent = p;
    80001314:	0329bc23          	sd	s2,56(s3)
  release(&wait_lock);
    80001318:	8526                	mv	a0,s1
    8000131a:	00005097          	auipc	ra,0x5
    8000131e:	16c080e7          	jalr	364(ra) # 80006486 <release>
  acquire(&np->lock);
    80001322:	854e                	mv	a0,s3
    80001324:	00005097          	auipc	ra,0x5
    80001328:	0ae080e7          	jalr	174(ra) # 800063d2 <acquire>
  np->state = RUNNABLE;
  ...
  release(&np->lock);
    ...
    80001338:	152080e7          	jalr	338(ra) # 80006486 <release>
}
...
0000000080001352 <scheduler>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    800013d4:	0b6080e7          	jalr	182(ra) # 80006486 <release>
    for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800013e6:	ff0080e7          	jalr	-16(ra) # 800063d2 <acquire>
      if(p->state == RUNNABLE) {
...
00000000800013f2 <sched>:
{
  ...
  if(!holding(&p->lock))
    ...
    8000140e:	f4e080e7          	jalr	-178(ra) # 80006358 <holding>
...
00000000800014c8 <yield>:
{
  ...
  acquire(&p->lock);
    ...
    800014e0:	ef6080e7          	jalr	-266(ra) # 800063d2 <acquire>
  p->state = RUNNABLE;
  ...
  release(&p->lock);
    ...
    800014f6:	f94080e7          	jalr	-108(ra) # 80006486 <release>
}
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  acquire(&p->lock);  //DOC: sleeplock1
    ...
    80001524:	eb2080e7          	jalr	-334(ra) # 800063d2 <acquire>
  release(lk);
    80001528:	854a                	mv	a0,s2
    8000152a:	00005097          	auipc	ra,0x5
    8000152e:	f5c080e7          	jalr	-164(ra) # 80006486 <release>
  ...
  release(&p->lock);
    ...
    8000154c:	f3e080e7          	jalr	-194(ra) # 80006486 <release>
  acquire(lk);
    80001550:	854a                	mv	a0,s2
    80001552:	00005097          	auipc	ra,0x5
    80001556:	e80080e7          	jalr	-384(ra) # 800063d2 <acquire>
}
...
0000000080001568 <wait>:
{
  ...
  acquire(&wait_lock);
    ...
    80001598:	e3e080e7          	jalr	-450(ra) # 800063d2 <acquire>
    havekids = 0;
    ...
    80001636:	da0080e7          	jalr	-608(ra) # 800063d2 <acquire>
        if(np->state == ZOMBIE){
    ...
    80001646:	e44080e7          	jalr	-444(ra) # 80006486 <release>
        havekids = 1;
    ...
    80001662:	e28080e7          	jalr	-472(ra) # 80006486 <release>
      return -1;
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800016c0:	dca080e7          	jalr	-566(ra) # 80006486 <release>
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800016de:	cf8080e7          	jalr	-776(ra) # 800063d2 <acquire>
      if(p->state == SLEEPING && p->chan == chan) {
...
0000000080001760 <exit>:
{
  ...
  if(p == initproc)
    ...
    8000179c:	6f0080e7          	jalr	1776(ra) # 80005e88 <panic>
      fileclose(f);
  ...
  acquire(&wait_lock);
    ...
    800017e6:	bf0080e7          	jalr	-1040(ra) # 800063d2 <acquire>
  reparent(p);
  ...
  acquire(&p->lock);
    ...
    80001806:	bd0080e7          	jalr	-1072(ra) # 800063d2 <acquire>
  p->xstate = status;
  ...
  release(&wait_lock);
    ...
    8000181a:	c70080e7          	jalr	-912(ra) # 80006486 <release>
  sched();
  ...
  panic("zombie exit");
    ...
    80001832:	65a080e7          	jalr	1626(ra) # 80005e88 <panic>
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    8000185c:	b7a080e7          	jalr	-1158(ra) # 800063d2 <acquire>
    if(p->pid == pid){
    ...
    8000186c:	c1e080e7          	jalr	-994(ra) # 80006486 <release>
  for(p = proc; p < &proc[NPROC]; p++){
  ...
  return -1;
    ...
    8000189a:	bf0080e7          	jalr	-1040(ra) # 80006486 <release>
      return 0;
...
procdump(void)
{
  ...
  printf("\n");
    ...
    80001976:	560080e7          	jalr	1376(ra) # 80005ed2 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800019b8:	51e080e7          	jalr	1310(ra) # 80005ed2 <printf>
    printf("\n");
    800019bc:	8552                	mv	a0,s4
    800019be:	00004097          	auipc	ra,0x4
    800019c2:	514080e7          	jalr	1300(ra) # 80005ed2 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80001a88:	8be080e7          	jalr	-1858(ra) # 80006342 <initlock>
}
...
trapinithart(void)
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    80001a9e:	7f678793          	addi	a5,a5,2038 # 80005290 <kernelvec>
...
clockintr()
{
  ...
  acquire(&tickslock);
    ...
    80001b62:	874080e7          	jalr	-1932(ra) # 800063d2 <acquire>
  ticks++;
  ...
  release(&tickslock);
    ...
    80001b82:	908080e7          	jalr	-1784(ra) # 80006486 <release>
}
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    80001bc6:	7d6080e7          	jalr	2006(ra) # 80005398 <plic_claim>
...
0000000080001c32 <usertrap>:
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    80001c4c:	64878793          	addi	a5,a5,1608 # 80005290 <kernelvec>
  ...
  usertrapret();
    ...
    80001cb4:	1d8080e7          	jalr	472(ra) # 80005e88 <panic>
      exit(-1);
  ...
  asm volatile("csrr %0, scause" : "=r" (x) );
    ...
    80001ce8:	1ee080e7          	jalr	494(ra) # 80005ed2 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80001d00:	1d6080e7          	jalr	470(ra) # 80005ed2 <printf>
    p->killed = 1;
...
0000000080001d26 <kerneltrap>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001d80:	10c080e7          	jalr	268(ra) # 80005e88 <panic>
    ...
    80001d90:	0fc080e7          	jalr	252(ra) # 80005e88 <panic>
    printf("scause %p\n", scause);
    ...
    80001da2:	134080e7          	jalr	308(ra) # 80005ed2 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
...
argraw(int n)
{
  ...
  panic("argraw");
    ...
    80001e56:	036080e7          	jalr	54(ra) # 80005e88 <panic>
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    80001fbe:	f18080e7          	jalr	-232(ra) # 80005ed2 <printf>
            p->pid, p->name, num);
    p->trapframe->a0 = -1;
...
sys_sleep(void)
{
  ...
  acquire(&tickslock);
    ...
    800020e4:	2f2080e7          	jalr	754(ra) # 800063d2 <acquire>
  ticks0 = ticks;
  ...
  release(&tickslock);
    ...
    80002138:	352080e7          	jalr	850(ra) # 80006486 <release>
  return 0;
    ...
    8000215a:	330080e7          	jalr	816(ra) # 80006486 <release>
      return -1;
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    800021aa:	22c080e7          	jalr	556(ra) # 800063d2 <acquire>
  xticks = ticks;
  ...
  release(&tickslock);
    ...
    800021c2:	2c8080e7          	jalr	712(ra) # 80006486 <release>
  return xticks;
}
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    800021fa:	14c080e7          	jalr	332(ra) # 80006342 <initlock>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    80002282:	154080e7          	jalr	340(ra) # 800063d2 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    800022c2:	1c8080e7          	jalr	456(ra) # 80006486 <release>
      acquiresleep(&b->lock);
  ...
  panic("bget: no buffers");
    ...
    80002300:	b8c080e7          	jalr	-1140(ra) # 80005e88 <panic>
      b->dev = dev;
    ...
    80002320:	16a080e7          	jalr	362(ra) # 80006486 <release>
      acquiresleep(&b->lock);
  ...
  return b;
    ...
    8000234c:	27e080e7          	jalr	638(ra) # 800055c6 <virtio_disk_rw>
    b->valid = 1;
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    80002376:	254080e7          	jalr	596(ra) # 800055c6 <virtio_disk_rw>
}
    ...
    80002390:	afc080e7          	jalr	-1284(ra) # 80005e88 <panic>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    800023c8:	00e080e7          	jalr	14(ra) # 800063d2 <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    80002412:	078080e7          	jalr	120(ra) # 80006486 <release>
}
    ...
    8000242e:	a5e080e7          	jalr	-1442(ra) # 80005e88 <panic>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    8000244a:	f8c080e7          	jalr	-116(ra) # 800063d2 <acquire>
  b->refcnt++;
  ...
  release(&bcache.lock);
    ...
    80002460:	02a080e7          	jalr	42(ra) # 80006486 <release>
}
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80002486:	f50080e7          	jalr	-176(ra) # 800063d2 <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    8000249c:	fee080e7          	jalr	-18(ra) # 80006486 <release>
}
...
bfree(int dev, uint b)
{
  ...
  brelse(bp);
    ...
    80002522:	96a080e7          	jalr	-1686(ra) # 80005e88 <panic>
...
0000000080002526 <balloc>:
{
  ...
  panic("balloc: out of blocks");
    ...
    800025e8:	8a4080e7          	jalr	-1884(ra) # 80005e88 <panic>
...
bmap(struct inode *ip, uint bn)
{
    ...
    8000268c:	14f77e63          	bgeu	a4,a5,800027e8 <bmap+0x190>
  {
    ...
    // 在第一层索引 a 中查找 bn1 对应的物理块地址
    // 如果没有分配物理块，则分配一个新块，并记录到数组 a 中
    if((addr = a[bn1])==0)
  ...
  panic("bmap: out of range");
    ...
    800027f4:	698080e7          	jalr	1688(ra) # 80005e88 <panic>
...
00000000800027f8 <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    80002818:	bbe080e7          	jalr	-1090(ra) # 800063d2 <acquire>
  empty = 0;
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    8000285e:	c2c080e7          	jalr	-980(ra) # 80006486 <release>
      return ip;
  ...
  release(&itable.lock);
    ...
    8000288e:	bfc080e7          	jalr	-1028(ra) # 80006486 <release>
}
    ...
    800028b0:	5dc080e7          	jalr	1500(ra) # 80005e88 <panic>
...
fsinit(int dev) {
  ...
  initlog(dev, &sb);
    ...
    80002930:	55c080e7          	jalr	1372(ra) # 80005e88 <panic>
...
0000000080002934 <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    80002956:	9f0080e7          	jalr	-1552(ra) # 80006342 <initlock>
  for(i = 0; i < NINODE; i++) {
...
0000000080002994 <ialloc>:
{
  ...
  panic("ialloc: no inodes");
    ...
    80002a14:	478080e7          	jalr	1144(ra) # 80005e88 <panic>
...
0000000080002aee <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    80002b06:	8d0080e7          	jalr	-1840(ra) # 800063d2 <acquire>
  ip->ref++;
  ...
  release(&itable.lock);
    ...
    80002b1c:	96e080e7          	jalr	-1682(ra) # 80006486 <release>
}
...
0000000080002b2c <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80002b68:	324080e7          	jalr	804(ra) # 80005e88 <panic>
    bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80002bea:	2a2080e7          	jalr	674(ra) # 80005e88 <panic>
...
0000000080002bee <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    80002c36:	256080e7          	jalr	598(ra) # 80005e88 <panic>
...
itrunc(struct inode *ip)
{
  ...
  if(ip->addrs[NDIRECT+1])
    ...
    // 释放双重间接块本身，并将 ip->addrs[NDIRECT + 1] 设为0
    brelse(bp);
...
0000000080002d90 <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    80002daa:	62c080e7          	jalr	1580(ra) # 800063d2 <acquire>
  ...
  release(&itable.lock);
    ...
    80002dc8:	6c2080e7          	jalr	1730(ra) # 80006486 <release>
}
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80002dfc:	68e080e7          	jalr	1678(ra) # 80006486 <release>
    itrunc(ip);
    ...
    80002e32:	5a4080e7          	jalr	1444(ra) # 800063d2 <acquire>
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    800030f2:	d9a080e7          	jalr	-614(ra) # 80005e88 <panic>
    ...
    80003102:	d8a080e7          	jalr	-630(ra) # 80005e88 <panic>
  for(off = 0; off < dp->size; off += sizeof(de)){
...
0000000080003506 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    8000352e:	e18080e7          	jalr	-488(ra) # 80006342 <initlock>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    ...
    800035c2:	e14080e7          	jalr	-492(ra) # 800063d2 <acquire>
  while(1){
    if(log.committing){
    ...
    8000361a:	e70080e7          	jalr	-400(ra) # 80006486 <release>
      break;
    }
  }
}
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    8000364a:	d8c080e7          	jalr	-628(ra) # 800063d2 <acquire>
  log.outstanding -= 1;
  ...
  release(&log.lock);
    ...
    80003672:	e18080e7          	jalr	-488(ra) # 80006486 <release>
}
...
commit()
{
  if (log.lh.n > 0) {
    ...
    8000368a:	d4c080e7          	jalr	-692(ra) # 800063d2 <acquire>
    log.committing = 0;
    ...
    800036a2:	de8080e7          	jalr	-536(ra) # 80006486 <release>
}
    ...
    800036c4:	7c8080e7          	jalr	1992(ra) # 80005e88 <panic>
    wakeup(&log);
  ...
  release(&log.lock);
    ...
    800036e0:	daa080e7          	jalr	-598(ra) # 80006486 <release>
  if(do_commit){
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    8000379e:	c38080e7          	jalr	-968(ra) # 800063d2 <acquire>
  ...
  release(&log.lock);
    ...
    80003858:	c32080e7          	jalr	-974(ra) # 80006486 <release>
}
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    80003886:	ac0080e7          	jalr	-1344(ra) # 80006342 <initlock>
  lk->name = name;
...
acquiresleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    800038ba:	b1c080e7          	jalr	-1252(ra) # 800063d2 <acquire>
  while (lk->locked) {
  ...
  release(&lk->lk);
    ...
    800038e8:	ba2080e7          	jalr	-1118(ra) # 80006486 <release>
}
...
releasesleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    80003910:	ac6080e7          	jalr	-1338(ra) # 800063d2 <acquire>
  lk->locked = 0;
  ...
  release(&lk->lk);
    ...
    8000392c:	b5e080e7          	jalr	-1186(ra) # 80006486 <release>
}
...
holdingsleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    80003956:	a80080e7          	jalr	-1408(ra) # 800063d2 <acquire>
  ...
  release(&lk->lk);
    ...
    80003966:	b24080e7          	jalr	-1244(ra) # 80006486 <release>
  return r;
}
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    800039ae:	998080e7          	jalr	-1640(ra) # 80006342 <initlock>
}
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    800039d0:	a06080e7          	jalr	-1530(ra) # 800063d2 <acquire>
  ...
  release(&ftable.lock);
    ...
    800039fc:	a8e080e7          	jalr	-1394(ra) # 80006486 <release>
  return 0;
    ...
    80003a14:	a76080e7          	jalr	-1418(ra) # 80006486 <release>
}
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003a3c:	99a080e7          	jalr	-1638(ra) # 800063d2 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    80003a56:	a34080e7          	jalr	-1484(ra) # 80006486 <release>
  return f;
}
    ...
    80003a72:	41a080e7          	jalr	1050(ra) # 80005e88 <panic>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003a96:	940080e7          	jalr	-1728(ra) # 800063d2 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    80003ad0:	9ba080e7          	jalr	-1606(ra) # 80006486 <release>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    80003c62:	22a080e7          	jalr	554(ra) # 80005e88 <panic>
    return -1;
...
filewrite(struct file *f, uint64 addr, int n)
{
  ...
  return ret;
    ...
    80003d96:	0f6080e7          	jalr	246(ra) # 80005e88 <panic>
    return -1;
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    80003e06:	540080e7          	jalr	1344(ra) # 80006342 <initlock>
  (*f0)->type = FD_PIPE;
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  acquire(&pi->lock);
    ...
    80003e94:	542080e7          	jalr	1346(ra) # 800063d2 <acquire>
  if(writable){
  ...
  if(pi->readopen == 0 && pi->writeopen == 0){
    ...
    80003eb8:	5d2080e7          	jalr	1490(ra) # 80006486 <release>
    kfree((char*)pi);
    ...
    80003eea:	5a0080e7          	jalr	1440(ra) # 80006486 <release>
}
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80003f20:	4b6080e7          	jalr	1206(ra) # 800063d2 <acquire>
  while(i < n){
  ...
  int i = 0;
    ...
    80003f3e:	54c080e7          	jalr	1356(ra) # 80006486 <release>
      return -1;
  ...
  release(&pi->lock);
    ...
    80003fe0:	4aa080e7          	jalr	1194(ra) # 80006486 <release>
  return i;
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80004016:	3c0080e7          	jalr	960(ra) # 800063d2 <acquire>
  ...
  release(&pi->lock);
    ...
    800040aa:	3e0080e7          	jalr	992(ra) # 80006486 <release>
  return i;
}
    ...
    800040ca:	3c0080e7          	jalr	960(ra) # 80006486 <release>
      return -1;
...
exec(char *path, char **argv)
{
 ...
 bad:
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    800041d2:	cba080e7          	jalr	-838(ra) # 80005e88 <panic>
    if(sz - i < PGSIZE)
      n = sz - i;
    else
      n = PGSIZE;
...
create(char *path, short type, short major, short minor)
{
  ...
  return ip;
    ...
    80004604:	888080e7          	jalr	-1912(ra) # 80005e88 <panic>
    dp->nlink++;  // for ".."
...
0000000080004972 <sys_unlink>:
{
  ...
  return 0;
    ...
    80004a9e:	3ee080e7          	jalr	1006(ra) # 80005e88 <panic>
...
sys_open(void)
{
  ...
  if((n = argstr(0, path, MAXPATH)) < 0 || argint(1, &omode) < 0)
    80004b6c:	12054e63          	bltz	a0,80004ca8 <sys_open+0x164>
    80004b70:	ebc40593          	addi	a1,s0,-324
    80004b74:	4505                	li	a0,1
    80004b76:	ffffd097          	auipc	ra,0xffffd
    80004b7a:	37e080e7          	jalr	894(ra) # 80001ef4 <argint>
    80004b7e:	12054563          	bltz	a0,80004ca8 <sys_open+0x164>
  ...
  if(omode & O_CREATE){
    80004b8a:	ebc42783          	lw	a5,-324(s0)
    80004b8e:	2007f793          	andi	a5,a5,512
    80004b92:	cba9                	beqz	a5,80004be4 <sys_open+0xa0>
    ...
    if(ip == 0){
    80004ba8:	c90d                	beqz	a0,80004bda <sys_open+0x96>
      end_op();
      return -1;
    }
  }
  ...
  if(ip->type == T_DEVICE && (ip->major < 0 || ip->major >= NDEV)){
    ...
    80004bb4:	06e68d63          	beq	a3,a4,80004c2e <sys_open+0xea>
    iunlockput(ip);
    end_op();
    return -1;
  }
  ...
  if(ip->type == T_SYMLINK && (omode & O_NOFOLLOW) == 0)
    ...
    80004bbc:	06e79e63          	bne	a5,a4,80004c38 <sys_open+0xf4>
    80004bc0:	ebc42783          	lw	a5,-324(s0)
    80004bc4:	8b91                	andi	a5,a5,4
    80004bc6:	0007899b          	sext.w	s3,a5
    80004bca:	e7bd                	bnez	a5,80004c38 <sys_open+0xf4>
    80004bcc:	e9040a13          	addi	s4,s0,-368
    80004bd0:	028a0913          	addi	s2,s4,40
        }
      }
      // 锁定新的 inode
      ilock(ip);
      // 如果新的 inode 不是符号链接，退出循环，解析完成
      if(ip->type != T_SYMLINK)
    80004bd4:	4a91                	li	s5,4
    for(i=0;i<MAXSYMLINK;i++)
    80004bd6:	4b29                	li	s6,10
    80004bd8:	aaa5                	j	80004d50 <sys_open+0x20c>
      end_op();
    80004bda:	fffff097          	auipc	ra,0xfffff
    80004bde:	a50080e7          	jalr	-1456(ra) # 8000362a <end_op>
      return -1;
    80004be2:	a0d9                	j	80004ca8 <sys_open+0x164>
    if((ip = namei(path)) == 0){
    80004be4:	f4040513          	addi	a0,s0,-192
    80004be8:	ffffe097          	auipc	ra,0xffffe
    80004bec:	7a6080e7          	jalr	1958(ra) # 8000338e <namei>
    80004bf0:	84aa                	mv	s1,a0
    80004bf2:	c905                	beqz	a0,80004c22 <sys_open+0xde>
    ilock(ip);
    80004bf4:	ffffe097          	auipc	ra,0xffffe
    80004bf8:	f38080e7          	jalr	-200(ra) # 80002b2c <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
    80004bfc:	04449703          	lh	a4,68(s1)
    80004c00:	4785                	li	a5,1
    80004c02:	faf714e3          	bne	a4,a5,80004baa <sys_open+0x66>
    80004c06:	ebc42783          	lw	a5,-324(s0)
    80004c0a:	c79d                	beqz	a5,80004c38 <sys_open+0xf4>
      iunlockput(ip);
    80004c0c:	8526                	mv	a0,s1
    80004c0e:	ffffe097          	auipc	ra,0xffffe
    80004c12:	22a080e7          	jalr	554(ra) # 80002e38 <iunlockput>
      end_op();
    80004c16:	fffff097          	auipc	ra,0xfffff
    80004c1a:	a14080e7          	jalr	-1516(ra) # 8000362a <end_op>
      return -1;
    80004c1e:	597d                	li	s2,-1
    80004c20:	a061                	j	80004ca8 <sys_open+0x164>
      end_op();
    80004c22:	fffff097          	auipc	ra,0xfffff
    80004c26:	a08080e7          	jalr	-1528(ra) # 8000362a <end_op>
      return -1;
    80004c2a:	597d                	li	s2,-1
    80004c2c:	a8b5                	j	80004ca8 <sys_open+0x164>
  if(ip->type == T_DEVICE && (ip->major < 0 || ip->major >= NDEV)){
    80004c2e:	0464d703          	lhu	a4,70(s1)
    80004c32:	47a5                	li	a5,9
    80004c34:	08e7e563          	bltu	a5,a4,80004cbe <sys_open+0x17a>
      end_op();
      return -1;
    }
  }
  ...
  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
    ...
    80004c3c:	d82080e7          	jalr	-638(ra) # 800039ba <filealloc>
    80004c40:	89aa                	mv	s3,a0
    80004c42:	1a050663          	beqz	a0,80004dee <sys_open+0x2aa>
    80004c46:	00000097          	auipc	ra,0x0
    80004c4a:	882080e7          	jalr	-1918(ra) # 800044c8 <fdalloc>
    80004c4e:	892a                	mv	s2,a0
    80004c50:	18054a63          	bltz	a0,80004de4 <sys_open+0x2a0>
    iunlockput(ip);
    end_op();
    return -1;
  }
  ...
  if(ip->type == T_DEVICE){
    ...
    80004c5a:	16f70863          	beq	a4,a5,80004dca <sys_open+0x286>
    f->type = FD_DEVICE;
    f->major = ip->major;
  } else {
    f->type = FD_INODE;
  ...
  f->readable = !(omode & O_WRONLY);
    80004c6c:	ebc42783          	lw	a5,-324(s0)
  ...
  if((omode & O_TRUNC) && ip->type == T_FILE){
    ...
    80004c8a:	c791                	beqz	a5,80004c96 <sys_open+0x152>
    80004c8c:	04449703          	lh	a4,68(s1)
    80004c90:	4789                	li	a5,2
    80004c92:	14f70363          	beq	a4,a5,80004dd8 <sys_open+0x294>
    itrunc(ip);
  }
  ...
  iunlock(ip);
    ...
    80004c9c:	f56080e7          	jalr	-170(ra) # 80002bee <iunlock>
  end_op();
    80004ca0:	fffff097          	auipc	ra,0xfffff
    80004ca4:	98a080e7          	jalr	-1654(ra) # 8000362a <end_op>

  return fd;
}
    80004ca8:	854a                	mv	a0,s2
    80004caa:	70b6                	ld	ra,360(sp)
    80004cac:	7416                	ld	s0,352(sp)
    80004cae:	64f6                	ld	s1,344(sp)
    80004cb0:	6956                	ld	s2,336(sp)
    80004cb2:	69b6                	ld	s3,328(sp)
    80004cb4:	6a16                	ld	s4,320(sp)
    80004cb6:	7af2                	ld	s5,312(sp)
    80004cb8:	7b52                	ld	s6,304(sp)
    80004cba:	6175                	addi	sp,sp,368
    80004cbc:	8082                	ret
    iunlockput(ip);
    80004cbe:	8526                	mv	a0,s1
    80004cc0:	ffffe097          	auipc	ra,0xffffe
    80004cc4:	178080e7          	jalr	376(ra) # 80002e38 <iunlockput>
    end_op();
    80004cc8:	fffff097          	auipc	ra,0xfffff
    80004ccc:	962080e7          	jalr	-1694(ra) # 8000362a <end_op>
    return -1;
    80004cd0:	597d                	li	s2,-1
    80004cd2:	bfd9                	j	80004ca8 <sys_open+0x164>
        iunlockput(ip);
    80004cd4:	8526                	mv	a0,s1
    80004cd6:	ffffe097          	auipc	ra,0xffffe
    80004cda:	162080e7          	jalr	354(ra) # 80002e38 <iunlockput>
        end_op();
    80004cde:	fffff097          	auipc	ra,0xfffff
    80004ce2:	94c080e7          	jalr	-1716(ra) # 8000362a <end_op>
        printf("open symlink failed\n");
    80004ce6:	00004517          	auipc	a0,0x4
    80004cea:	a0a50513          	addi	a0,a0,-1526 # 800086f0 <syscalls+0x328>
    80004cee:	00001097          	auipc	ra,0x1
    80004cf2:	1e4080e7          	jalr	484(ra) # 80005ed2 <printf>
        return -1;
    80004cf6:	597d                	li	s2,-1
    80004cf8:	bf45                	j	80004ca8 <sys_open+0x164>
        printf("\"%s\" is not a valid path",target);
    80004cfa:	ec040593          	addi	a1,s0,-320
    80004cfe:	00004517          	auipc	a0,0x4
    80004d02:	a0a50513          	addi	a0,a0,-1526 # 80008708 <syscalls+0x340>
    80004d06:	00001097          	auipc	ra,0x1
    80004d0a:	1cc080e7          	jalr	460(ra) # 80005ed2 <printf>
        end_op();
    80004d0e:	fffff097          	auipc	ra,0xfffff
    80004d12:	91c080e7          	jalr	-1764(ra) # 8000362a <end_op>
        return -1;
    80004d16:	597d                	li	s2,-1
    80004d18:	bf41                	j	80004ca8 <sys_open+0x164>
          printf("Form a cirle\n");
    80004d1a:	00004517          	auipc	a0,0x4
    80004d1e:	a0e50513          	addi	a0,a0,-1522 # 80008728 <syscalls+0x360>
    80004d22:	00001097          	auipc	ra,0x1
    80004d26:	1b0080e7          	jalr	432(ra) # 80005ed2 <printf>
          end_op();
    80004d2a:	fffff097          	auipc	ra,0xfffff
    80004d2e:	900080e7          	jalr	-1792(ra) # 8000362a <end_op>
          return -1;
    80004d32:	597d                	li	s2,-1
    80004d34:	bf95                	j	80004ca8 <sys_open+0x164>
      ilock(ip);
    80004d36:	8526                	mv	a0,s1
    80004d38:	ffffe097          	auipc	ra,0xffffe
    80004d3c:	df4080e7          	jalr	-524(ra) # 80002b2c <ilock>
      if(ip->type != T_SYMLINK)
    80004d40:	04449783          	lh	a5,68(s1)
    80004d44:	05579d63          	bne	a5,s5,80004d9e <sys_open+0x25a>
    for(i=0;i<MAXSYMLINK;i++)
    80004d48:	2985                	addiw	s3,s3,1
    80004d4a:	0a11                	addi	s4,s4,4
    80004d4c:	05698c63          	beq	s3,s6,80004da4 <sys_open+0x260>
      inum[i]=ip->inum;
    80004d50:	40dc                	lw	a5,4(s1)
    80004d52:	00fa2023          	sw	a5,0(s4)
      if(readi(ip,0,(uint64)target,0,MAXPATH)<=0){
    80004d56:	08000713          	li	a4,128
    80004d5a:	4681                	li	a3,0
    80004d5c:	ec040613          	addi	a2,s0,-320
    80004d60:	4581                	li	a1,0
    80004d62:	8526                	mv	a0,s1
    80004d64:	ffffe097          	auipc	ra,0xffffe
    80004d68:	126080e7          	jalr	294(ra) # 80002e8a <readi>
    80004d6c:	f6a054e3          	blez	a0,80004cd4 <sys_open+0x190>
      iunlockput(ip);
    80004d70:	8526                	mv	a0,s1
    80004d72:	ffffe097          	auipc	ra,0xffffe
    80004d76:	0c6080e7          	jalr	198(ra) # 80002e38 <iunlockput>
      if((ip=namei(target))==0){
    80004d7a:	ec040513          	addi	a0,s0,-320
    80004d7e:	ffffe097          	auipc	ra,0xffffe
    80004d82:	610080e7          	jalr	1552(ra) # 8000338e <namei>
    80004d86:	84aa                	mv	s1,a0
    80004d88:	d92d                	beqz	a0,80004cfa <sys_open+0x1b6>
        if(ip->inum==inum[j]){
    80004d8a:	4154                	lw	a3,4(a0)
    80004d8c:	e9040793          	addi	a5,s0,-368
    80004d90:	4398                	lw	a4,0(a5)
    80004d92:	f8d704e3          	beq	a4,a3,80004d1a <sys_open+0x1d6>
      for(int j=0;j<MAXSYMLINK;j++){
    80004d96:	0791                	addi	a5,a5,4
    80004d98:	ff279ce3          	bne	a5,s2,80004d90 <sys_open+0x24c>
    80004d9c:	bf69                	j	80004d36 <sys_open+0x1f2>
    if(i==MAXSYMLINK)
    80004d9e:	47a9                	li	a5,10
    80004da0:	e8f99ce3          	bne	s3,a5,80004c38 <sys_open+0xf4>
      iunlockput(ip);
    80004da4:	8526                	mv	a0,s1
    80004da6:	ffffe097          	auipc	ra,0xffffe
    80004daa:	092080e7          	jalr	146(ra) # 80002e38 <iunlockput>
      printf("The depth of links reaches the limit\n");
    80004dae:	00004517          	auipc	a0,0x4
    80004db2:	98a50513          	addi	a0,a0,-1654 # 80008738 <syscalls+0x370>
    80004db6:	00001097          	auipc	ra,0x1
    80004dba:	11c080e7          	jalr	284(ra) # 80005ed2 <printf>
      end_op();
    80004dbe:	fffff097          	auipc	ra,0xfffff
    80004dc2:	86c080e7          	jalr	-1940(ra) # 8000362a <end_op>
      return -1;
    80004dc6:	597d                	li	s2,-1
    80004dc8:	b5c5                	j	80004ca8 <sys_open+0x164>
    f->type = FD_DEVICE;
    80004dca:	00f9a023          	sw	a5,0(s3)
    f->major = ip->major;
    80004dce:	04649783          	lh	a5,70(s1)
    80004dd2:	02f99223          	sh	a5,36(s3)
    80004dd6:	bd49                	j	80004c68 <sys_open+0x124>
    itrunc(ip);
    80004dd8:	8526                	mv	a0,s1
    80004dda:	ffffe097          	auipc	ra,0xffffe
    80004dde:	e60080e7          	jalr	-416(ra) # 80002c3a <itrunc>
    80004de2:	bd55                	j	80004c96 <sys_open+0x152>
      fileclose(f);
    80004de4:	854e                	mv	a0,s3
    80004de6:	fffff097          	auipc	ra,0xfffff
    80004dea:	c90080e7          	jalr	-880(ra) # 80003a76 <fileclose>
    iunlockput(ip);
    80004dee:	8526                	mv	a0,s1
    80004df0:	ffffe097          	auipc	ra,0xffffe
    80004df4:	048080e7          	jalr	72(ra) # 80002e38 <iunlockput>
    end_op();
    80004df8:	fffff097          	auipc	ra,0xfffff
    80004dfc:	832080e7          	jalr	-1998(ra) # 8000362a <end_op>
    return -1;
    80004e00:	597d                	li	s2,-1
    80004e02:	b55d                	j	80004ca8 <sys_open+0x164>

0000000080004e04 <sys_mkdir>:

uint64
sys_mkdir(void)
{
    80004e04:	7175                	addi	sp,sp,-144
    80004e06:	e506                	sd	ra,136(sp)
    80004e08:	e122                	sd	s0,128(sp)
    80004e0a:	0900                	addi	s0,sp,144
  char path[MAXPATH];
  struct inode *ip;

  begin_op();
    80004e0c:	ffffe097          	auipc	ra,0xffffe
    80004e10:	79e080e7          	jalr	1950(ra) # 800035aa <begin_op>
  if(argstr(0, path, MAXPATH) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
    ...
    80004e22:	11a080e7          	jalr	282(ra) # 80001f38 <argstr>
    80004e26:	02054963          	bltz	a0,80004e58 <sys_mkdir+0x54>
    80004e2a:	4681                	li	a3,0
    80004e2c:	4601                	li	a2,0
    80004e2e:	4585                	li	a1,1
    80004e30:	f7040513          	addi	a0,s0,-144
    80004e34:	fffff097          	auipc	ra,0xfffff
    80004e38:	6d6080e7          	jalr	1750(ra) # 8000450a <create>
    80004e3c:	cd11                	beqz	a0,80004e58 <sys_mkdir+0x54>
    end_op();
    return -1;
  }
  iunlockput(ip);
    80004e3e:	ffffe097          	auipc	ra,0xffffe
    80004e42:	ffa080e7          	jalr	-6(ra) # 80002e38 <iunlockput>
  end_op();
    80004e46:	ffffe097          	auipc	ra,0xffffe
    80004e4a:	7e4080e7          	jalr	2020(ra) # 8000362a <end_op>
  return 0;
    80004e4e:	4501                	li	a0,0
}
    80004e50:	60aa                	ld	ra,136(sp)
    80004e52:	640a                	ld	s0,128(sp)
    80004e54:	6149                	addi	sp,sp,144
    80004e56:	8082                	ret
    end_op();
    80004e58:	ffffe097          	auipc	ra,0xffffe
    80004e5c:	7d2080e7          	jalr	2002(ra) # 8000362a <end_op>
    return -1;
    80004e60:	557d                	li	a0,-1
    80004e62:	b7fd                	j	80004e50 <sys_mkdir+0x4c>

0000000080004e64 <sys_mknod>:

uint64
sys_mknod(void)
{
    80004e64:	7135                	addi	sp,sp,-160
    80004e66:	ed06                	sd	ra,152(sp)
    80004e68:	e922                	sd	s0,144(sp)
  ...
  begin_op();
    ...
    80004e70:	73e080e7          	jalr	1854(ra) # 800035aa <begin_op>
  if((argstr(0, path, MAXPATH)) < 0 ||
    80004e74:	08000613          	li	a2,128
    80004e78:	f7040593          	addi	a1,s0,-144
    80004e7c:	4501                	li	a0,0
    80004e7e:	ffffd097          	auipc	ra,0xffffd
    80004e82:	0ba080e7          	jalr	186(ra) # 80001f38 <argstr>
    80004e86:	04054a63          	bltz	a0,80004eda <sys_mknod+0x76>
     argint(1, &major) < 0 ||
    80004e8a:	f6c40593          	addi	a1,s0,-148
    80004e8e:	4505                	li	a0,1
    80004e90:	ffffd097          	auipc	ra,0xffffd
    80004e94:	064080e7          	jalr	100(ra) # 80001ef4 <argint>
  if((argstr(0, path, MAXPATH)) < 0 ||
    80004e98:	04054163          	bltz	a0,80004eda <sys_mknod+0x76>
     argint(2, &minor) < 0 ||
    80004e9c:	f6840593          	addi	a1,s0,-152
    80004ea0:	4509                	li	a0,2
    80004ea2:	ffffd097          	auipc	ra,0xffffd
    80004ea6:	052080e7          	jalr	82(ra) # 80001ef4 <argint>
     argint(1, &major) < 0 ||
    80004eaa:	02054863          	bltz	a0,80004eda <sys_mknod+0x76>
     (ip = create(path, T_DEVICE, major, minor)) == 0){
    80004eae:	f6841683          	lh	a3,-152(s0)
    80004eb2:	f6c41603          	lh	a2,-148(s0)
    80004eb6:	458d                	li	a1,3
    80004eb8:	f7040513          	addi	a0,s0,-144
    80004ebc:	fffff097          	auipc	ra,0xfffff
    80004ec0:	64e080e7          	jalr	1614(ra) # 8000450a <create>
     argint(2, &minor) < 0 ||
    80004ec4:	c919                	beqz	a0,80004eda <sys_mknod+0x76>
    end_op();
    return -1;
  }
  iunlockput(ip);
    80004ec6:	ffffe097          	auipc	ra,0xffffe
    80004eca:	f72080e7          	jalr	-142(ra) # 80002e38 <iunlockput>
  end_op();
    80004ece:	ffffe097          	auipc	ra,0xffffe
    80004ed2:	75c080e7          	jalr	1884(ra) # 8000362a <end_op>
  return 0;
    80004ed6:	4501                	li	a0,0
    80004ed8:	a031                	j	80004ee4 <sys_mknod+0x80>
    end_op();
    80004eda:	ffffe097          	auipc	ra,0xffffe
    80004ede:	750080e7          	jalr	1872(ra) # 8000362a <end_op>
    return -1;
...
sys_chdir(void)
{
  ...
  struct proc *p = myproc();
    ...
    80004efc:	f50080e7          	jalr	-176(ra) # 80000e48 <myproc>
    80004f00:	892a                	mv	s2,a0
  
  begin_op();
    80004f02:	ffffe097          	auipc	ra,0xffffe
    80004f06:	6a8080e7          	jalr	1704(ra) # 800035aa <begin_op>
  if(argstr(0, path, MAXPATH) < 0 || (ip = namei(path)) == 0){
    80004f0a:	08000613          	li	a2,128
    80004f0e:	f6040593          	addi	a1,s0,-160
    80004f12:	4501                	li	a0,0
    80004f14:	ffffd097          	auipc	ra,0xffffd
    80004f18:	024080e7          	jalr	36(ra) # 80001f38 <argstr>
    80004f1c:	04054b63          	bltz	a0,80004f72 <sys_chdir+0x86>
    80004f20:	f6040513          	addi	a0,s0,-160
    80004f24:	ffffe097          	auipc	ra,0xffffe
    80004f28:	46a080e7          	jalr	1130(ra) # 8000338e <namei>
    80004f2c:	84aa                	mv	s1,a0
    80004f2e:	c131                	beqz	a0,80004f72 <sys_chdir+0x86>
    end_op();
    return -1;
  }
  ilock(ip);
    80004f30:	ffffe097          	auipc	ra,0xffffe
    80004f34:	bfc080e7          	jalr	-1028(ra) # 80002b2c <ilock>
  if(ip->type != T_DIR){
    80004f38:	04449703          	lh	a4,68(s1)
    80004f3c:	4785                	li	a5,1
    80004f3e:	04f71063          	bne	a4,a5,80004f7e <sys_chdir+0x92>
    iunlockput(ip);
    end_op();
    return -1;
  }
  iunlock(ip);
    ...
    80004f48:	caa080e7          	jalr	-854(ra) # 80002bee <iunlock>
  iput(p->cwd);
    80004f4c:	15093503          	ld	a0,336(s2)
    80004f50:	ffffe097          	auipc	ra,0xffffe
    80004f54:	e40080e7          	jalr	-448(ra) # 80002d90 <iput>
  end_op();
    80004f58:	ffffe097          	auipc	ra,0xffffe
    80004f5c:	6d2080e7          	jalr	1746(ra) # 8000362a <end_op>
  p->cwd = ip;
    80004f60:	14993823          	sd	s1,336(s2)
  return 0;
    80004f64:	4501                	li	a0,0
}
    80004f66:	60ea                	ld	ra,152(sp)
    80004f68:	644a                	ld	s0,144(sp)
    80004f6a:	64aa                	ld	s1,136(sp)
    80004f6c:	690a                	ld	s2,128(sp)
    80004f6e:	610d                	addi	sp,sp,160
    80004f70:	8082                	ret
    end_op();
    80004f72:	ffffe097          	auipc	ra,0xffffe
    80004f76:	6b8080e7          	jalr	1720(ra) # 8000362a <end_op>
    return -1;
    80004f7a:	557d                	li	a0,-1
    80004f7c:	b7ed                	j	80004f66 <sys_chdir+0x7a>
    iunlockput(ip);
    80004f7e:	8526                	mv	a0,s1
    80004f80:	ffffe097          	auipc	ra,0xffffe
    80004f84:	eb8080e7          	jalr	-328(ra) # 80002e38 <iunlockput>
    end_op();
    80004f88:	ffffe097          	auipc	ra,0xffffe
    80004f8c:	6a2080e7          	jalr	1698(ra) # 8000362a <end_op>
    return -1;
    80004f90:	557d                	li	a0,-1
    80004f92:	bfd1                	j	80004f66 <sys_chdir+0x7a>
...
sys_exec(void)
{
    80004f94:	7145                	addi	sp,sp,-464
    80004f96:	e786                	sd	ra,456(sp)
    80004f98:	e3a2                	sd	s0,448(sp)
    80004f9a:	ff26                	sd	s1,440(sp)
    80004f9c:	fb4a                	sd	s2,432(sp)
    80004f9e:	f74e                	sd	s3,424(sp)
    80004fa0:	f352                	sd	s4,416(sp)
    80004fa2:	ef56                	sd	s5,408(sp)
    80004fa4:	0b80                	addi	s0,sp,464
  ...
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    ...
    80004faa:	f4040593          	addi	a1,s0,-192
    80004fae:	4501                	li	a0,0
    80004fb0:	ffffd097          	auipc	ra,0xffffd
    80004fb4:	f88080e7          	jalr	-120(ra) # 80001f38 <argstr>
    return -1;
    80004fb8:	597d                	li	s2,-1
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    80004fba:	0c054a63          	bltz	a0,8000508e <sys_exec+0xfa>
    80004fbe:	e3840593          	addi	a1,s0,-456
    80004fc2:	4505                	li	a0,1
    80004fc4:	ffffd097          	auipc	ra,0xffffd
    80004fc8:	f52080e7          	jalr	-174(ra) # 80001f16 <argaddr>
    80004fcc:	0c054163          	bltz	a0,8000508e <sys_exec+0xfa>
  }
  memset(argv, 0, sizeof(argv));
    80004fd0:	10000613          	li	a2,256
    80004fd4:	4581                	li	a1,0
    80004fd6:	e4040513          	addi	a0,s0,-448
    80004fda:	ffffb097          	auipc	ra,0xffffb
    80004fde:	19e080e7          	jalr	414(ra) # 80000178 <memset>
  for(i=0;; i++){
    if(i >= NELEM(argv)){
    80004fe2:	e4040493          	addi	s1,s0,-448
  memset(argv, 0, sizeof(argv));
    80004fe6:	89a6                	mv	s3,s1
    80004fe8:	4901                	li	s2,0
    if(i >= NELEM(argv)){
    80004fea:	02000a13          	li	s4,32
    80004fee:	00090a9b          	sext.w	s5,s2
      goto bad;
    }
    if(fetchaddr(uargv+sizeof(uint64)*i, (uint64*)&uarg) < 0){
    80004ff2:	00391513          	slli	a0,s2,0x3
    80004ff6:	e3040593          	addi	a1,s0,-464
    80004ffa:	e3843783          	ld	a5,-456(s0)
    80004ffe:	953e                	add	a0,a0,a5
    80005000:	ffffd097          	auipc	ra,0xffffd
    80005004:	e5a080e7          	jalr	-422(ra) # 80001e5a <fetchaddr>
    80005008:	02054a63          	bltz	a0,8000503c <sys_exec+0xa8>
      goto bad;
    }
    if(uarg == 0){
    8000500c:	e3043783          	ld	a5,-464(s0)
    80005010:	c3b9                	beqz	a5,80005056 <sys_exec+0xc2>
      argv[i] = 0;
      break;
    }
    argv[i] = kalloc();
    80005012:	ffffb097          	auipc	ra,0xffffb
    80005016:	106080e7          	jalr	262(ra) # 80000118 <kalloc>
    8000501a:	85aa                	mv	a1,a0
    8000501c:	00a9b023          	sd	a0,0(s3)
    if(argv[i] == 0)
    80005020:	cd11                	beqz	a0,8000503c <sys_exec+0xa8>
      goto bad;
    if(fetchstr(uarg, argv[i], PGSIZE) < 0)
    80005022:	6605                	lui	a2,0x1
    80005024:	e3043503          	ld	a0,-464(s0)
    80005028:	ffffd097          	auipc	ra,0xffffd
    8000502c:	e84080e7          	jalr	-380(ra) # 80001eac <fetchstr>
    80005030:	00054663          	bltz	a0,8000503c <sys_exec+0xa8>
    if(i >= NELEM(argv)){
    80005034:	0905                	addi	s2,s2,1
    80005036:	09a1                	addi	s3,s3,8
    80005038:	fb491be3          	bne	s2,s4,80004fee <sys_exec+0x5a>
    kfree(argv[i]);
 ...
 bad:
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    8000503c:	10048913          	addi	s2,s1,256
    80005040:	6088                	ld	a0,0(s1)
    80005042:	c529                	beqz	a0,8000508c <sys_exec+0xf8>
    kfree(argv[i]);
    80005044:	ffffb097          	auipc	ra,0xffffb
    80005048:	fd8080e7          	jalr	-40(ra) # 8000001c <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    8000504c:	04a1                	addi	s1,s1,8
    8000504e:	ff2499e3          	bne	s1,s2,80005040 <sys_exec+0xac>
  return -1;
    80005052:	597d                	li	s2,-1
    80005054:	a82d                	j	8000508e <sys_exec+0xfa>
      argv[i] = 0;
    80005056:	0a8e                	slli	s5,s5,0x3
    80005058:	fc040793          	addi	a5,s0,-64
    8000505c:	9abe                	add	s5,s5,a5
    8000505e:	e80ab023          	sd	zero,-384(s5)
  int ret = exec(path, argv);
    80005062:	e4040593          	addi	a1,s0,-448
    80005066:	f4040513          	addi	a0,s0,-192
    8000506a:	fffff097          	auipc	ra,0xfffff
    8000506e:	06c080e7          	jalr	108(ra) # 800040d6 <exec>
    80005072:	892a                	mv	s2,a0
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80005074:	10048993          	addi	s3,s1,256
    80005078:	6088                	ld	a0,0(s1)
    8000507a:	c911                	beqz	a0,8000508e <sys_exec+0xfa>
    kfree(argv[i]);
    8000507c:	ffffb097          	auipc	ra,0xffffb
    80005080:	fa0080e7          	jalr	-96(ra) # 8000001c <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80005084:	04a1                	addi	s1,s1,8
    80005086:	ff3499e3          	bne	s1,s3,80005078 <sys_exec+0xe4>
    8000508a:	a011                	j	8000508e <sys_exec+0xfa>
  return -1;
    8000508c:	597d                	li	s2,-1
}
    8000508e:	854a                	mv	a0,s2
    80005090:	60be                	ld	ra,456(sp)
    80005092:	641e                	ld	s0,448(sp)
    80005094:	74fa                	ld	s1,440(sp)
    80005096:	795a                	ld	s2,432(sp)
    80005098:	79ba                	ld	s3,424(sp)
    8000509a:	7a1a                	ld	s4,416(sp)
    8000509c:	6afa                	ld	s5,408(sp)
    8000509e:	6179                	addi	sp,sp,464
    800050a0:	8082                	ret

00000000800050a2 <sys_pipe>:

uint64
sys_pipe(void)
{
    800050a2:	7139                	addi	sp,sp,-64
    800050a4:	fc06                	sd	ra,56(sp)
    800050a6:	f822                	sd	s0,48(sp)
    800050a8:	f426                	sd	s1,40(sp)
  ...
  struct proc *p = myproc();
    ...
    800050b0:	d9c080e7          	jalr	-612(ra) # 80000e48 <myproc>
    800050b4:	84aa                	mv	s1,a0

  if(argaddr(0, &fdarray) < 0)
    800050b6:	fd840593          	addi	a1,s0,-40
    800050ba:	4501                	li	a0,0
    800050bc:	ffffd097          	auipc	ra,0xffffd
    800050c0:	e5a080e7          	jalr	-422(ra) # 80001f16 <argaddr>
    return -1;
    800050c4:	57fd                	li	a5,-1
  if(argaddr(0, &fdarray) < 0)
    800050c6:	0e054063          	bltz	a0,800051a6 <sys_pipe+0x104>
  if(pipealloc(&rf, &wf) < 0)
    800050ca:	fc840593          	addi	a1,s0,-56
    800050ce:	fd040513          	addi	a0,s0,-48
    800050d2:	fffff097          	auipc	ra,0xfffff
    800050d6:	cd4080e7          	jalr	-812(ra) # 80003da6 <pipealloc>
    return -1;
    800050da:	57fd                	li	a5,-1
  if(pipealloc(&rf, &wf) < 0)
    800050dc:	0c054563          	bltz	a0,800051a6 <sys_pipe+0x104>
  fd0 = -1;
    800050e0:	fcf42223          	sw	a5,-60(s0)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    800050e4:	fd043503          	ld	a0,-48(s0)
    800050e8:	fffff097          	auipc	ra,0xfffff
    800050ec:	3e0080e7          	jalr	992(ra) # 800044c8 <fdalloc>
    800050f0:	fca42223          	sw	a0,-60(s0)
    800050f4:	08054c63          	bltz	a0,8000518c <sys_pipe+0xea>
    800050f8:	fc843503          	ld	a0,-56(s0)
    800050fc:	fffff097          	auipc	ra,0xfffff
    80005100:	3cc080e7          	jalr	972(ra) # 800044c8 <fdalloc>
    80005104:	fca42023          	sw	a0,-64(s0)
    80005108:	06054863          	bltz	a0,80005178 <sys_pipe+0xd6>
      p->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    ...
    8000510e:	fc440613          	addi	a2,s0,-60
    80005112:	fd843583          	ld	a1,-40(s0)
    80005116:	68a8                	ld	a0,80(s1)
    80005118:	ffffc097          	auipc	ra,0xffffc
    8000511c:	9f2080e7          	jalr	-1550(ra) # 80000b0a <copyout>
    80005120:	02054063          	bltz	a0,80005140 <sys_pipe+0x9e>
    ...
    80005136:	9d8080e7          	jalr	-1576(ra) # 80000b0a <copyout>
    p->ofile[fd1] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    8000513c:	06055563          	bgez	a0,800051a6 <sys_pipe+0x104>
    p->ofile[fd0] = 0;
    80005140:	fc442783          	lw	a5,-60(s0)
    80005144:	07e9                	addi	a5,a5,26
    80005146:	078e                	slli	a5,a5,0x3
    80005148:	97a6                	add	a5,a5,s1
    8000514a:	0007b023          	sd	zero,0(a5)
    p->ofile[fd1] = 0;
    8000514e:	fc042503          	lw	a0,-64(s0)
    80005152:	0569                	addi	a0,a0,26
    80005154:	050e                	slli	a0,a0,0x3
    80005156:	9526                	add	a0,a0,s1
    80005158:	00053023          	sd	zero,0(a0)
    fileclose(rf);
    8000515c:	fd043503          	ld	a0,-48(s0)
    80005160:	fffff097          	auipc	ra,0xfffff
    80005164:	916080e7          	jalr	-1770(ra) # 80003a76 <fileclose>
    fileclose(wf);
    80005168:	fc843503          	ld	a0,-56(s0)
    8000516c:	fffff097          	auipc	ra,0xfffff
    80005170:	90a080e7          	jalr	-1782(ra) # 80003a76 <fileclose>
    return -1;
    80005174:	57fd                	li	a5,-1
    80005176:	a805                	j	800051a6 <sys_pipe+0x104>
    if(fd0 >= 0)
    80005178:	fc442783          	lw	a5,-60(s0)
    8000517c:	0007c863          	bltz	a5,8000518c <sys_pipe+0xea>
      p->ofile[fd0] = 0;
    80005180:	01a78513          	addi	a0,a5,26
    ...
    80005194:	8e6080e7          	jalr	-1818(ra) # 80003a76 <fileclose>
    fileclose(wf);
    80005198:	fc843503          	ld	a0,-56(s0)
    8000519c:	fffff097          	auipc	ra,0xfffff
    800051a0:	8da080e7          	jalr	-1830(ra) # 80003a76 <fileclose>
    return -1;
    800051a4:	57fd                	li	a5,-1
}
    800051a6:	853e                	mv	a0,a5
    800051a8:	70e2                	ld	ra,56(sp)
    800051aa:	7442                	ld	s0,48(sp)
    800051ac:	74a2                	ld	s1,40(sp)
    800051ae:	6121                	addi	sp,sp,64
    800051b0:	8082                	ret

00000000800051b2 <sys_symlink>:

int sys_symlink(void)
{
    800051b2:	712d                	addi	sp,sp,-288
    800051b4:	ee06                	sd	ra,280(sp)
    800051b6:	ea22                	sd	s0,272(sp)
    800051b8:	e626                	sd	s1,264(sp)
    800051ba:	e24a                	sd	s2,256(sp)
    800051bc:	1200                	addi	s0,sp,288
  char target[MAXPATH]; // 存储从用户空间传递过来的目标文件路径
  char path[MAXPATH]; // 存储从用户空间传递过来的符号链接路径
  struct inode* ip;
  // 获取用户传递的参数
  if(argstr(0,target,MAXPATH)<0||argstr(1,path,MAXPATH)<0)
    800051be:	08000613          	li	a2,128
    800051c2:	f6040593          	addi	a1,s0,-160
    800051c6:	4501                	li	a0,0
    800051c8:	ffffd097          	auipc	ra,0xffffd
    800051cc:	d70080e7          	jalr	-656(ra) # 80001f38 <argstr>
    800051d0:	0a054763          	bltz	a0,8000527e <sys_symlink+0xcc>
    800051d4:	08000613          	li	a2,128
    800051d8:	ee040593          	addi	a1,s0,-288
    800051dc:	4505                	li	a0,1
    800051de:	ffffd097          	auipc	ra,0xffffd
    800051e2:	d5a080e7          	jalr	-678(ra) # 80001f38 <argstr>
    800051e6:	08054e63          	bltz	a0,80005282 <sys_symlink+0xd0>
  {
    return -1;
  }
  // 开始文件系统操作
  begin_op();
    ...
    800051ee:	3c0080e7          	jalr	960(ra) # 800035aa <begin_op>
  // 根据传递的路径创建一个类型为 T_SYMLINK 的文件，并返回对应的 inode
  if((ip=create(path,T_SYMLINK,0,0))==0)
    800051f2:	4681                	li	a3,0
    800051f4:	4601                	li	a2,0
    800051f6:	4591                	li	a1,4
    800051f8:	ee040513          	addi	a0,s0,-288
    800051fc:	fffff097          	auipc	ra,0xfffff
    80005200:	30e080e7          	jalr	782(ra) # 8000450a <create>
    80005204:	84aa                	mv	s1,a0
    80005206:	c939                	beqz	a0,8000525c <sys_symlink+0xaa>
  {
    end_op();
    return -1;
  }
  // 将目标文件路径写入符号链接文件的 inode 中
  if(writei(ip,0,(uint64)&target,0,strlen(target))!=strlen(target))
    80005208:	f6040513          	addi	a0,s0,-160
    8000520c:	ffffb097          	auipc	ra,0xffffb
    80005210:	0f0080e7          	jalr	240(ra) # 800002fc <strlen>
    80005214:	0005071b          	sext.w	a4,a0
    80005218:	4681                	li	a3,0
    8000521a:	f6040613          	addi	a2,s0,-160
    8000521e:	4581                	li	a1,0
    80005220:	8526                	mv	a0,s1
    80005222:	ffffe097          	auipc	ra,0xffffe
    80005226:	d60080e7          	jalr	-672(ra) # 80002f82 <writei>
    8000522a:	892a                	mv	s2,a0
    8000522c:	f6040513          	addi	a0,s0,-160
    80005230:	ffffb097          	auipc	ra,0xffffb
    80005234:	0cc080e7          	jalr	204(ra) # 800002fc <strlen>
    80005238:	02a91863          	bne	s2,a0,80005268 <sys_symlink+0xb6>
    iunlockput(ip);
    end_op();
    return -1;
  }
  ...
  iunlockput(ip);
    ...
    80005242:	bfa080e7          	jalr	-1030(ra) # 80002e38 <iunlockput>
  // 结束文件系统操作
  end_op();
    80005246:	ffffe097          	auipc	ra,0xffffe
    8000524a:	3e4080e7          	jalr	996(ra) # 8000362a <end_op>
  return 0;
    8000524e:	4501                	li	a0,0
}
    80005250:	60f2                	ld	ra,280(sp)
    80005252:	6452                	ld	s0,272(sp)
    80005254:	64b2                	ld	s1,264(sp)
    80005256:	6912                	ld	s2,256(sp)
    80005258:	6115                	addi	sp,sp,288
    8000525a:	8082                	ret
    end_op();
    8000525c:	ffffe097          	auipc	ra,0xffffe
    80005260:	3ce080e7          	jalr	974(ra) # 8000362a <end_op>
    return -1;
    80005264:	557d                	li	a0,-1
    80005266:	b7ed                	j	80005250 <sys_symlink+0x9e>
    iunlockput(ip);
    80005268:	8526                	mv	a0,s1
    8000526a:	ffffe097          	auipc	ra,0xffffe
    8000526e:	bce080e7          	jalr	-1074(ra) # 80002e38 <iunlockput>
    end_op();
    80005272:	ffffe097          	auipc	ra,0xffffe
    80005276:	3b8080e7          	jalr	952(ra) # 8000362a <end_op>
    return -1;
    8000527a:	557d                	li	a0,-1
    8000527c:	bfd1                	j	80005250 <sys_symlink+0x9e>
    return -1;
    8000527e:	557d                	li	a0,-1
    80005280:	bfc1                	j	80005250 <sys_symlink+0x9e>
    80005282:	557d                	li	a0,-1
    80005284:	b7f1                	j	80005250 <sys_symlink+0x9e>
	...
...
0000000080005290 <kernelvec>:
    ...
    800052d0:	a57fc0ef          	jal	ra,80001d26 <kerneltrap>
...
plic_claim(void)
{
  ...
  int hart = cpuid();
    ...
    800053a4:	a7c080e7          	jalr	-1412(ra) # 80000e1c <cpuid>
...
plic_complete(int irq)
{
  ...
  int hart = cpuid();
    ...
    800053cc:	a54080e7          	jalr	-1452(ra) # 80000e1c <cpuid>
...
free_desc(int i)
{
  ...
  wakeup(&disk.free[0]);
    ...
    80005456:	23e080e7          	jalr	574(ra) # 80001690 <wakeup>
}
    ...
    80005466:	2fe50513          	addi	a0,a0,766 # 80008760 <syscalls+0x398>
    8000546a:	00001097          	auipc	ra,0x1
    8000546e:	a1e080e7          	jalr	-1506(ra) # 80005e88 <panic>
    panic("free_desc 2");
    80005472:	00003517          	auipc	a0,0x3
    80005476:	2fe50513          	addi	a0,a0,766 # 80008770 <syscalls+0x3a8>
...
0000000080005482 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    80005490:	2f458593          	addi	a1,a1,756 # 80008780 <syscalls+0x3b8>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    800055f4:	00013517          	auipc	a0,0x13
    800055f8:	b3450513          	addi	a0,a0,-1228 # 80018128 <disk+0x2128>
  ...
  for(int i = 0; i < NUM; i++){
    80005606:	4c21                	li	s8,8
      disk.free[i] = 0;
    80005608:	00011b97          	auipc	s7,0x11
    8000560c:	9f8b8b93          	addi	s7,s7,-1544 # 80016000 <disk>
  ...
  for(int i = 0; i < NUM; i++){
    80005632:	00013697          	auipc	a3,0x13
    80005636:	9e668693          	addi	a3,a3,-1562 # 80018018 <disk+0x2018>
  ...
  while(1){
    ...
    80005682:	00013597          	auipc	a1,0x13
    80005686:	aa658593          	addi	a1,a1,-1370 # 80018128 <disk+0x2128>
    8000568a:	00013517          	auipc	a0,0x13
    8000568e:	98e50513          	addi	a0,a0,-1650 # 80018018 <disk+0x2018>
    80005692:	ffffc097          	auipc	ra,0xffffc
    80005696:	e72080e7          	jalr	-398(ra) # 80001504 <sleep>
  for(int i = 0; i < 3; i++){
  ...
  if(write)
    ...
    800056aa:	00011717          	auipc	a4,0x11
    800056ae:	95670713          	addi	a4,a4,-1706 # 80016000 <disk>
  ...
  buf0->reserved = 0;
    ...
    800056c2:	00011717          	auipc	a4,0x11
    800056c6:	93e70713          	addi	a4,a4,-1730 # 80016000 <disk>
  ...
  disk.desc[idx[0]].addr = (uint64) buf0;
    ...
    800056d8:	00013697          	auipc	a3,0x13
    800056dc:	92868693          	addi	a3,a3,-1752 # 80018000 <disk+0x2000>
  ...
  disk.desc[idx[0]].next = idx[1];
    ...
    80005700:	00e61723          	sh	a4,14(a2) # ffffffffffffe00e <end+0xffffffff7ffdcdce>
  ...
  if(write)
    ...
    8000571e:	00013697          	auipc	a3,0x13
    80005722:	8e26b683          	ld	a3,-1822(a3) # 80018000 <disk+0x2000>
    80005726:	96ba                	add	a3,a3,a4
    80005728:	00069623          	sh	zero,12(a3)
  else
    disk.desc[idx[1]].flags = VRING_DESC_F_WRITE; // device writes b->data
  disk.desc[idx[1]].flags |= VRING_DESC_F_NEXT;
    8000572c:	00011817          	auipc	a6,0x11
    80005730:	8d480813          	addi	a6,a6,-1836 # 80016000 <disk>
    80005734:	00013517          	auipc	a0,0x13
    80005738:	8cc50513          	addi	a0,a0,-1844 # 80018000 <disk+0x2000>
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    800057ce:	00013997          	auipc	s3,0x13
    800057d2:	95a98993          	addi	s3,s3,-1702 # 80018128 <disk+0x2128>
  while(b->disk == 1) {
    ...
    800057e0:	d28080e7          	jalr	-728(ra) # 80001504 <sleep>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    800057f8:	00011797          	auipc	a5,0x11
    800057fc:	80878793          	addi	a5,a5,-2040 # 80016000 <disk>
    80005800:	97ba                	add	a5,a5,a4
    80005802:	0207b423          	sd	zero,40(a5)
    int flag = disk.desc[i].flags;
    80005806:	00012997          	auipc	s3,0x12
    8000580a:	7fa98993          	addi	s3,s3,2042 # 80018000 <disk+0x2000>
  ...
  release(&disk.vdisk_lock);
    8000582e:	00013517          	auipc	a0,0x13
    80005832:	8fa50513          	addi	a0,a0,-1798 # 80018128 <disk+0x2128>
    ...
    80005858:	8082                	ret
    disk.desc[idx[1]].flags = VRING_DESC_F_WRITE; // device writes b->data
    8000585a:	00012697          	auipc	a3,0x12
    8000585e:	7a66b683          	ld	a3,1958(a3) # 80018000 <disk+0x2000>
  ...
  struct virtio_blk_req *buf0 = &disk.ops[idx[0]];
    ...
    80005876:	00011517          	auipc	a0,0x11
    8000587a:	83250513          	addi	a0,a0,-1998 # 800160a8 <disk+0xa8>
  ...
  if(write)
    ...
    8000588c:	00010717          	auipc	a4,0x10
    80005890:	77470713          	addi	a4,a4,1908 # 80016000 <disk>
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    800058a8:	00013517          	auipc	a0,0x13
    800058ac:	88050513          	addi	a0,a0,-1920 # 80018128 <disk+0x2128>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  while(disk.used_idx != disk.used->idx){
    800058c6:	00012797          	auipc	a5,0x12
    800058ca:	73a78793          	addi	a5,a5,1850 # 80018000 <disk+0x2000>
    ...
    800058dc:	00010917          	auipc	s2,0x10
    800058e0:	72490913          	addi	s2,s2,1828 # 80016000 <disk>
    800058e4:	00012497          	auipc	s1,0x12
    800058e8:	71c48493          	addi	s1,s1,1820 # 80018000 <disk+0x2000>
    __sync_synchronize();
    ...
    8000591e:	d76080e7          	jalr	-650(ra) # 80001690 <wakeup>
  ...
  release(&disk.vdisk_lock);
    8000593a:	00012517          	auipc	a0,0x12
    8000593e:	7ee50513          	addi	a0,a0,2030 # 80018128 <disk+0x2128>
    ...
    8000595a:	e9a50513          	addi	a0,a0,-358 # 800087f0 <syscalls+0x428>
...
timerinit()
{
  ...
  *(uint64*)CLINT_MTIMECMP(id) = *(uint64*)CLINT_MTIME + interval;
  ...
  uint64 *scratch = &timer_scratch[id][0];
    ...
    8000599c:	00013717          	auipc	a4,0x13
    800059a0:	66470713          	addi	a4,a4,1636 # 80019000 <timer_scratch>
...
00000000800059d8 <start>:
{
  ...
  x &= ~MSTATUS_MPP_MASK;
    ...
    800059e6:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7ffdd5bf>
  ...
  asm volatile("csrw mepc, %0" : : "r" (x));
    ...
    800059fc:	92e78793          	addi	a5,a5,-1746 # 80000326 <main>
...
consolewrite(int user_src, uint64 src, int n)
{
  ...
  for(i = 0; i < n; i++){
    ...
    80005a7a:	e88080e7          	jalr	-376(ra) # 800018fe <either_copyin>
...
consoleread(int user_dst, uint64 dst, int n)
{
  ...
  acquire(&cons.lock);
    80005ad6:	0001b517          	auipc	a0,0x1b
    80005ada:	66a50513          	addi	a0,a0,1642 # 80021140 <cons>
  ...
  while(n > 0){
    ...
    while(cons.r == cons.w){
    80005ae6:	0001b497          	auipc	s1,0x1b
    80005aea:	65a48493          	addi	s1,s1,1626 # 80021140 <cons>
      if(myproc()->killed){
        release(&cons.lock);
        return -1;
      }
    ...
    80005af0:	0001b917          	auipc	s2,0x1b
    80005af4:	6e890913          	addi	s2,s2,1768 # 800211d8 <cons+0x98>
    }
  ...
  while(n > 0){
    ...
    80005b12:	33a080e7          	jalr	826(ra) # 80000e48 <myproc>
    ...
    80005b22:	9e6080e7          	jalr	-1562(ra) # 80001504 <sleep>
    while(cons.r == cons.w){
    ...
    80005b5e:	d4e080e7          	jalr	-690(ra) # 800018a8 <either_copyout>
  ...
  release(&cons.lock);
    80005b6e:	0001b517          	auipc	a0,0x1b
    80005b72:	5d250513          	addi	a0,a0,1490 # 80021140 <cons>
  ...
  return target - n;
    ...
    80005bb8:	fb777be3          	bgeu	a4,s7,80005b6e <consoleread+0xc0>
        cons.r--;
    80005bbc:	0001b717          	auipc	a4,0x1b
    80005bc0:	60f72e23          	sw	a5,1564(a4) # 800211d8 <cons+0x98>
...
consoleintr(int c)
{
  ...
  acquire(&cons.lock);
    80005c16:	0001b517          	auipc	a0,0x1b
    80005c1a:	52a50513          	addi	a0,a0,1322 # 80021140 <cons>
  ...
  case C('P'):  // Print process list.
    ...
    80005c40:	d18080e7          	jalr	-744(ra) # 80001954 <procdump>
      }
    }
    break;
  }
  ...
  release(&cons.lock);
    80005c44:	0001b517          	auipc	a0,0x1b
    80005c48:	4fc50513          	addi	a0,a0,1276 # 80021140 <cons>
  ...
  switch(c){
    ...
    80005c68:	0001b717          	auipc	a4,0x1b
    80005c6c:	4d870713          	addi	a4,a4,1240 # 80021140 <cons>
    ...
    80005cc4:	5187a783          	lw	a5,1304(a5) # 800211d8 <cons+0x98>
    ...
    while(cons.e != cons.w &&
    80005cd4:	0001b717          	auipc	a4,0x1b
    80005cd8:	46c70713          	addi	a4,a4,1132 # 80021140 <cons>
    80005cdc:	0a072783          	lw	a5,160(a4)
    80005ce0:	09c72703          	lw	a4,156(a4)
          cons.buf[(cons.e-1) % INPUT_BUF] != '\n'){
    80005ce4:	0001b497          	auipc	s1,0x1b
    80005ce8:	45c48493          	addi	s1,s1,1116 # 80021140 <cons>
    while(cons.e != cons.w &&
    ...
    80005d24:	42070713          	addi	a4,a4,1056 # 80021140 <cons>
    ...
    80005d36:	0001b717          	auipc	a4,0x1b
    80005d3a:	4af72523          	sw	a5,1194(a4) # 800211e0 <cons+0xa0>
      consputc(BACKSPACE);
    ...
    80005d58:	e72080e7          	jalr	-398(ra) # 80005bc6 <consputc>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    80005d5c:	0001b797          	auipc	a5,0x1b
    80005d60:	3e478793          	addi	a5,a5,996 # 80021140 <cons>
    ...
    80005d7c:	00e78c23          	sb	a4,24(a5)
        cons.w = cons.e;
    80005d80:	0001b797          	auipc	a5,0x1b
    80005d84:	44c7ae23          	sw	a2,1116(a5) # 800211dc <cons+0x9c>
        wakeup(&cons.r);
    80005d88:	0001b517          	auipc	a0,0x1b
    80005d8c:	45050513          	addi	a0,a0,1104 # 800211d8 <cons+0x98>
    80005d90:	ffffc097          	auipc	ra,0xffffc
    80005d94:	900080e7          	jalr	-1792(ra) # 80001690 <wakeup>
...
consoleinit(void)
{
  ...
  initlock(&cons.lock, "cons");
    ...
    80005da6:	a6658593          	addi	a1,a1,-1434 # 80008808 <syscalls+0x440>
    80005daa:	0001b517          	auipc	a0,0x1b
    80005dae:	39650513          	addi	a0,a0,918 # 80021140 <cons>
  ...
  devsw[CONSOLE].read = consoleread;
    80005dc2:	0000e797          	auipc	a5,0xe
    80005dc6:	71678793          	addi	a5,a5,1814 # 800144d8 <devsw>
...
printint(int xx, int base, int sign)
{
  ...
  do {
    ...
    80005e08:	a3460613          	addi	a2,a2,-1484 # 80008838 <digits>
...
panic(char *s)
{
  ...
  pr.locking = 0;
    80005e94:	0001b797          	auipc	a5,0x1b
    80005e98:	3607a623          	sw	zero,876(a5) # 80021200 <pr+0x18>
  printf("panic: ");
    80005e9c:	00003517          	auipc	a0,0x3
    80005ea0:	97450513          	addi	a0,a0,-1676 # 80008810 <syscalls+0x448>
  ...
  printf("\n");
    ...
    80005eba:	19250513          	addi	a0,a0,402 # 80008048 <etext+0x48>
...
0000000080005ed2 <printf>:
{
  ...
  locking = pr.locking;
    80005f04:	0001bd97          	auipc	s11,0x1b
    80005f08:	2fcdad83          	lw	s11,764(s11) # 80021200 <pr+0x18>
  if(locking)
  ...
  consputc('x');
    ...
    80005f34:	908b8b93          	addi	s7,s7,-1784 # 80008838 <digits>
    switch(c){
    80005f38:	07300c93          	li	s9,115
    80005f3c:	06400c13          	li	s8,100
    80005f40:	a82d                	j	80005f7a <printf+0xa8>
    acquire(&pr.lock);
    80005f42:	0001b517          	auipc	a0,0x1b
    80005f46:	2a650513          	addi	a0,a0,678 # 800211e8 <pr>
    ...
    80005f58:	8cc50513          	addi	a0,a0,-1844 # 80008820 <syscalls+0x458>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    80006058:	7c490913          	addi	s2,s2,1988 # 80008818 <syscalls+0x450>
      for(; *s; s++)
  ...
  if(locking)
    ...
    800060a4:	8082                	ret
    release(&pr.lock);
    800060a6:	0001b517          	auipc	a0,0x1b
    800060aa:	14250513          	addi	a0,a0,322 # 800211e8 <pr>
...
printfinit(void)
{
  ...
  initlock(&pr.lock, "pr");
    800060c2:	0001b497          	auipc	s1,0x1b
    800060c6:	12648493          	addi	s1,s1,294 # 800211e8 <pr>
    800060ca:	00002597          	auipc	a1,0x2
    800060ce:	76658593          	addi	a1,a1,1894 # 80008830 <syscalls+0x468>
...
uartinit(void)
{
  ...
  initlock(&uart_tx_lock, "uart");
    ...
    8000611e:	73658593          	addi	a1,a1,1846 # 80008850 <digits+0x18>
    80006122:	0001b517          	auipc	a0,0x1b
    80006126:	0e650513          	addi	a0,a0,230 # 80021208 <uart_tx_lock>
    ...
    8000619a:	06e78c63          	beq	a5,a4,80006212 <uartstart+0x88>
{
    ...
    800061b4:	0001ba17          	auipc	s4,0x1b
    800061b8:	054a0a13          	addi	s4,s4,84 # 80021208 <uart_tx_lock>
    uart_tx_r += 1;
    ...
    800061ee:	4a6080e7          	jalr	1190(ra) # 80001690 <wakeup>
...
0000000080006214 <uartputc>:
{
  ...
  acquire(&uart_tx_lock);
    80006226:	0001b517          	auipc	a0,0x1b
    8000622a:	fe250513          	addi	a0,a0,-30 # 80021208 <uart_tx_lock>
  ...
  if(panicked){
    ...
    8000625a:	0001ba17          	auipc	s4,0x1b
    8000625e:	faea0a13          	addi	s4,s4,-82 # 80021208 <uart_tx_lock>
    ...
    8000627a:	28e080e7          	jalr	654(ra) # 80001504 <sleep>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    ...
    8000628c:	0001b497          	auipc	s1,0x1b
    80006290:	f7c48493          	addi	s1,s1,-132 # 80021208 <uart_tx_lock>
...
uartintr(void)
{
  ...
  acquire(&uart_tx_lock);
    80006314:	0001b497          	auipc	s1,0x1b
    80006318:	ef448493          	addi	s1,s1,-268 # 80021208 <uart_tx_lock>
    ...
    8000635e:	8082                	ret
{
  ...
  r = (lk->locked && lk->cpu == mycpu());
    ...
    80006370:	ac0080e7          	jalr	-1344(ra) # 80000e2c <mycpu>
...
push_off(void)
{
  ...
  mycpu()->noff += 1;
    ...
    800063ae:	a82080e7          	jalr	-1406(ra) # 80000e2c <mycpu>
...
00000000800063d2 <acquire>:
{
  ...
  lk->cpu = mycpu();
    ...
    80006406:	a2a080e7          	jalr	-1494(ra) # 80000e2c <mycpu>
    ...
    8000641a:	44250513          	addi	a0,a0,1090 # 80008858 <digits+0x20>
...
pop_off(void)
{
  ...
  struct cpu *c = mycpu();
    ...
    80006432:	9fe080e7          	jalr	-1538(ra) # 80000e2c <mycpu>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    8000646a:	3fa50513          	addi	a0,a0,1018 # 80008860 <digits+0x28>
    8000646e:	00000097          	auipc	ra,0x0
    80006472:	a1a080e7          	jalr	-1510(ra) # 80005e88 <panic>
    panic("pop_off");
    80006476:	00002517          	auipc	a0,0x2
    8000647a:	40250513          	addi	a0,a0,1026 # 80008878 <digits+0x40>
...
0000000080006486 <release>:
{
  ...
  pop_off();
    ...
    800064c2:	3c250513          	addi	a0,a0,962 # 80008880 <digits+0x48>
