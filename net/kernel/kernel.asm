...
0000000080000000 <_entry>:
    ...
    80000004:	91013103          	ld	sp,-1776(sp) # 80009910 <_GLOBAL_OFFSET_TABLE_+0x8>
    80000008:	6505                	lui	a0,0x1
    8000000a:	f14025f3          	csrr	a1,mhartid
    8000000e:	0585                	addi	a1,a1,1
    80000010:	02b50533          	mul	a0,a0,a1
    80000014:	912a                	add	sp,sp,a0
    80000016:	736060ef          	jal	ra,8000674c <start>
...
kfree(void *pa)
{
  ...
  acquire(&kmem.lock);
    ...
    8000005e:	0ec080e7          	jalr	236(ra) # 80007146 <acquire>
  ...
  release(&kmem.lock);
    ...
    80000072:	18c080e7          	jalr	396(ra) # 800071fa <release>
}
    ...
    8000008e:	b72080e7          	jalr	-1166(ra) # 80006bfc <panic>
...
00000000800000dc <kinit>:
{
  ...
  initlock(&kmem.lock, "kmem");
    ...
    800000f8:	fc2080e7          	jalr	-62(ra) # 800070b6 <initlock>
...
kalloc(void)
{
  ...
  acquire(&kmem.lock);
    ...
    80000130:	01a080e7          	jalr	26(ra) # 80007146 <acquire>
  r = kmem.freelist;
  ...
  release(&kmem.lock);
    ...
    80000148:	0b6080e7          	jalr	182(ra) # 800071fa <release>
  ...
  release(&kmem.lock);
    ...
    80000172:	08c080e7          	jalr	140(ra) # 800071fa <release>
  if(r)
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    80000348:	f14080e7          	jalr	-236(ra) # 80007258 <lockfree_read4>
    ...
    80000368:	8e2080e7          	jalr	-1822(ra) # 80006c46 <printf>
  ...
  scheduler();        
    ...
    80000430:	220080e7          	jalr	544(ra) # 8000664c <pci_init>
    sockinit();
    80000434:	00006097          	auipc	ra,0x6
    80000438:	e0e080e7          	jalr	-498(ra) # 80006242 <sockinit>
...
walk(pagetable_t pagetable, uint64 va, int alloc)
{
  ...
  if(va >= MAXVA)
    ...
    800004aa:	756080e7          	jalr	1878(ra) # 80006bfc <panic>
...
0000000080000600 <kvmmap>:
{
  ...
  if(mappages(kpgtbl, va, sz, pa, perm) != 0)
    ...
    8000062c:	5d4080e7          	jalr	1492(ra) # 80006bfc <panic>
...
uvminit(pagetable_t pagetable, uchar *src, uint sz)
{
  ...
  memmove(mem, src, sz);
    ...
    800008ca:	336080e7          	jalr	822(ra) # 80006bfc <panic>
...
freewalk(pagetable_t pagetable)
{
  ...
  for(int i = 0; i < 512; i++){
    ...
    80000a0c:	1f4080e7          	jalr	500(ra) # 80006bfc <panic>
    }
  }
...
uvmclear(pagetable_t pagetable, uint64 va)
{
  ...
  *pte &= ~PTE_U;
    ...
    80000b62:	09e080e7          	jalr	158(ra) # 80006bfc <panic>
...
proc_mapstacks(pagetable_t kpgtbl) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000dc2:	e3e080e7          	jalr	-450(ra) # 80006bfc <panic>
...
procinit(void)
{
  ...
  initlock(&pid_lock, "nextpid");
    ...
    80000dee:	2cc080e7          	jalr	716(ra) # 800070b6 <initlock>
  initlock(&wait_lock, "wait_lock");
    ...
    80000e06:	2b4080e7          	jalr	692(ra) # 800070b6 <initlock>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000e3c:	27e080e7          	jalr	638(ra) # 800070b6 <initlock>
      p->kstack = KSTACK((int) (p - proc));
...
myproc(void) {
  ...
  push_off();
    ...
    80000eae:	250080e7          	jalr	592(ra) # 800070fa <push_off>
  ...
  pop_off();
    ...
    80000ec8:	2d6080e7          	jalr	726(ra) # 8000719a <pop_off>
  return p;
}
...
forkret(void)
{
  ...
  release(&myproc()->lock);
    ...
    80000eec:	312080e7          	jalr	786(ra) # 800071fa <release>

  if (first) {
    80000ef0:	00009797          	auipc	a5,0x9
    80000ef4:	9c07a783          	lw	a5,-1600(a5) # 800098b0 <first.1722>
  ...
  usertrapret();
    ...
    80000f0e:	9a07a323          	sw	zero,-1626(a5) # 800098b0 <first.1722>
    fsinit(ROOTDEV);
...
allocpid() {
  ...
  acquire(&pid_lock);
    ...
    80000f38:	212080e7          	jalr	530(ra) # 80007146 <acquire>
  pid = nextpid;
    80000f3c:	00009797          	auipc	a5,0x9
    80000f40:	97878793          	addi	a5,a5,-1672 # 800098b4 <nextpid>
  ...
  release(&pid_lock);
    ...
    80000f52:	2ac080e7          	jalr	684(ra) # 800071fa <release>
}
...
00000000800010aa <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800010cc:	07e080e7          	jalr	126(ra) # 80007146 <acquire>
    if(p->state == UNUSED) {
    ...
    800010da:	124080e7          	jalr	292(ra) # 800071fa <release>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  p->context.sp = p->kstack + PGSIZE;
    ...
    80001158:	0a6080e7          	jalr	166(ra) # 800071fa <release>
    return 0;
    ...
    80001170:	08e080e7          	jalr	142(ra) # 800071fa <release>
    return 0;
...
0000000080001178 <userinit>:
{
  ...
  uvminit(p->pagetable, initcode, sizeof(initcode));
    ...
    8000119c:	73858593          	addi	a1,a1,1848 # 800098d0 <initcode>
  ...
  release(&p->lock);
    ...
    800011ec:	012080e7          	jalr	18(ra) # 800071fa <release>
}
...
000000008000126e <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  for(i = 0; i < NOFILE; i++)
    ...
    80001304:	efa080e7          	jalr	-262(ra) # 800071fa <release>
    return -1;
  ...
  release(&np->lock);
    ...
    80001356:	ea8080e7          	jalr	-344(ra) # 800071fa <release>
  acquire(&wait_lock);
    ...
    80001368:	de2080e7          	jalr	-542(ra) # 80007146 <acquire>
  np->parent = p;
    8000136c:	0329bc23          	sd	s2,56(s3)
  release(&wait_lock);
    80001370:	8526                	mv	a0,s1
    80001372:	00006097          	auipc	ra,0x6
    80001376:	e88080e7          	jalr	-376(ra) # 800071fa <release>
  acquire(&np->lock);
    8000137a:	854e                	mv	a0,s3
    8000137c:	00006097          	auipc	ra,0x6
    80001380:	dca080e7          	jalr	-566(ra) # 80007146 <acquire>
  np->state = RUNNABLE;
  ...
  release(&np->lock);
    ...
    80001390:	e6e080e7          	jalr	-402(ra) # 800071fa <release>
}
...
00000000800013aa <scheduler>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    8000142c:	dd2080e7          	jalr	-558(ra) # 800071fa <release>
    for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000143e:	d0c080e7          	jalr	-756(ra) # 80007146 <acquire>
      if(p->state == RUNNABLE) {
...
000000008000144a <sched>:
{
  ...
  if(!holding(&p->lock))
    ...
    80001466:	c6a080e7          	jalr	-918(ra) # 800070cc <holding>
...
0000000080001520 <yield>:
{
  ...
  acquire(&p->lock);
    ...
    80001538:	c12080e7          	jalr	-1006(ra) # 80007146 <acquire>
  p->state = RUNNABLE;
  ...
  release(&p->lock);
    ...
    8000154e:	cb0080e7          	jalr	-848(ra) # 800071fa <release>
}
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  acquire(&p->lock);  //DOC: sleeplock1
    ...
    8000157c:	bce080e7          	jalr	-1074(ra) # 80007146 <acquire>
  release(lk);
    80001580:	854a                	mv	a0,s2
    80001582:	00006097          	auipc	ra,0x6
    80001586:	c78080e7          	jalr	-904(ra) # 800071fa <release>
  ...
  release(&p->lock);
    ...
    800015a4:	c5a080e7          	jalr	-934(ra) # 800071fa <release>
  acquire(lk);
    800015a8:	854a                	mv	a0,s2
    800015aa:	00006097          	auipc	ra,0x6
    800015ae:	b9c080e7          	jalr	-1124(ra) # 80007146 <acquire>
}
...
00000000800015c0 <wait>:
{
  ...
  acquire(&wait_lock);
    ...
    800015f0:	b5a080e7          	jalr	-1190(ra) # 80007146 <acquire>
    havekids = 0;
    ...
    8000168e:	abc080e7          	jalr	-1348(ra) # 80007146 <acquire>
        if(np->state == ZOMBIE){
    ...
    8000169e:	b60080e7          	jalr	-1184(ra) # 800071fa <release>
        havekids = 1;
    ...
    800016ba:	b44080e7          	jalr	-1212(ra) # 800071fa <release>
      return -1;
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000171c:	ae2080e7          	jalr	-1310(ra) # 800071fa <release>
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000173a:	a10080e7          	jalr	-1520(ra) # 80007146 <acquire>
      if(p->state == SLEEPING && p->chan == chan) {
...
00000000800017b8 <exit>:
{
  ...
  if(p == initproc)
    ...
    800017f4:	40c080e7          	jalr	1036(ra) # 80006bfc <panic>
      fileclose(f);
  ...
  acquire(&wait_lock);
    ...
    8000183e:	90c080e7          	jalr	-1780(ra) # 80007146 <acquire>
  reparent(p);
  ...
  acquire(&p->lock);
    ...
    8000185e:	8ec080e7          	jalr	-1812(ra) # 80007146 <acquire>
  p->xstate = status;
  ...
  release(&wait_lock);
    ...
    80001872:	98c080e7          	jalr	-1652(ra) # 800071fa <release>
  sched();
  ...
  panic("zombie exit");
    ...
    8000188a:	376080e7          	jalr	886(ra) # 80006bfc <panic>
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800018b4:	896080e7          	jalr	-1898(ra) # 80007146 <acquire>
    if(p->pid == pid){
    ...
    800018c4:	93a080e7          	jalr	-1734(ra) # 800071fa <release>
  for(p = proc; p < &proc[NPROC]; p++){
  ...
  return -1;
    ...
    800018e6:	918080e7          	jalr	-1768(ra) # 800071fa <release>
      return 0;
...
procdump(void)
{
  ...
  printf("\n");
    ...
    800019ce:	27c080e7          	jalr	636(ra) # 80006c46 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80001a10:	23a080e7          	jalr	570(ra) # 80006c46 <printf>
    printf("\n");
    80001a14:	8552                	mv	a0,s4
    80001a16:	00005097          	auipc	ra,0x5
    80001a1a:	230080e7          	jalr	560(ra) # 80006c46 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80001ae0:	5da080e7          	jalr	1498(ra) # 800070b6 <initlock>
}
...
clockintr()
{
  ...
  acquire(&tickslock);
    ...
    80001bba:	590080e7          	jalr	1424(ra) # 80007146 <acquire>
  ticks++;
  ...
  release(&tickslock);
    ...
    80001bda:	624080e7          	jalr	1572(ra) # 800071fa <release>
}
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    80001c4a:	000080e7          	jalr	ra # 80006c46 <printf>
    80001c4e:	a029                	j	80001c58 <devintr+0x70>
      uartintr();
    80001c50:	00005097          	auipc	ra,0x5
    80001c54:	416080e7          	jalr	1046(ra) # 80007066 <uartintr>
      plic_complete(irq);
...
0000000080001c9c <usertrap>:
{
  ...
  if(lockfree_read4(&p->killed))
    ...
    80001cee:	56e080e7          	jalr	1390(ra) # 80007258 <lockfree_read4>
    ...
    80001d02:	efe080e7          	jalr	-258(ra) # 80006bfc <panic>
    if(lockfree_read4(&p->killed))
    80001d06:	02850513          	addi	a0,a0,40
    80001d0a:	00005097          	auipc	ra,0x5
    80001d0e:	54e080e7          	jalr	1358(ra) # 80007258 <lockfree_read4>
  ...
  if(lockfree_read4(&p->killed))
    ...
    80001d38:	524080e7          	jalr	1316(ra) # 80007258 <lockfree_read4>
  ...
  asm volatile("csrr %0, scause" : "=r" (x) );
    ...
    80001d82:	ec8080e7          	jalr	-312(ra) # 80006c46 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80001d9a:	eb0080e7          	jalr	-336(ra) # 80006c46 <printf>
    p->killed = 1;
...
0000000080001dae <kerneltrap>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001e08:	df8080e7          	jalr	-520(ra) # 80006bfc <panic>
    ...
    80001e18:	de8080e7          	jalr	-536(ra) # 80006bfc <panic>
    printf("scause %p\n", scause);
    ...
    80001e2a:	e20080e7          	jalr	-480(ra) # 80006c46 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
...
argraw(int n)
{
  ...
  panic("argraw");
    ...
    80001ede:	d22080e7          	jalr	-734(ra) # 80006bfc <panic>
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    80002046:	c04080e7          	jalr	-1020(ra) # 80006c46 <printf>
            p->pid, p->name, num);
    p->trapframe->a0 = -1;
...
sys_sleep(void)
{
  ...
  acquire(&tickslock);
    ...
    8000216c:	fde080e7          	jalr	-34(ra) # 80007146 <acquire>
  ticks0 = ticks;
  ...
  release(&tickslock);
    ...
    800021c0:	03e080e7          	jalr	62(ra) # 800071fa <release>
  return 0;
    ...
    800021e2:	01c080e7          	jalr	28(ra) # 800071fa <release>
      return -1;
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80002232:	f18080e7          	jalr	-232(ra) # 80007146 <acquire>
  xticks = ticks;
  ...
  release(&tickslock);
    ...
    8000224a:	fb4080e7          	jalr	-76(ra) # 800071fa <release>
  return xticks;
}
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002282:	e38080e7          	jalr	-456(ra) # 800070b6 <initlock>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    8000230a:	e40080e7          	jalr	-448(ra) # 80007146 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    8000234a:	eb4080e7          	jalr	-332(ra) # 800071fa <release>
      acquiresleep(&b->lock);
  ...
  panic("bget: no buffers");
    ...
    80002388:	878080e7          	jalr	-1928(ra) # 80006bfc <panic>
      b->dev = dev;
    ...
    800023a8:	e56080e7          	jalr	-426(ra) # 800071fa <release>
      acquiresleep(&b->lock);
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    80002418:	7e8080e7          	jalr	2024(ra) # 80006bfc <panic>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    80002450:	cfa080e7          	jalr	-774(ra) # 80007146 <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    8000249a:	d64080e7          	jalr	-668(ra) # 800071fa <release>
}
    ...
    800024b6:	74a080e7          	jalr	1866(ra) # 80006bfc <panic>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    800024d2:	c78080e7          	jalr	-904(ra) # 80007146 <acquire>
  b->refcnt++;
  ...
  release(&bcache.lock);
    ...
    800024e8:	d16080e7          	jalr	-746(ra) # 800071fa <release>
}
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    8000250e:	c3c080e7          	jalr	-964(ra) # 80007146 <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    80002524:	cda080e7          	jalr	-806(ra) # 800071fa <release>
}
...
bfree(int dev, uint b)
{
  ...
  brelse(bp);
    ...
    800025aa:	656080e7          	jalr	1622(ra) # 80006bfc <panic>
...
00000000800025ae <balloc>:
{
  ...
  panic("balloc: out of blocks");
    ...
    80002670:	590080e7          	jalr	1424(ra) # 80006bfc <panic>
...
bmap(struct inode *ip, uint bn)
{
  ...
  panic("bmap: out of range");
    ...
    800027b6:	44a080e7          	jalr	1098(ra) # 80006bfc <panic>
...
00000000800027ba <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    800027da:	970080e7          	jalr	-1680(ra) # 80007146 <acquire>
  empty = 0;
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80002820:	9de080e7          	jalr	-1570(ra) # 800071fa <release>
      return ip;
  ...
  release(&itable.lock);
    ...
    80002850:	9ae080e7          	jalr	-1618(ra) # 800071fa <release>
}
    ...
    80002872:	38e080e7          	jalr	910(ra) # 80006bfc <panic>
...
fsinit(int dev) {
  ...
  initlog(dev, &sb);
    ...
    800028f2:	30e080e7          	jalr	782(ra) # 80006bfc <panic>
...
00000000800028f6 <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    80002918:	7a2080e7          	jalr	1954(ra) # 800070b6 <initlock>
  for(i = 0; i < NINODE; i++) {
...
0000000080002956 <ialloc>:
{
  ...
  panic("ialloc: no inodes");
    ...
    800029d6:	22a080e7          	jalr	554(ra) # 80006bfc <panic>
...
0000000080002ab0 <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    80002ac8:	682080e7          	jalr	1666(ra) # 80007146 <acquire>
  ip->ref++;
  ...
  release(&itable.lock);
    ...
    80002ade:	720080e7          	jalr	1824(ra) # 800071fa <release>
}
...
0000000080002aee <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80002b2a:	0d6080e7          	jalr	214(ra) # 80006bfc <panic>
    bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80002bac:	054080e7          	jalr	84(ra) # 80006bfc <panic>
...
0000000080002bb0 <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    80002bf8:	008080e7          	jalr	8(ra) # 80006bfc <panic>
...
0000000080002ca8 <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    80002cc2:	488080e7          	jalr	1160(ra) # 80007146 <acquire>
  ...
  release(&itable.lock);
    ...
    80002ce0:	51e080e7          	jalr	1310(ra) # 800071fa <release>
}
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80002d14:	4ea080e7          	jalr	1258(ra) # 800071fa <release>
    itrunc(ip);
    ...
    80002d4a:	400080e7          	jalr	1024(ra) # 80007146 <acquire>
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    80003008:	bf8080e7          	jalr	-1032(ra) # 80006bfc <panic>
    ...
    80003018:	be8080e7          	jalr	-1048(ra) # 80006bfc <panic>
  for(off = 0; off < dp->size; off += sizeof(de)){
...
000000008000341c <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    80003444:	c76080e7          	jalr	-906(ra) # 800070b6 <initlock>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    ...
    800034d8:	c72080e7          	jalr	-910(ra) # 80007146 <acquire>
  while(1){
    if(log.committing){
    ...
    80003530:	cce080e7          	jalr	-818(ra) # 800071fa <release>
      break;
    }
  }
}
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80003560:	bea080e7          	jalr	-1046(ra) # 80007146 <acquire>
  log.outstanding -= 1;
  ...
  release(&log.lock);
    ...
    80003588:	c76080e7          	jalr	-906(ra) # 800071fa <release>
}
...
commit()
{
  if (log.lh.n > 0) {
    ...
    800035a0:	baa080e7          	jalr	-1110(ra) # 80007146 <acquire>
    log.committing = 0;
    ...
    800035b8:	c46080e7          	jalr	-954(ra) # 800071fa <release>
}
    ...
    800035da:	626080e7          	jalr	1574(ra) # 80006bfc <panic>
    wakeup(&log);
  ...
  release(&log.lock);
    ...
    800035f6:	c08080e7          	jalr	-1016(ra) # 800071fa <release>
  if(do_commit){
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    800036b4:	a96080e7          	jalr	-1386(ra) # 80007146 <acquire>
  ...
  release(&log.lock);
    ...
    8000376e:	a90080e7          	jalr	-1392(ra) # 800071fa <release>
}
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    8000379c:	91e080e7          	jalr	-1762(ra) # 800070b6 <initlock>
  lk->name = name;
...
acquiresleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    800037d0:	97a080e7          	jalr	-1670(ra) # 80007146 <acquire>
  while (lk->locked) {
  ...
  release(&lk->lk);
    ...
    800037fe:	a00080e7          	jalr	-1536(ra) # 800071fa <release>
}
...
releasesleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    80003826:	924080e7          	jalr	-1756(ra) # 80007146 <acquire>
  lk->locked = 0;
  ...
  release(&lk->lk);
    ...
    80003842:	9bc080e7          	jalr	-1604(ra) # 800071fa <release>
}
...
holdingsleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    8000386c:	8de080e7          	jalr	-1826(ra) # 80007146 <acquire>
  ...
  release(&lk->lk);
    ...
    8000387c:	982080e7          	jalr	-1662(ra) # 800071fa <release>
  return r;
}
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    800038c4:	7f6080e7          	jalr	2038(ra) # 800070b6 <initlock>
}
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    800038e6:	864080e7          	jalr	-1948(ra) # 80007146 <acquire>
  ...
  release(&ftable.lock);
    ...
    80003912:	8ec080e7          	jalr	-1812(ra) # 800071fa <release>
  return 0;
    ...
    8000392a:	8d4080e7          	jalr	-1836(ra) # 800071fa <release>
}
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003952:	7f8080e7          	jalr	2040(ra) # 80007146 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    8000396c:	892080e7          	jalr	-1902(ra) # 800071fa <release>
  return f;
}
    ...
    80003988:	278080e7          	jalr	632(ra) # 80006bfc <panic>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800039ae:	79c080e7          	jalr	1948(ra) # 80007146 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    800039ec:	812080e7          	jalr	-2030(ra) # 800071fa <release>
  ...
  if(ff.type == FD_PIPE){
    ...
    80003a0c:	988080e7          	jalr	-1656(ra) # 80006390 <sockclose>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    80003b1c:	908080e7          	jalr	-1784(ra) # 80006420 <sockread>
  ...
  return r;
    ...
    80003ba8:	058080e7          	jalr	88(ra) # 80006bfc <panic>
    return -1;
    ...
    80003bbc:	12078263          	beqz	a5,80003ce0 <filewrite+0x128>
{
  ...
  if(f->type == FD_PIPE){
    ...
    80003bfe:	8f6080e7          	jalr	-1802(ra) # 800064f0 <sockwrite>
  else {
    panic("filewrite");
  }
  ...
  return ret;
    ...
    80003cdc:	f24080e7          	jalr	-220(ra) # 80006bfc <panic>
    return -1;
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    80003d4c:	36e080e7          	jalr	878(ra) # 800070b6 <initlock>
  (*f0)->type = FD_PIPE;
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  acquire(&pi->lock);
    ...
    80003dda:	370080e7          	jalr	880(ra) # 80007146 <acquire>
  if(writable){
  ...
  if(pi->readopen == 0 && pi->writeopen == 0){
    ...
    80003dfe:	400080e7          	jalr	1024(ra) # 800071fa <release>
    kfree((char*)pi);
    ...
    80003e30:	3ce080e7          	jalr	974(ra) # 800071fa <release>
}
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80003e66:	2e4080e7          	jalr	740(ra) # 80007146 <acquire>
  while(i < n){
  ...
  int i = 0;
    ...
    80003e84:	37a080e7          	jalr	890(ra) # 800071fa <release>
      return -1;
  ...
  release(&pi->lock);
    ...
    80003f26:	2d8080e7          	jalr	728(ra) # 800071fa <release>
  return i;
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80003f5c:	1ee080e7          	jalr	494(ra) # 80007146 <acquire>
  ...
  release(&pi->lock);
    ...
    80003ff0:	20e080e7          	jalr	526(ra) # 800071fa <release>
  return i;
}
    ...
    80004010:	1ee080e7          	jalr	494(ra) # 800071fa <release>
      return -1;
...
exec(char *path, char **argv)
{
 ...
 bad:
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80004118:	ae8080e7          	jalr	-1304(ra) # 80006bfc <panic>
    if(sz - i < PGSIZE)
      n = sz - i;
    else
      n = PGSIZE;
...
create(char *path, short type, short major, short minor)
{
  ...
  return ip;
    ...
    8000454a:	6b6080e7          	jalr	1718(ra) # 80006bfc <panic>
    dp->nlink++;  // for ".."
...
00000000800048b8 <sys_unlink>:
{
  ...
  return 0;
    ...
    800049e4:	21c080e7          	jalr	540(ra) # 80006bfc <panic>
...
sys_connect(void)
{
  ...
  if(sockalloc(&f, raddr, lport, rport) < 0)
    ...
    80005022:	24c080e7          	jalr	588(ra) # 8000626a <sockalloc>
...
000000008000527c <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    8000529a:	e20080e7          	jalr	-480(ra) # 800070b6 <initlock>
  ...
  *R(VIRTIO_MMIO_QUEUE_PFN) = ((uint64)disk.pages) >> PGSHIFT;
  ...
  disk.used = (struct virtq_used *) (disk.pages + PGSIZE);
    ...
    8000539c:	864080e7          	jalr	-1948(ra) # 80006bfc <panic>
    ...
    800053ac:	854080e7          	jalr	-1964(ra) # 80006bfc <panic>
    ...
    800053bc:	844080e7          	jalr	-1980(ra) # 80006bfc <panic>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800053fa:	d50080e7          	jalr	-688(ra) # 80007146 <acquire>
  for(int i = 0; i < 3; i++){
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  release(&disk.vdisk_lock);
    ...
    80005634:	bca080e7          	jalr	-1078(ra) # 800071fa <release>
}
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800056ae:	a9c080e7          	jalr	-1380(ra) # 80007146 <acquire>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    80005740:	abe080e7          	jalr	-1346(ra) # 800071fa <release>
}
    ...
    8000575c:	4a4080e7          	jalr	1188(ra) # 80006bfc <panic>
...
e1000_init(uint32* xregs)
{
  ...
  initlock(&e1000_lock, "e1000");
    ...
    80005784:	936080e7          	jalr	-1738(ra) # 800070b6 <initlock>
  ...
  for (i = 0; i < RX_RING_SIZE; i++) {
    ...
    8000583e:	44a080e7          	jalr	1098(ra) # 80005c84 <mbufalloc>
  ...
  regs[E1000_IMS] = (1 << 7); // RXDW -- Receiver Descriptor Write Back
    ...
    80005900:	300080e7          	jalr	768(ra) # 80006bfc <panic>
...
e1000_transmit(struct mbuf* m)
{
  ...
  acquire(&e1000_lock);
    ...
    80005922:	828080e7          	jalr	-2008(ra) # 80007146 <acquire>
  ...
  if (tx_mbufs[end])
    ...
    8000595e:	382080e7          	jalr	898(ra) # 80005cdc <mbuffree>
  ...
  tx_ring[end].cmd = E1000_TXD_CMD_EOP | E1000_TXD_CMD_RS;
    80005976:	4725                	li	a4,9
    80005978:	02e785a3          	sb	a4,43(a5)
  tx_ring[end].length = m->len;
    8000597c:	01092703          	lw	a4,16(s2)
    80005980:	02e79423          	sh	a4,40(a5)
  tx_mbufs[end] = m;
  ...
  release(&e1000_lock);
    ...
    800059b2:	84c080e7          	jalr	-1972(ra) # 800071fa <release>
  return 0;
    ...
    800059d2:	82c080e7          	jalr	-2004(ra) # 800071fa <release>
    return -1;
...
e1000_intr(void)
{
    ...
    800059e0:	ec26                	sd	s1,24(sp)
    800059e2:	e84a                	sd	s2,16(sp)
    800059e4:	e44e                	sd	s3,8(sp)
    800059e6:	e052                	sd	s4,0(sp)
    800059e8:	1800                	addi	s0,sp,48
  // tell the e1000 we've seen this interrupt;
  // without this the e1000 won't raise any
  // further interrupts.
  regs[E1000_ICR] = 0xffffffff;
    800059ea:	00004797          	auipc	a5,0x4
    800059ee:	6367b783          	ld	a5,1590(a5) # 8000a020 <regs>
    800059f2:	577d                	li	a4,-1
    800059f4:	0ce7a023          	sw	a4,192(a5)
  int end = (regs[E1000_RDT] + 1) % RX_RING_SIZE;
    800059f8:	670d                	lui	a4,0x3
    800059fa:	97ba                	add	a5,a5,a4
    800059fc:	8187a483          	lw	s1,-2024(a5)
    80005a00:	2485                	addiw	s1,s1,1
    80005a02:	88bd                	andi	s1,s1,15
  while (rx_ring[end].status & E1000_TXD_STAT_DD)
    80005a04:	00449713          	slli	a4,s1,0x4
    80005a08:	00019797          	auipc	a5,0x19
    80005a0c:	5f878793          	addi	a5,a5,1528 # 8001f000 <e1000_lock>
    80005a10:	97ba                	add	a5,a5,a4
    80005a12:	1ac7c783          	lbu	a5,428(a5)
    80005a16:	8b85                	andi	a5,a5,1
    80005a18:	cfa5                	beqz	a5,80005a90 <e1000_intr+0xb6>
    if (rx_ring[end].length > MBUF_SIZE)
    80005a1a:	00019997          	auipc	s3,0x19
    80005a1e:	5e698993          	addi	s3,s3,1510 # 8001f000 <e1000_lock>
    80005a22:	6a05                	lui	s4,0x1
    80005a24:	800a0a13          	addi	s4,s4,-2048 # 800 <_entry-0x7ffff800>
    80005a28:	00449793          	slli	a5,s1,0x4
    80005a2c:	97ce                	add	a5,a5,s3
    80005a2e:	1a87d783          	lhu	a5,424(a5)
    80005a32:	0007871b          	sext.w	a4,a5
    80005a36:	08ea6563          	bltu	s4,a4,80005ac0 <e1000_intr+0xe6>
    rx_mbufs[end]->len = rx_ring[end].length;
    80005a3a:	00349913          	slli	s2,s1,0x3
    80005a3e:	994e                	add	s2,s2,s3
    80005a40:	2a093703          	ld	a4,672(s2)
    80005a44:	cb1c                	sw	a5,16(a4)
    net_rx(rx_mbufs[end]);
    80005a46:	2a093503          	ld	a0,672(s2)
    80005a4a:	00000097          	auipc	ra,0x0
    80005a4e:	406080e7          	jalr	1030(ra) # 80005e50 <net_rx>
    rx_mbufs[end] = mbufalloc(0);
    80005a52:	4501                	li	a0,0
    80005a54:	00000097          	auipc	ra,0x0
    80005a58:	230080e7          	jalr	560(ra) # 80005c84 <mbufalloc>
    80005a5c:	2aa93023          	sd	a0,672(s2)
    if (rx_mbufs[end] == 0)
    80005a60:	c925                	beqz	a0,80005ad0 <e1000_intr+0xf6>
    rx_ring[end].addr = (uint64)(rx_mbufs[end]->head);
    80005a62:	00449793          	slli	a5,s1,0x4
    80005a66:	97ce                	add	a5,a5,s3
    80005a68:	6518                	ld	a4,8(a0)
    80005a6a:	1ae7b023          	sd	a4,416(a5)
    rx_ring[end].status = 0;
    80005a6e:	1a078623          	sb	zero,428(a5)
    end = (end + 1) % RX_RING_SIZE;
    80005a72:	2485                	addiw	s1,s1,1
    80005a74:	41f4d79b          	sraiw	a5,s1,0x1f
    80005a78:	01c7d79b          	srliw	a5,a5,0x1c
    80005a7c:	9cbd                	addw	s1,s1,a5
    80005a7e:	88bd                	andi	s1,s1,15
    80005a80:	9c9d                	subw	s1,s1,a5
  while (rx_ring[end].status & E1000_TXD_STAT_DD)
    80005a82:	00449793          	slli	a5,s1,0x4
    80005a86:	97ce                	add	a5,a5,s3
    80005a88:	1ac7c783          	lbu	a5,428(a5)
    80005a8c:	8b85                	andi	a5,a5,1
    80005a8e:	ffc9                	bnez	a5,80005a28 <e1000_intr+0x4e>
  regs[E1000_RDT] = (end - 1) % RX_RING_SIZE;
    80005a90:	34fd                	addiw	s1,s1,-1
    80005a92:	41f4d79b          	sraiw	a5,s1,0x1f
    80005a96:	01c7d79b          	srliw	a5,a5,0x1c
    80005a9a:	9cbd                	addw	s1,s1,a5
    80005a9c:	88bd                	andi	s1,s1,15
    80005a9e:	9c9d                	subw	s1,s1,a5
    80005aa0:	00004797          	auipc	a5,0x4
    80005aa4:	5807b783          	ld	a5,1408(a5) # 8000a020 <regs>
    80005aa8:	670d                	lui	a4,0x3
    80005aaa:	97ba                	add	a5,a5,a4
    80005aac:	8097ac23          	sw	s1,-2024(a5)

  e1000_recv();
}
    80005ab0:	70a2                	ld	ra,40(sp)
    80005ab2:	7402                	ld	s0,32(sp)
    80005ab4:	64e2                	ld	s1,24(sp)
    80005ab6:	6942                	ld	s2,16(sp)
    80005ab8:	69a2                	ld	s3,8(sp)
    80005aba:	6a02                	ld	s4,0(sp)
    80005abc:	6145                	addi	sp,sp,48
    80005abe:	8082                	ret
      panic("Out of Buf");
    80005ac0:	00004517          	auipc	a0,0x4
    80005ac4:	d2850513          	addi	a0,a0,-728 # 800097e8 <syscalls+0x410>
    80005ac8:	00001097          	auipc	ra,0x1
    80005acc:	134080e7          	jalr	308(ra) # 80006bfc <panic>
      panic("no mbufs");
    80005ad0:	00004517          	auipc	a0,0x4
    80005ad4:	d2850513          	addi	a0,a0,-728 # 800097f8 <syscalls+0x420>
    80005ad8:	00001097          	auipc	ra,0x1
    80005adc:	124080e7          	jalr	292(ra) # 80006bfc <panic>

0000000080005ae0 <in_cksum>:
...
in_cksum(const unsigned char *addr, int len)
{
    ...
    80005ae2:	ec22                	sd	s0,24(sp)
    80005ae4:	1000                	addi	s0,sp,32
  int nleft = len;
  const unsigned short *w = (const unsigned short *)addr;
  unsigned int sum = 0;
  unsigned short answer = 0;
    80005ae6:	fe041723          	sh	zero,-18(s0)
  /*
  ...
  while (nleft > 1)  {
    ...
    80005aec:	04b7d963          	bge	a5,a1,80005b3e <in_cksum+0x5e>
    80005af0:	ffe5879b          	addiw	a5,a1,-2
    80005af4:	0017d61b          	srliw	a2,a5,0x1
    80005af8:	0017d71b          	srliw	a4,a5,0x1
    80005afc:	0705                	addi	a4,a4,1
    80005afe:	0706                	slli	a4,a4,0x1
    80005b00:	972a                	add	a4,a4,a0
  unsigned int sum = 0;
    80005b02:	4781                	li	a5,0
    sum += *w++;
    80005b04:	0509                	addi	a0,a0,2
    80005b06:	ffe55683          	lhu	a3,-2(a0)
    80005b0a:	9fb5                	addw	a5,a5,a3
  while (nleft > 1)  {
    80005b0c:	fee51ce3          	bne	a0,a4,80005b04 <in_cksum+0x24>
    80005b10:	35f9                	addiw	a1,a1,-2
    80005b12:	0016169b          	slliw	a3,a2,0x1
    80005b16:	9d95                	subw	a1,a1,a3
    nleft -= 2;
  }
  ...
  if (nleft == 1) {
    ...
    80005b1a:	02d58563          	beq	a1,a3,80005b44 <in_cksum+0x64>
  ...
  sum = (sum & 0xffff) + (sum >> 16);
    80005b1e:	03079513          	slli	a0,a5,0x30
    80005b22:	9141                	srli	a0,a0,0x30
    80005b24:	0107d79b          	srliw	a5,a5,0x10
    80005b28:	9fa9                	addw	a5,a5,a0
  sum += (sum >> 16);
    80005b2a:	0107d51b          	srliw	a0,a5,0x10
  /* guaranteed now that the lower 16 bits of sum are correct */

  answer = ~sum; /* truncate to 16 bits */
    80005b2e:	9d3d                	addw	a0,a0,a5
    80005b30:	fff54513          	not	a0,a0
  return answer;
}
    80005b34:	1542                	slli	a0,a0,0x30
    80005b36:	9141                	srli	a0,a0,0x30
    80005b38:	6462                	ld	s0,24(sp)
    80005b3a:	6105                	addi	sp,sp,32
    80005b3c:	8082                	ret
  const unsigned short *w = (const unsigned short *)addr;
    80005b3e:	872a                	mv	a4,a0
  unsigned int sum = 0;
    80005b40:	4781                	li	a5,0
    80005b42:	bfd9                	j	80005b18 <in_cksum+0x38>
    *(unsigned char *)(&answer) = *(const unsigned char *)w;
    80005b44:	00074703          	lbu	a4,0(a4) # 3000 <_entry-0x7fffd000>
    80005b48:	fee40723          	sb	a4,-18(s0)
    sum += answer;
    80005b4c:	fee45703          	lhu	a4,-18(s0)
    80005b50:	9fb9                	addw	a5,a5,a4
    80005b52:	b7f1                	j	80005b1e <in_cksum+0x3e>

0000000080005b54 <mbufpull>:
{
    80005b54:	1141                	addi	sp,sp,-16
    80005b56:	e422                	sd	s0,8(sp)
    80005b58:	0800                	addi	s0,sp,16
    80005b5a:	87aa                	mv	a5,a0
  char *tmp = m->head;
    80005b5c:	6508                	ld	a0,8(a0)
  if (m->len < len)
    80005b5e:	4b98                	lw	a4,16(a5)
    80005b60:	00b76b63          	bltu	a4,a1,80005b76 <mbufpull+0x22>
  m->len -= len;
    80005b64:	9f0d                	subw	a4,a4,a1
    80005b66:	cb98                	sw	a4,16(a5)
  m->head += len;
    80005b68:	1582                	slli	a1,a1,0x20
    80005b6a:	9181                	srli	a1,a1,0x20
    80005b6c:	95aa                	add	a1,a1,a0
    80005b6e:	e78c                	sd	a1,8(a5)
}
    ...
    80005b78:	bfe5                	j	80005b70 <mbufpull+0x1c>

0000000080005b7a <mbufpush>:
{
    80005b7a:	87aa                	mv	a5,a0
  m->head -= len;
    80005b7c:	02059713          	slli	a4,a1,0x20
    80005b80:	9301                	srli	a4,a4,0x20
    80005b82:	6508                	ld	a0,8(a0)
    80005b84:	8d19                	sub	a0,a0,a4
    80005b86:	e788                	sd	a0,8(a5)
  if (m->head < m->buf)
    80005b88:	01478713          	addi	a4,a5,20
    80005b8c:	00e56663          	bltu	a0,a4,80005b98 <mbufpush+0x1e>
  m->len += len;
    80005b90:	4b98                	lw	a4,16(a5)
    80005b92:	9db9                	addw	a1,a1,a4
    80005b94:	cb8c                	sw	a1,16(a5)
}
    80005b96:	8082                	ret
{
    ...
    80005ba4:	c6850513          	addi	a0,a0,-920 # 80009808 <syscalls+0x430>
    80005ba8:	00001097          	auipc	ra,0x1
    80005bac:	054080e7          	jalr	84(ra) # 80006bfc <panic>

0000000080005bb0 <net_tx_eth>:
...
net_tx_eth(struct mbuf *m, uint16 ethtype)
{
    ...
    80005bba:	e44e                	sd	s3,8(sp)
    80005bbc:	1800                	addi	s0,sp,48
    80005bbe:	89aa                	mv	s3,a0
    80005bc0:	892e                	mv	s2,a1
  struct eth *ethhdr;

  ethhdr = mbufpushhdr(m, *ethhdr);
    80005bc2:	45b9                	li	a1,14
    80005bc4:	00000097          	auipc	ra,0x0
    80005bc8:	fb6080e7          	jalr	-74(ra) # 80005b7a <mbufpush>
    80005bcc:	84aa                	mv	s1,a0
  memmove(ethhdr->shost, local_mac, ETHADDR_LEN);
    80005bce:	4619                	li	a2,6
    80005bd0:	00004597          	auipc	a1,0x4
    80005bd4:	cf058593          	addi	a1,a1,-784 # 800098c0 <local_mac>
    80005bd8:	0519                	addi	a0,a0,6
    80005bda:	ffffa097          	auipc	ra,0xffffa
    80005bde:	5fe080e7          	jalr	1534(ra) # 800001d8 <memmove>
  ...
  memmove(ethhdr->dhost, broadcast_mac, ETHADDR_LEN);
    ...
    80005be8:	cd458593          	addi	a1,a1,-812 # 800098b8 <broadcast_mac>
    80005bec:	8526                	mv	a0,s1
    80005bee:	ffffa097          	auipc	ra,0xffffa
    80005bf2:	5ea080e7          	jalr	1514(ra) # 800001d8 <memmove>
// endianness support
//
...
static inline uint16 bswaps(uint16 val)
{
  return (((val & 0x00ffU) << 8) |
    80005bf6:	0089579b          	srliw	a5,s2,0x8
  ethhdr->type = htons(ethtype);
    80005bfa:	00f48623          	sb	a5,12(s1)
    80005bfe:	012486a3          	sb	s2,13(s1)
  if (e1000_transmit(m)) {
    80005c02:	854e                	mv	a0,s3
    80005c04:	00000097          	auipc	ra,0x0
    80005c08:	d00080e7          	jalr	-768(ra) # 80005904 <e1000_transmit>
    80005c0c:	e901                	bnez	a0,80005c1c <net_tx_eth+0x6c>
    mbuffree(m);
  }
}
    ...
    80005c16:	69a2                	ld	s3,8(sp)
    80005c18:	6145                	addi	sp,sp,48
    80005c1a:	8082                	ret
  kfree(m);
    80005c1c:	854e                	mv	a0,s3
    80005c1e:	ffffa097          	auipc	ra,0xffffa
    80005c22:	3fe080e7          	jalr	1022(ra) # 8000001c <kfree>
}
    80005c26:	b7e5                	j	80005c0e <net_tx_eth+0x5e>

0000000080005c28 <mbufput>:
{
    80005c28:	87aa                	mv	a5,a0
  char *tmp = m->head + m->len;
    80005c2a:	4918                	lw	a4,16(a0)
    80005c2c:	02071693          	slli	a3,a4,0x20
    80005c30:	9281                	srli	a3,a3,0x20
    80005c32:	6508                	ld	a0,8(a0)
    80005c34:	9536                	add	a0,a0,a3
  m->len += len;
    80005c36:	9f2d                	addw	a4,a4,a1
    80005c38:	0007069b          	sext.w	a3,a4
    80005c3c:	cb98                	sw	a4,16(a5)
  if (m->len > MBUF_SIZE)
    80005c3e:	6785                	lui	a5,0x1
    80005c40:	80078793          	addi	a5,a5,-2048 # 800 <_entry-0x7ffff800>
    80005c44:	00d7e363          	bltu	a5,a3,80005c4a <mbufput+0x22>
}
    80005c48:	8082                	ret
{
    ...
    panic("mbufput");
    80005c52:	00004517          	auipc	a0,0x4
    80005c56:	bc650513          	addi	a0,a0,-1082 # 80009818 <syscalls+0x440>
    80005c5a:	00001097          	auipc	ra,0x1
    80005c5e:	fa2080e7          	jalr	-94(ra) # 80006bfc <panic>

0000000080005c62 <mbuftrim>:
{
    80005c62:	1141                	addi	sp,sp,-16
    80005c64:	e422                	sd	s0,8(sp)
    80005c66:	0800                	addi	s0,sp,16
  if (len > m->len)
    80005c68:	491c                	lw	a5,16(a0)
    80005c6a:	00b7eb63          	bltu	a5,a1,80005c80 <mbuftrim+0x1e>
  m->len -= len;
    80005c6e:	9f8d                	subw	a5,a5,a1
    80005c70:	c91c                	sw	a5,16(a0)
  return m->head + m->len;
    80005c72:	1782                	slli	a5,a5,0x20
    80005c74:	9381                	srli	a5,a5,0x20
    80005c76:	6508                	ld	a0,8(a0)
    ...
    80005c82:	bfe5                	j	80005c7a <mbuftrim+0x18>

0000000080005c84 <mbufalloc>:
{
  ...
  if (headroom > MBUF_SIZE)
    80005c90:	6785                	lui	a5,0x1
    80005c92:	80078793          	addi	a5,a5,-2048 # 800 <_entry-0x7ffff800>
    return 0;
    80005c96:	4901                	li	s2,0
  if (headroom > MBUF_SIZE)
    80005c98:	02a7eb63          	bltu	a5,a0,80005cce <mbufalloc+0x4a>
    80005c9c:	84aa                	mv	s1,a0
  m = kalloc();
    80005c9e:	ffffa097          	auipc	ra,0xffffa
    80005ca2:	47a080e7          	jalr	1146(ra) # 80000118 <kalloc>
    80005ca6:	892a                	mv	s2,a0
  if (m == 0)
    80005ca8:	c11d                	beqz	a0,80005cce <mbufalloc+0x4a>
  m->next = 0;
    80005caa:	00053023          	sd	zero,0(a0)
  m->head = (char *)m->buf + headroom;
    80005cae:	0551                	addi	a0,a0,20
    80005cb0:	1482                	slli	s1,s1,0x20
    80005cb2:	9081                	srli	s1,s1,0x20
    80005cb4:	94aa                	add	s1,s1,a0
    80005cb6:	00993423          	sd	s1,8(s2)
  m->len = 0;
    80005cba:	00092823          	sw	zero,16(s2)
  memset(m->buf, 0, sizeof(m->buf));
    80005cbe:	6605                	lui	a2,0x1
    80005cc0:	80060613          	addi	a2,a2,-2048 # 800 <_entry-0x7ffff800>
    80005cc4:	4581                	li	a1,0
    80005cc6:	ffffa097          	auipc	ra,0xffffa
    80005cca:	4b2080e7          	jalr	1202(ra) # 80000178 <memset>
}
    80005cce:	854a                	mv	a0,s2
    80005cd0:	60e2                	ld	ra,24(sp)
    80005cd2:	6442                	ld	s0,16(sp)
    80005cd4:	64a2                	ld	s1,8(sp)
    80005cd6:	6902                	ld	s2,0(sp)
    80005cd8:	6105                	addi	sp,sp,32
    80005cda:	8082                	ret

0000000080005cdc <mbuffree>:
{
  ...
  kfree(m);
    80005ce4:	ffffa097          	auipc	ra,0xffffa
    80005ce8:	338080e7          	jalr	824(ra) # 8000001c <kfree>
}
...
0000000080005cf4 <mbufq_pushtail>:
{
    80005cf4:	1141                	addi	sp,sp,-16
    80005cf6:	e422                	sd	s0,8(sp)
    80005cf8:	0800                	addi	s0,sp,16
  m->next = 0;
    80005cfa:	0005b023          	sd	zero,0(a1)
  if (!q->head){
    80005cfe:	611c                	ld	a5,0(a0)
    80005d00:	c799                	beqz	a5,80005d0e <mbufq_pushtail+0x1a>
  q->tail->next = m;
    80005d02:	651c                	ld	a5,8(a0)
    80005d04:	e38c                	sd	a1,0(a5)
  q->tail = m;
    80005d06:	e50c                	sd	a1,8(a0)
}
    80005d08:	6422                	ld	s0,8(sp)
    80005d0a:	0141                	addi	sp,sp,16
    80005d0c:	8082                	ret
    q->head = q->tail = m;
    80005d0e:	e50c                	sd	a1,8(a0)
    80005d10:	e10c                	sd	a1,0(a0)
    return;
    80005d12:	bfdd                	j	80005d08 <mbufq_pushtail+0x14>

0000000080005d14 <mbufq_pophead>:
{
    80005d14:	1141                	addi	sp,sp,-16
    80005d16:	e422                	sd	s0,8(sp)
    80005d18:	0800                	addi	s0,sp,16
    80005d1a:	87aa                	mv	a5,a0
  struct mbuf *head = q->head;
    80005d1c:	6108                	ld	a0,0(a0)
  if (!head)
    80005d1e:	c119                	beqz	a0,80005d24 <mbufq_pophead+0x10>
  q->head = head->next;
    80005d20:	6118                	ld	a4,0(a0)
    80005d22:	e398                	sd	a4,0(a5)
}
    80005d24:	6422                	ld	s0,8(sp)
    80005d26:	0141                	addi	sp,sp,16
    80005d28:	8082                	ret

0000000080005d2a <mbufq_empty>:
{
    80005d2a:	1141                	addi	sp,sp,-16
    80005d2c:	e422                	sd	s0,8(sp)
    80005d2e:	0800                	addi	s0,sp,16
  return q->head == 0;
    80005d30:	6108                	ld	a0,0(a0)
}
    80005d32:	00153513          	seqz	a0,a0
    80005d36:	6422                	ld	s0,8(sp)
    80005d38:	0141                	addi	sp,sp,16
    80005d3a:	8082                	ret

0000000080005d3c <mbufq_init>:
{
    80005d3c:	1141                	addi	sp,sp,-16
    80005d3e:	e422                	sd	s0,8(sp)
    80005d40:	0800                	addi	s0,sp,16
  q->head = 0;
    80005d42:	00053023          	sd	zero,0(a0)
}
    80005d46:	6422                	ld	s0,8(sp)
    80005d48:	0141                	addi	sp,sp,16
    80005d4a:	8082                	ret

0000000080005d4c <net_tx_udp>:
...
{
    80005d4c:	7179                	addi	sp,sp,-48
    80005d4e:	f406                	sd	ra,40(sp)
    80005d50:	f022                	sd	s0,32(sp)
    80005d52:	ec26                	sd	s1,24(sp)
    80005d54:	e84a                	sd	s2,16(sp)
    80005d56:	e44e                	sd	s3,8(sp)
    80005d58:	e052                	sd	s4,0(sp)
    80005d5a:	1800                	addi	s0,sp,48
    80005d5c:	8a2a                	mv	s4,a0
    80005d5e:	892e                	mv	s2,a1
    80005d60:	89b2                	mv	s3,a2
    80005d62:	84b6                	mv	s1,a3
  struct udp *udphdr;

  // put the UDP header
  udphdr = mbufpushhdr(m, *udphdr);
    80005d64:	45a1                	li	a1,8
    80005d66:	00000097          	auipc	ra,0x0
    80005d6a:	e14080e7          	jalr	-492(ra) # 80005b7a <mbufpush>
    80005d6e:	0089d61b          	srliw	a2,s3,0x8
    80005d72:	0089999b          	slliw	s3,s3,0x8
    80005d76:	00c9e9b3          	or	s3,s3,a2
  udphdr->sport = htons(sport);
    80005d7a:	01351023          	sh	s3,0(a0)
    80005d7e:	0084d69b          	srliw	a3,s1,0x8
    80005d82:	0084949b          	slliw	s1,s1,0x8
    80005d86:	8cd5                	or	s1,s1,a3
  udphdr->dport = htons(dport);
    80005d88:	00951123          	sh	s1,2(a0)
  udphdr->ulen = htons(m->len);
    80005d8c:	010a2783          	lw	a5,16(s4)
    80005d90:	0087d713          	srli	a4,a5,0x8
    80005d94:	0087979b          	slliw	a5,a5,0x8
    80005d98:	0ff77713          	andi	a4,a4,255
    80005d9c:	8fd9                	or	a5,a5,a4
    80005d9e:	00f51223          	sh	a5,4(a0)
  udphdr->sum = 0; // zero means no checksum is provided
    80005da2:	00051323          	sh	zero,6(a0)
  iphdr = mbufpushhdr(m, *iphdr);
    80005da6:	45d1                	li	a1,20
    80005da8:	8552                	mv	a0,s4
    80005daa:	00000097          	auipc	ra,0x0
    80005dae:	dd0080e7          	jalr	-560(ra) # 80005b7a <mbufpush>
    80005db2:	84aa                	mv	s1,a0
  memset(iphdr, 0, sizeof(*iphdr));
    80005db4:	4651                	li	a2,20
    80005db6:	4581                	li	a1,0
    80005db8:	ffffa097          	auipc	ra,0xffffa
    80005dbc:	3c0080e7          	jalr	960(ra) # 80000178 <memset>
  iphdr->ip_vhl = (4 << 4) | (20 >> 2);
    80005dc0:	04500793          	li	a5,69
    80005dc4:	00f48023          	sb	a5,0(s1)
  iphdr->ip_p = proto;
    80005dc8:	47c5                	li	a5,17
    80005dca:	00f484a3          	sb	a5,9(s1)
  iphdr->ip_src = htonl(local_ip);
    80005dce:	0f0207b7          	lui	a5,0xf020
    80005dd2:	27a9                	addiw	a5,a5,10
    80005dd4:	c4dc                	sw	a5,12(s1)
          ((val & 0xff00U) >> 8));
}
...
static inline uint32 bswapl(uint32 val)
{
  return (((val & 0x000000ffUL) << 24) |
    80005dd6:	0189179b          	slliw	a5,s2,0x18
          ((val & 0x0000ff00UL) << 8) |
          ((val & 0x00ff0000UL) >> 8) |
          ((val & 0xff000000UL) >> 24));
    80005dda:	0189571b          	srliw	a4,s2,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80005dde:	8fd9                	or	a5,a5,a4
          ((val & 0x0000ff00UL) << 8) |
    80005de0:	0089171b          	slliw	a4,s2,0x8
    80005de4:	00ff06b7          	lui	a3,0xff0
    80005de8:	8f75                	and	a4,a4,a3
          ((val & 0x00ff0000UL) >> 8) |
    80005dea:	8fd9                	or	a5,a5,a4
    80005dec:	0089591b          	srliw	s2,s2,0x8
    80005df0:	65c1                	lui	a1,0x10
    80005df2:	f0058593          	addi	a1,a1,-256 # ff00 <_entry-0x7fff0100>
    80005df6:	00b97933          	and	s2,s2,a1
    80005dfa:	0127e933          	or	s2,a5,s2
  iphdr->ip_dst = htonl(dip);
    80005dfe:	0124a823          	sw	s2,16(s1)
  iphdr->ip_len = htons(m->len);
    80005e02:	010a2783          	lw	a5,16(s4)
  return (((val & 0x00ffU) << 8) |
    80005e06:	0087d713          	srli	a4,a5,0x8
    80005e0a:	0087979b          	slliw	a5,a5,0x8
    80005e0e:	0ff77713          	andi	a4,a4,255
    80005e12:	8fd9                	or	a5,a5,a4
    80005e14:	00f49123          	sh	a5,2(s1)
  iphdr->ip_ttl = 100;
    80005e18:	06400793          	li	a5,100
    80005e1c:	00f48423          	sb	a5,8(s1)
  iphdr->ip_sum = in_cksum((unsigned char *)iphdr, sizeof(*iphdr));
    80005e20:	45d1                	li	a1,20
    80005e22:	8526                	mv	a0,s1
    80005e24:	00000097          	auipc	ra,0x0
    80005e28:	cbc080e7          	jalr	-836(ra) # 80005ae0 <in_cksum>
    80005e2c:	00a49523          	sh	a0,10(s1)
  net_tx_eth(m, ETHTYPE_IP);
    80005e30:	6585                	lui	a1,0x1
    80005e32:	80058593          	addi	a1,a1,-2048 # 800 <_entry-0x7ffff800>
    80005e36:	8552                	mv	a0,s4
    80005e38:	00000097          	auipc	ra,0x0
    80005e3c:	d78080e7          	jalr	-648(ra) # 80005bb0 <net_tx_eth>
  ...
  net_tx_ip(m, IPPROTO_UDP, dip);
    ...
    80005e44:	64e2                	ld	s1,24(sp)
    80005e46:	6942                	ld	s2,16(sp)
    80005e48:	69a2                	ld	s3,8(sp)
    80005e4a:	6a02                	ld	s4,0(sp)
    80005e4c:	6145                	addi	sp,sp,48
    80005e4e:	8082                	ret

0000000080005e50 <net_rx>:
}
...
void net_rx(struct mbuf *m)
{
  ...
  ethhdr = mbufpullhdr(m, *ethhdr);
    80005e64:	45b9                	li	a1,14
    80005e66:	00000097          	auipc	ra,0x0
    80005e6a:	cee080e7          	jalr	-786(ra) # 80005b54 <mbufpull>
  if (!ethhdr) {
    80005e6e:	c521                	beqz	a0,80005eb6 <net_rx+0x66>
    mbuffree(m);
    return;
  }

  type = ntohs(ethhdr->type);
    80005e70:	00c54783          	lbu	a5,12(a0)
    80005e74:	00d54703          	lbu	a4,13(a0)
    80005e78:	0722                	slli	a4,a4,0x8
    80005e7a:	8fd9                	or	a5,a5,a4
    80005e7c:	0087979b          	slliw	a5,a5,0x8
    80005e80:	8321                	srli	a4,a4,0x8
    80005e82:	8fd9                	or	a5,a5,a4
    80005e84:	17c2                	slli	a5,a5,0x30
    80005e86:	93c1                	srli	a5,a5,0x30
  if (type == ETHTYPE_IP)
    80005e88:	8007871b          	addiw	a4,a5,-2048
    80005e8c:	cb1d                	beqz	a4,80005ec2 <net_rx+0x72>
    net_rx_ip(m);
  else if (type == ETHTYPE_ARP)
    80005e8e:	2781                	sext.w	a5,a5
    80005e90:	6705                	lui	a4,0x1
    80005e92:	80670713          	addi	a4,a4,-2042 # 806 <_entry-0x7ffff7fa>
    80005e96:	18e78e63          	beq	a5,a4,80006032 <net_rx+0x1e2>
  kfree(m);
    80005e9a:	8526                	mv	a0,s1
    80005e9c:	ffffa097          	auipc	ra,0xffffa
    80005ea0:	180080e7          	jalr	384(ra) # 8000001c <kfree>
    net_rx_arp(m);
  else
    mbuffree(m);
}
    80005ea4:	60a6                	ld	ra,72(sp)
    80005ea6:	6406                	ld	s0,64(sp)
    80005ea8:	74e2                	ld	s1,56(sp)
    80005eaa:	7942                	ld	s2,48(sp)
    80005eac:	79a2                	ld	s3,40(sp)
    80005eae:	7a02                	ld	s4,32(sp)
    80005eb0:	6ae2                	ld	s5,24(sp)
    80005eb2:	6161                	addi	sp,sp,80
    80005eb4:	8082                	ret
  kfree(m);
    80005eb6:	8526                	mv	a0,s1
    80005eb8:	ffffa097          	auipc	ra,0xffffa
    80005ebc:	164080e7          	jalr	356(ra) # 8000001c <kfree>
}
    80005ec0:	b7d5                	j	80005ea4 <net_rx+0x54>
  iphdr = mbufpullhdr(m, *iphdr);
    80005ec2:	45d1                	li	a1,20
    80005ec4:	8526                	mv	a0,s1
    80005ec6:	00000097          	auipc	ra,0x0
    80005eca:	c8e080e7          	jalr	-882(ra) # 80005b54 <mbufpull>
    80005ece:	892a                	mv	s2,a0
  if (!iphdr)
    80005ed0:	c519                	beqz	a0,80005ede <net_rx+0x8e>
  if (iphdr->ip_vhl != ((4 << 4) | (20 >> 2)))
    80005ed2:	00054703          	lbu	a4,0(a0)
    80005ed6:	04500793          	li	a5,69
    80005eda:	00f70863          	beq	a4,a5,80005eea <net_rx+0x9a>
  kfree(m);
    80005ede:	8526                	mv	a0,s1
    80005ee0:	ffffa097          	auipc	ra,0xffffa
    80005ee4:	13c080e7          	jalr	316(ra) # 8000001c <kfree>
}
    80005ee8:	bf75                	j	80005ea4 <net_rx+0x54>
  if (in_cksum((unsigned char *)iphdr, sizeof(*iphdr)))
    80005eea:	45d1                	li	a1,20
    80005eec:	00000097          	auipc	ra,0x0
    80005ef0:	bf4080e7          	jalr	-1036(ra) # 80005ae0 <in_cksum>
    80005ef4:	f56d                	bnez	a0,80005ede <net_rx+0x8e>
    80005ef6:	00695783          	lhu	a5,6(s2)
    80005efa:	0087d713          	srli	a4,a5,0x8
    80005efe:	0087979b          	slliw	a5,a5,0x8
    80005f02:	0ff77713          	andi	a4,a4,255
    80005f06:	8fd9                	or	a5,a5,a4
  if (htons(iphdr->ip_off) != 0)
    80005f08:	17c2                	slli	a5,a5,0x30
    80005f0a:	93c1                	srli	a5,a5,0x30
    80005f0c:	fbe9                	bnez	a5,80005ede <net_rx+0x8e>
  if (htonl(iphdr->ip_dst) != local_ip)
    80005f0e:	01092703          	lw	a4,16(s2)
  return (((val & 0x000000ffUL) << 24) |
    80005f12:	0187179b          	slliw	a5,a4,0x18
          ((val & 0xff000000UL) >> 24));
    80005f16:	0187569b          	srliw	a3,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80005f1a:	8fd5                	or	a5,a5,a3
          ((val & 0x0000ff00UL) << 8) |
    80005f1c:	0087169b          	slliw	a3,a4,0x8
    80005f20:	00ff0637          	lui	a2,0xff0
    80005f24:	8ef1                	and	a3,a3,a2
          ((val & 0x00ff0000UL) >> 8) |
    80005f26:	8fd5                	or	a5,a5,a3
    80005f28:	0087571b          	srliw	a4,a4,0x8
    80005f2c:	66c1                	lui	a3,0x10
    80005f2e:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    80005f32:	8f75                	and	a4,a4,a3
    80005f34:	8fd9                	or	a5,a5,a4
    80005f36:	2781                	sext.w	a5,a5
    80005f38:	0a000737          	lui	a4,0xa000
    80005f3c:	20f70713          	addi	a4,a4,527 # a00020f <_entry-0x75fffdf1>
    80005f40:	f8e79fe3          	bne	a5,a4,80005ede <net_rx+0x8e>
  if (iphdr->ip_p != IPPROTO_UDP)
    80005f44:	00994703          	lbu	a4,9(s2)
    80005f48:	47c5                	li	a5,17
    80005f4a:	f8f71ae3          	bne	a4,a5,80005ede <net_rx+0x8e>
  return (((val & 0x00ffU) << 8) |
    80005f4e:	00295783          	lhu	a5,2(s2)
    80005f52:	0087d713          	srli	a4,a5,0x8
    80005f56:	0087999b          	slliw	s3,a5,0x8
    80005f5a:	0ff77793          	andi	a5,a4,255
    80005f5e:	00f9e9b3          	or	s3,s3,a5
    80005f62:	19c2                	slli	s3,s3,0x30
    80005f64:	0309d993          	srli	s3,s3,0x30
  len = ntohs(iphdr->ip_len) - sizeof(*iphdr);
    80005f68:	fec9879b          	addiw	a5,s3,-20
    80005f6c:	03079a13          	slli	s4,a5,0x30
    80005f70:	030a5a13          	srli	s4,s4,0x30
  udphdr = mbufpullhdr(m, *udphdr);
    80005f74:	45a1                	li	a1,8
    80005f76:	8526                	mv	a0,s1
    80005f78:	00000097          	auipc	ra,0x0
    80005f7c:	bdc080e7          	jalr	-1060(ra) # 80005b54 <mbufpull>
    80005f80:	8aaa                	mv	s5,a0
  if (!udphdr)
    80005f82:	c915                	beqz	a0,80005fb6 <net_rx+0x166>
    80005f84:	00455783          	lhu	a5,4(a0)
    80005f88:	0087d713          	srli	a4,a5,0x8
    80005f8c:	0087979b          	slliw	a5,a5,0x8
    80005f90:	0ff77713          	andi	a4,a4,255
    80005f94:	8fd9                	or	a5,a5,a4
  if (ntohs(udphdr->ulen) != len)
    80005f96:	2a01                	sext.w	s4,s4
    80005f98:	17c2                	slli	a5,a5,0x30
    80005f9a:	93c1                	srli	a5,a5,0x30
    80005f9c:	00fa1d63          	bne	s4,a5,80005fb6 <net_rx+0x166>
  len -= sizeof(*udphdr);
    80005fa0:	fe49879b          	addiw	a5,s3,-28
  if (len > m->len)
    80005fa4:	0107979b          	slliw	a5,a5,0x10
    80005fa8:	0107d79b          	srliw	a5,a5,0x10
    80005fac:	0007871b          	sext.w	a4,a5
    80005fb0:	488c                	lw	a1,16(s1)
    80005fb2:	00e5f863          	bgeu	a1,a4,80005fc2 <net_rx+0x172>
  kfree(m);
    80005fb6:	8526                	mv	a0,s1
    80005fb8:	ffffa097          	auipc	ra,0xffffa
    80005fbc:	064080e7          	jalr	100(ra) # 8000001c <kfree>
}
    80005fc0:	b5d5                	j	80005ea4 <net_rx+0x54>
  mbuftrim(m, m->len - len);
    80005fc2:	9d9d                	subw	a1,a1,a5
    80005fc4:	8526                	mv	a0,s1
    80005fc6:	00000097          	auipc	ra,0x0
    80005fca:	c9c080e7          	jalr	-868(ra) # 80005c62 <mbuftrim>
  sip = ntohl(iphdr->ip_src);
    80005fce:	00c92783          	lw	a5,12(s2)
    80005fd2:	000ad703          	lhu	a4,0(s5)
    80005fd6:	00875693          	srli	a3,a4,0x8
    80005fda:	0087171b          	slliw	a4,a4,0x8
    80005fde:	0ff6f693          	andi	a3,a3,255
    80005fe2:	8ed9                	or	a3,a3,a4
    80005fe4:	002ad703          	lhu	a4,2(s5)
    80005fe8:	00875613          	srli	a2,a4,0x8
    80005fec:	0087171b          	slliw	a4,a4,0x8
    80005ff0:	0ff67613          	andi	a2,a2,255
    80005ff4:	8e59                	or	a2,a2,a4
  return (((val & 0x000000ffUL) << 24) |
    80005ff6:	0187971b          	slliw	a4,a5,0x18
          ((val & 0xff000000UL) >> 24));
    80005ffa:	0187d59b          	srliw	a1,a5,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80005ffe:	8f4d                	or	a4,a4,a1
          ((val & 0x0000ff00UL) << 8) |
    80006000:	0087959b          	slliw	a1,a5,0x8
    80006004:	00ff0537          	lui	a0,0xff0
    80006008:	8de9                	and	a1,a1,a0
          ((val & 0x00ff0000UL) >> 8) |
    8000600a:	8f4d                	or	a4,a4,a1
    8000600c:	0087d79b          	srliw	a5,a5,0x8
    80006010:	65c1                	lui	a1,0x10
    80006012:	f0058593          	addi	a1,a1,-256 # ff00 <_entry-0x7fff0100>
    80006016:	8fed                	and	a5,a5,a1
    80006018:	8fd9                	or	a5,a5,a4
  sockrecvudp(m, sip, dport, sport);
    8000601a:	16c2                	slli	a3,a3,0x30
    8000601c:	92c1                	srli	a3,a3,0x30
    8000601e:	1642                	slli	a2,a2,0x30
    80006020:	9241                	srli	a2,a2,0x30
    80006022:	0007859b          	sext.w	a1,a5
    80006026:	8526                	mv	a0,s1
    80006028:	00000097          	auipc	ra,0x0
    8000602c:	55c080e7          	jalr	1372(ra) # 80006584 <sockrecvudp>
  return;
    80006030:	bd95                	j	80005ea4 <net_rx+0x54>
  arphdr = mbufpullhdr(m, *arphdr);
    80006032:	45f1                	li	a1,28
    80006034:	8526                	mv	a0,s1
    80006036:	00000097          	auipc	ra,0x0
    8000603a:	b1e080e7          	jalr	-1250(ra) # 80005b54 <mbufpull>
    8000603e:	892a                	mv	s2,a0
  if (!arphdr)
    80006040:	c179                	beqz	a0,80006106 <net_rx+0x2b6>
  if (ntohs(arphdr->hrd) != ARP_HRD_ETHER ||
    80006042:	00054783          	lbu	a5,0(a0) # ff0000 <_entry-0x7f010000>
    80006046:	00154703          	lbu	a4,1(a0)
    8000604a:	0722                	slli	a4,a4,0x8
    8000604c:	8fd9                	or	a5,a5,a4
  return (((val & 0x00ffU) << 8) |
    8000604e:	0087979b          	slliw	a5,a5,0x8
    80006052:	8321                	srli	a4,a4,0x8
    80006054:	8fd9                	or	a5,a5,a4
    80006056:	17c2                	slli	a5,a5,0x30
    80006058:	93c1                	srli	a5,a5,0x30
    8000605a:	4705                	li	a4,1
    8000605c:	0ae79563          	bne	a5,a4,80006106 <net_rx+0x2b6>
      ntohs(arphdr->pro) != ETHTYPE_IP ||
    80006060:	00254783          	lbu	a5,2(a0)
    80006064:	00354703          	lbu	a4,3(a0)
    80006068:	0722                	slli	a4,a4,0x8
    8000606a:	8fd9                	or	a5,a5,a4
    8000606c:	0087979b          	slliw	a5,a5,0x8
    80006070:	8321                	srli	a4,a4,0x8
    80006072:	8fd9                	or	a5,a5,a4
  if (ntohs(arphdr->hrd) != ARP_HRD_ETHER ||
    80006074:	0107979b          	slliw	a5,a5,0x10
    80006078:	0107d79b          	srliw	a5,a5,0x10
    8000607c:	8007879b          	addiw	a5,a5,-2048
    80006080:	e3d9                	bnez	a5,80006106 <net_rx+0x2b6>
      ntohs(arphdr->pro) != ETHTYPE_IP ||
    80006082:	00454703          	lbu	a4,4(a0)
    80006086:	4799                	li	a5,6
    80006088:	06f71f63          	bne	a4,a5,80006106 <net_rx+0x2b6>
      arphdr->hln != ETHADDR_LEN ||
    8000608c:	00554703          	lbu	a4,5(a0)
    80006090:	4791                	li	a5,4
    80006092:	06f71a63          	bne	a4,a5,80006106 <net_rx+0x2b6>
  if (ntohs(arphdr->op) != ARP_OP_REQUEST || tip != local_ip)
    80006096:	00654783          	lbu	a5,6(a0)
    8000609a:	00754703          	lbu	a4,7(a0)
    8000609e:	0722                	slli	a4,a4,0x8
    800060a0:	8fd9                	or	a5,a5,a4
    800060a2:	0087979b          	slliw	a5,a5,0x8
    800060a6:	8321                	srli	a4,a4,0x8
    800060a8:	8fd9                	or	a5,a5,a4
    800060aa:	17c2                	slli	a5,a5,0x30
    800060ac:	93c1                	srli	a5,a5,0x30
    800060ae:	4705                	li	a4,1
    800060b0:	04e79b63          	bne	a5,a4,80006106 <net_rx+0x2b6>
  tip = ntohl(arphdr->tip); // target IP address
    800060b4:	01854783          	lbu	a5,24(a0)
    800060b8:	01954703          	lbu	a4,25(a0)
    800060bc:	0722                	slli	a4,a4,0x8
    800060be:	8f5d                	or	a4,a4,a5
    800060c0:	01a54783          	lbu	a5,26(a0)
    800060c4:	07c2                	slli	a5,a5,0x10
    800060c6:	8f5d                	or	a4,a4,a5
    800060c8:	01b54783          	lbu	a5,27(a0)
    800060cc:	07e2                	slli	a5,a5,0x18
    800060ce:	8fd9                	or	a5,a5,a4
    800060d0:	0007871b          	sext.w	a4,a5
  return (((val & 0x000000ffUL) << 24) |
    800060d4:	0187979b          	slliw	a5,a5,0x18
          ((val & 0xff000000UL) >> 24));
    800060d8:	0187569b          	srliw	a3,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    800060dc:	8fd5                	or	a5,a5,a3
          ((val & 0x0000ff00UL) << 8) |
    800060de:	0087169b          	slliw	a3,a4,0x8
    800060e2:	00ff0637          	lui	a2,0xff0
    800060e6:	8ef1                	and	a3,a3,a2
          ((val & 0x00ff0000UL) >> 8) |
    800060e8:	8fd5                	or	a5,a5,a3
    800060ea:	0087571b          	srliw	a4,a4,0x8
    800060ee:	66c1                	lui	a3,0x10
    800060f0:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    800060f4:	8f75                	and	a4,a4,a3
    800060f6:	8fd9                	or	a5,a5,a4
  if (ntohs(arphdr->op) != ARP_OP_REQUEST || tip != local_ip)
    800060f8:	2781                	sext.w	a5,a5
    800060fa:	0a000737          	lui	a4,0xa000
    800060fe:	20f70713          	addi	a4,a4,527 # a00020f <_entry-0x75fffdf1>
    80006102:	00e78863          	beq	a5,a4,80006112 <net_rx+0x2c2>
  kfree(m);
    80006106:	8526                	mv	a0,s1
    80006108:	ffffa097          	auipc	ra,0xffffa
    8000610c:	f14080e7          	jalr	-236(ra) # 8000001c <kfree>
}
    80006110:	bb51                	j	80005ea4 <net_rx+0x54>
  memmove(smac, arphdr->sha, ETHADDR_LEN); // sender's ethernet address
    80006112:	4619                	li	a2,6
    80006114:	00850593          	addi	a1,a0,8
    80006118:	fb840513          	addi	a0,s0,-72
    8000611c:	ffffa097          	auipc	ra,0xffffa
    80006120:	0bc080e7          	jalr	188(ra) # 800001d8 <memmove>
  sip = ntohl(arphdr->sip); // sender's IP address (qemu's slirp)
    80006124:	00e94783          	lbu	a5,14(s2)
    80006128:	00f94703          	lbu	a4,15(s2)
    8000612c:	0722                	slli	a4,a4,0x8
    8000612e:	8f5d                	or	a4,a4,a5
    80006130:	01094783          	lbu	a5,16(s2)
    80006134:	07c2                	slli	a5,a5,0x10
    80006136:	8f5d                	or	a4,a4,a5
    80006138:	01194783          	lbu	a5,17(s2)
    8000613c:	07e2                	slli	a5,a5,0x18
    8000613e:	8fd9                	or	a5,a5,a4
    80006140:	0007871b          	sext.w	a4,a5
  return (((val & 0x000000ffUL) << 24) |
    80006144:	0187991b          	slliw	s2,a5,0x18
          ((val & 0xff000000UL) >> 24));
    80006148:	0187579b          	srliw	a5,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    8000614c:	00f96933          	or	s2,s2,a5
          ((val & 0x0000ff00UL) << 8) |
    80006150:	0087179b          	slliw	a5,a4,0x8
    80006154:	00ff06b7          	lui	a3,0xff0
    80006158:	8ff5                	and	a5,a5,a3
          ((val & 0x00ff0000UL) >> 8) |
    8000615a:	00f96933          	or	s2,s2,a5
    8000615e:	0087579b          	srliw	a5,a4,0x8
    80006162:	6741                	lui	a4,0x10
    80006164:	f0070713          	addi	a4,a4,-256 # ff00 <_entry-0x7fff0100>
    80006168:	8ff9                	and	a5,a5,a4
    8000616a:	00f96933          	or	s2,s2,a5
    8000616e:	2901                	sext.w	s2,s2
  m = mbufalloc(MBUF_DEFAULT_HEADROOM);
    80006170:	08000513          	li	a0,128
    80006174:	00000097          	auipc	ra,0x0
    80006178:	b10080e7          	jalr	-1264(ra) # 80005c84 <mbufalloc>
    8000617c:	8a2a                	mv	s4,a0
  if (!m)
    8000617e:	d541                	beqz	a0,80006106 <net_rx+0x2b6>
  arphdr = mbufputhdr(m, *arphdr);
    80006180:	45f1                	li	a1,28
    80006182:	00000097          	auipc	ra,0x0
    80006186:	aa6080e7          	jalr	-1370(ra) # 80005c28 <mbufput>
    8000618a:	89aa                	mv	s3,a0
  arphdr->hrd = htons(ARP_HRD_ETHER);
    8000618c:	00050023          	sb	zero,0(a0)
    80006190:	4785                	li	a5,1
    80006192:	00f500a3          	sb	a5,1(a0)
  arphdr->pro = htons(ETHTYPE_IP);
    80006196:	47a1                	li	a5,8
    80006198:	00f50123          	sb	a5,2(a0)
    8000619c:	000501a3          	sb	zero,3(a0)
  arphdr->hln = ETHADDR_LEN;
    800061a0:	4799                	li	a5,6
    800061a2:	00f50223          	sb	a5,4(a0)
  arphdr->pln = sizeof(uint32);
    800061a6:	4791                	li	a5,4
    800061a8:	00f502a3          	sb	a5,5(a0)
  arphdr->op = htons(op);
    800061ac:	00050323          	sb	zero,6(a0)
    800061b0:	4a89                	li	s5,2
    800061b2:	015503a3          	sb	s5,7(a0)
  memmove(arphdr->sha, local_mac, ETHADDR_LEN);
    800061b6:	4619                	li	a2,6
    800061b8:	00003597          	auipc	a1,0x3
    800061bc:	70858593          	addi	a1,a1,1800 # 800098c0 <local_mac>
    800061c0:	0521                	addi	a0,a0,8
    800061c2:	ffffa097          	auipc	ra,0xffffa
    800061c6:	016080e7          	jalr	22(ra) # 800001d8 <memmove>
  arphdr->sip = htonl(local_ip);
    800061ca:	47a9                	li	a5,10
    800061cc:	00f98723          	sb	a5,14(s3)
    800061d0:	000987a3          	sb	zero,15(s3)
    800061d4:	01598823          	sb	s5,16(s3)
    800061d8:	47bd                	li	a5,15
    800061da:	00f988a3          	sb	a5,17(s3)
  memmove(arphdr->tha, dmac, ETHADDR_LEN);
    800061de:	4619                	li	a2,6
    800061e0:	fb840593          	addi	a1,s0,-72
    800061e4:	01298513          	addi	a0,s3,18
    800061e8:	ffffa097          	auipc	ra,0xffffa
    800061ec:	ff0080e7          	jalr	-16(ra) # 800001d8 <memmove>
  return (((val & 0x000000ffUL) << 24) |
    800061f0:	0189171b          	slliw	a4,s2,0x18
          ((val & 0xff000000UL) >> 24));
    800061f4:	0189579b          	srliw	a5,s2,0x18
          ((val & 0x00ff0000UL) >> 8) |
    800061f8:	8f5d                	or	a4,a4,a5
          ((val & 0x0000ff00UL) << 8) |
    800061fa:	0089179b          	slliw	a5,s2,0x8
    800061fe:	00ff06b7          	lui	a3,0xff0
    80006202:	8ff5                	and	a5,a5,a3
          ((val & 0x00ff0000UL) >> 8) |
    80006204:	8f5d                	or	a4,a4,a5
    80006206:	0089579b          	srliw	a5,s2,0x8
    8000620a:	66c1                	lui	a3,0x10
    8000620c:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    80006210:	8ff5                	and	a5,a5,a3
    80006212:	8fd9                	or	a5,a5,a4
  arphdr->tip = htonl(dip);
    80006214:	00e98c23          	sb	a4,24(s3)
    80006218:	0087d71b          	srliw	a4,a5,0x8
    8000621c:	00e98ca3          	sb	a4,25(s3)
    80006220:	0107d71b          	srliw	a4,a5,0x10
    80006224:	00e98d23          	sb	a4,26(s3)
    80006228:	0187d79b          	srliw	a5,a5,0x18
    8000622c:	00f98da3          	sb	a5,27(s3)
  net_tx_eth(m, ETHTYPE_ARP);
    80006230:	6585                	lui	a1,0x1
    80006232:	80658593          	addi	a1,a1,-2042 # 806 <_entry-0x7ffff7fa>
    80006236:	8552                	mv	a0,s4
    80006238:	00000097          	auipc	ra,0x0
    8000623c:	978080e7          	jalr	-1672(ra) # 80005bb0 <net_tx_eth>
  return 0;
    80006240:	b5d9                	j	80006106 <net_rx+0x2b6>

0000000080006242 <sockinit>:
...
sockinit(void)
{
  ...
  initlock(&lock, "socktbl");
    8000624a:	00003597          	auipc	a1,0x3
    8000624e:	5d658593          	addi	a1,a1,1494 # 80009820 <syscalls+0x448>
    80006252:	00019517          	auipc	a0,0x19
    80006256:	0ce50513          	addi	a0,a0,206 # 8001f320 <lock>
    8000625a:	00001097          	auipc	ra,0x1
    8000625e:	e5c080e7          	jalr	-420(ra) # 800070b6 <initlock>
}
    80006262:	60a2                	ld	ra,8(sp)
    80006264:	6402                	ld	s0,0(sp)
    80006266:	0141                	addi	sp,sp,16
    80006268:	8082                	ret

000000008000626a <sockalloc>:
...
sockalloc(struct file **f, uint32 raddr, uint16 lport, uint16 rport)
{
    ...
    80006272:	f04a                	sd	s2,32(sp)
    80006274:	ec4e                	sd	s3,24(sp)
    80006276:	e852                	sd	s4,16(sp)
    80006278:	e456                	sd	s5,8(sp)
    8000627a:	0080                	addi	s0,sp,64
    8000627c:	892a                	mv	s2,a0
    8000627e:	84ae                	mv	s1,a1
    80006280:	8a32                	mv	s4,a2
    80006282:	89b6                	mv	s3,a3
  struct sock *si, *pos;

  si = 0;
  *f = 0;
    80006284:	00053023          	sd	zero,0(a0)
  if ((*f = filealloc()) == 0)
    80006288:	ffffd097          	auipc	ra,0xffffd
    8000628c:	648080e7          	jalr	1608(ra) # 800038d0 <filealloc>
    80006290:	00a93023          	sd	a0,0(s2)
    80006294:	c975                	beqz	a0,80006388 <sockalloc+0x11e>
    goto bad;
  if ((si = (struct sock*)kalloc()) == 0)
    80006296:	ffffa097          	auipc	ra,0xffffa
    8000629a:	e82080e7          	jalr	-382(ra) # 80000118 <kalloc>
    8000629e:	8aaa                	mv	s5,a0
    800062a0:	c15d                	beqz	a0,80006346 <sockalloc+0xdc>
    goto bad;

  // initialize objects
  si->raddr = raddr;
    800062a2:	c504                	sw	s1,8(a0)
  si->lport = lport;
    800062a4:	01451623          	sh	s4,12(a0)
  si->rport = rport;
    800062a8:	01351723          	sh	s3,14(a0)
  initlock(&si->lock, "sock");
    800062ac:	00003597          	auipc	a1,0x3
    800062b0:	57c58593          	addi	a1,a1,1404 # 80009828 <syscalls+0x450>
    800062b4:	0541                	addi	a0,a0,16
    800062b6:	00001097          	auipc	ra,0x1
    800062ba:	e00080e7          	jalr	-512(ra) # 800070b6 <initlock>
  mbufq_init(&si->rxq);
    800062be:	028a8513          	addi	a0,s5,40
    800062c2:	00000097          	auipc	ra,0x0
    800062c6:	a7a080e7          	jalr	-1414(ra) # 80005d3c <mbufq_init>
  (*f)->type = FD_SOCK;
    800062ca:	00093783          	ld	a5,0(s2)
    800062ce:	4711                	li	a4,4
    800062d0:	c398                	sw	a4,0(a5)
  (*f)->readable = 1;
    800062d2:	00093703          	ld	a4,0(s2)
    800062d6:	4785                	li	a5,1
    800062d8:	00f70423          	sb	a5,8(a4)
  (*f)->writable = 1;
    800062dc:	00093703          	ld	a4,0(s2)
    800062e0:	00f704a3          	sb	a5,9(a4)
  (*f)->sock = si;
    800062e4:	00093783          	ld	a5,0(s2)
    800062e8:	0357b023          	sd	s5,32(a5) # f020020 <_entry-0x70fdffe0>
  ...
  acquire(&lock);
    ...
    800062f8:	e52080e7          	jalr	-430(ra) # 80007146 <acquire>
  pos = sockets;
    800062fc:	00004597          	auipc	a1,0x4
    80006300:	d2c5b583          	ld	a1,-724(a1) # 8000a028 <sockets>
  while (pos) {
    80006304:	c9b1                	beqz	a1,80006358 <sockalloc+0xee>
  pos = sockets;
    80006306:	87ae                	mv	a5,a1
    if (pos->raddr == raddr &&
    80006308:	000a061b          	sext.w	a2,s4
        pos->lport == lport &&
    8000630c:	0009869b          	sext.w	a3,s3
    80006310:	a019                	j	80006316 <sockalloc+0xac>
	pos->rport == rport) {
      release(&lock);
      goto bad;
    }
    pos = pos->next;
    80006312:	639c                	ld	a5,0(a5)
  while (pos) {
    80006314:	c3b1                	beqz	a5,80006358 <sockalloc+0xee>
    if (pos->raddr == raddr &&
    80006316:	4798                	lw	a4,8(a5)
    80006318:	fe971de3          	bne	a4,s1,80006312 <sockalloc+0xa8>
    8000631c:	00c7d703          	lhu	a4,12(a5)
    80006320:	fec719e3          	bne	a4,a2,80006312 <sockalloc+0xa8>
        pos->lport == lport &&
    80006324:	00e7d703          	lhu	a4,14(a5)
    80006328:	fed715e3          	bne	a4,a3,80006312 <sockalloc+0xa8>
      release(&lock);
    8000632c:	00019517          	auipc	a0,0x19
    80006330:	ff450513          	addi	a0,a0,-12 # 8001f320 <lock>
    80006334:	00001097          	auipc	ra,0x1
    80006338:	ec6080e7          	jalr	-314(ra) # 800071fa <release>
  release(&lock);
  return 0;
...
bad:
  if (si)
    kfree((char*)si);
    8000633c:	8556                	mv	a0,s5
    8000633e:	ffffa097          	auipc	ra,0xffffa
    80006342:	cde080e7          	jalr	-802(ra) # 8000001c <kfree>
  if (*f)
    80006346:	00093503          	ld	a0,0(s2)
    8000634a:	c129                	beqz	a0,8000638c <sockalloc+0x122>
    fileclose(*f);
    8000634c:	ffffd097          	auipc	ra,0xffffd
    80006350:	640080e7          	jalr	1600(ra) # 8000398c <fileclose>
  return -1;
    80006354:	557d                	li	a0,-1
    80006356:	a005                	j	80006376 <sockalloc+0x10c>
  si->next = sockets;
    80006358:	00bab023          	sd	a1,0(s5)
  sockets = si;
    8000635c:	00004797          	auipc	a5,0x4
    80006360:	cd57b623          	sd	s5,-820(a5) # 8000a028 <sockets>
  release(&lock);
    80006364:	00019517          	auipc	a0,0x19
    80006368:	fbc50513          	addi	a0,a0,-68 # 8001f320 <lock>
    8000636c:	00001097          	auipc	ra,0x1
    80006370:	e8e080e7          	jalr	-370(ra) # 800071fa <release>
  return 0;
    ...
    8000637c:	7902                	ld	s2,32(sp)
    8000637e:	69e2                	ld	s3,24(sp)
    80006380:	6a42                	ld	s4,16(sp)
    80006382:	6aa2                	ld	s5,8(sp)
    80006384:	6121                	addi	sp,sp,64
    80006386:	8082                	ret
  return -1;
    80006388:	557d                	li	a0,-1
    8000638a:	b7f5                	j	80006376 <sockalloc+0x10c>
    8000638c:	557d                	li	a0,-1
    8000638e:	b7e5                	j	80006376 <sockalloc+0x10c>

0000000080006390 <sockclose>:
...
sockclose(struct sock *si)
{
    ...
    8000639c:	892a                	mv	s2,a0
  struct sock **pos;
  struct mbuf *m;

  // remove from list of sockets
  acquire(&lock);
    8000639e:	00019517          	auipc	a0,0x19
    800063a2:	f8250513          	addi	a0,a0,-126 # 8001f320 <lock>
    800063a6:	00001097          	auipc	ra,0x1
    800063aa:	da0080e7          	jalr	-608(ra) # 80007146 <acquire>
  pos = &sockets;
    800063ae:	00004797          	auipc	a5,0x4
    800063b2:	c7a7b783          	ld	a5,-902(a5) # 8000a028 <sockets>
  while (*pos) {
    800063b6:	cb99                	beqz	a5,800063cc <sockclose+0x3c>
    if (*pos == si){
    800063b8:	02f90563          	beq	s2,a5,800063e2 <sockclose+0x52>
      *pos = si->next;
      break;
    }
    pos = &(*pos)->next;
  ...
  while (*pos) {
    800063c0:	c791                	beqz	a5,800063cc <sockclose+0x3c>
    if (*pos == si){
    800063c2:	fef91de3          	bne	s2,a5,800063bc <sockclose+0x2c>
      *pos = si->next;
    800063c6:	00093783          	ld	a5,0(s2)
    800063ca:	e31c                	sd	a5,0(a4)
  }
  release(&lock);
    800063cc:	00019517          	auipc	a0,0x19
    800063d0:	f5450513          	addi	a0,a0,-172 # 8001f320 <lock>
    800063d4:	00001097          	auipc	ra,0x1
    800063d8:	e26080e7          	jalr	-474(ra) # 800071fa <release>

  // free any pending mbufs
  while (!mbufq_empty(&si->rxq)) {
    800063dc:	02890493          	addi	s1,s2,40
    800063e0:	a839                	j	800063fe <sockclose+0x6e>
  pos = &sockets;
    800063e2:	00004717          	auipc	a4,0x4
    800063e6:	c4670713          	addi	a4,a4,-954 # 8000a028 <sockets>
    800063ea:	bff1                	j	800063c6 <sockclose+0x36>
    m = mbufq_pophead(&si->rxq);
    800063ec:	8526                	mv	a0,s1
    800063ee:	00000097          	auipc	ra,0x0
    800063f2:	926080e7          	jalr	-1754(ra) # 80005d14 <mbufq_pophead>
    mbuffree(m);
    800063f6:	00000097          	auipc	ra,0x0
    800063fa:	8e6080e7          	jalr	-1818(ra) # 80005cdc <mbuffree>
  while (!mbufq_empty(&si->rxq)) {
    800063fe:	8526                	mv	a0,s1
    80006400:	00000097          	auipc	ra,0x0
    80006404:	92a080e7          	jalr	-1750(ra) # 80005d2a <mbufq_empty>
    80006408:	d175                	beqz	a0,800063ec <sockclose+0x5c>
  }

  kfree((char*)si);
    8000640a:	854a                	mv	a0,s2
    8000640c:	ffffa097          	auipc	ra,0xffffa
    80006410:	c10080e7          	jalr	-1008(ra) # 8000001c <kfree>
}
    80006414:	60e2                	ld	ra,24(sp)
    80006416:	6442                	ld	s0,16(sp)
    80006418:	64a2                	ld	s1,8(sp)
    8000641a:	6902                	ld	s2,0(sp)
    8000641c:	6105                	addi	sp,sp,32
    8000641e:	8082                	ret

0000000080006420 <sockread>:
...
sockread(struct sock *si, uint64 addr, int n)
{
    ...
    80006434:	8a2e                	mv	s4,a1
    80006436:	8ab2                	mv	s5,a2
  struct proc *pr = myproc();
    80006438:	ffffb097          	auipc	ra,0xffffb
    8000643c:	a68080e7          	jalr	-1432(ra) # 80000ea0 <myproc>
    80006440:	892a                	mv	s2,a0
  struct mbuf *m;
  int len;

  acquire(&si->lock);
    80006442:	01048993          	addi	s3,s1,16
    80006446:	854e                	mv	a0,s3
    80006448:	00001097          	auipc	ra,0x1
    8000644c:	cfe080e7          	jalr	-770(ra) # 80007146 <acquire>
  while (mbufq_empty(&si->rxq) && !pr->killed) {
    80006450:	02848493          	addi	s1,s1,40
    80006454:	8526                	mv	a0,s1
    80006456:	00000097          	auipc	ra,0x0
    8000645a:	8d4080e7          	jalr	-1836(ra) # 80005d2a <mbufq_empty>
    8000645e:	c919                	beqz	a0,80006474 <sockread+0x54>
    80006460:	02892783          	lw	a5,40(s2)
    80006464:	eba5                	bnez	a5,800064d4 <sockread+0xb4>
    sleep(&si->rxq, &si->lock);
    80006466:	85ce                	mv	a1,s3
    80006468:	8526                	mv	a0,s1
    8000646a:	ffffb097          	auipc	ra,0xffffb
    8000646e:	0f2080e7          	jalr	242(ra) # 8000155c <sleep>
    80006472:	b7cd                	j	80006454 <sockread+0x34>
  }
  if (pr->killed) {
    80006474:	02892783          	lw	a5,40(s2)
    80006478:	efb1                	bnez	a5,800064d4 <sockread+0xb4>
    release(&si->lock);
    return -1;
  }
  m = mbufq_pophead(&si->rxq);
    ...
    80006480:	898080e7          	jalr	-1896(ra) # 80005d14 <mbufq_pophead>
    80006484:	84aa                	mv	s1,a0
  release(&si->lock);
    80006486:	854e                	mv	a0,s3
    80006488:	00001097          	auipc	ra,0x1
    8000648c:	d72080e7          	jalr	-654(ra) # 800071fa <release>

  len = m->len;
    80006490:	489c                	lw	a5,16(s1)
  if (len > n)
    80006492:	89be                	mv	s3,a5
    80006494:	00fad363          	bge	s5,a5,8000649a <sockread+0x7a>
    80006498:	89d6                	mv	s3,s5
    8000649a:	2981                	sext.w	s3,s3
    len = n;
  if (copyout(pr->pagetable, addr, m->head, len) == -1) {
    8000649c:	86ce                	mv	a3,s3
    8000649e:	6490                	ld	a2,8(s1)
    800064a0:	85d2                	mv	a1,s4
    800064a2:	05093503          	ld	a0,80(s2)
    800064a6:	ffffa097          	auipc	ra,0xffffa
    800064aa:	6c0080e7          	jalr	1728(ra) # 80000b66 <copyout>
    800064ae:	892a                	mv	s2,a0
    800064b0:	57fd                	li	a5,-1
    800064b2:	02f50863          	beq	a0,a5,800064e2 <sockread+0xc2>
    mbuffree(m);
    return -1;
  }
  mbuffree(m);
    ...
    800064bc:	824080e7          	jalr	-2012(ra) # 80005cdc <mbuffree>
  return len;
}
    800064c0:	854e                	mv	a0,s3
    800064c2:	70e2                	ld	ra,56(sp)
    800064c4:	7442                	ld	s0,48(sp)
    800064c6:	74a2                	ld	s1,40(sp)
    800064c8:	7902                	ld	s2,32(sp)
    800064ca:	69e2                	ld	s3,24(sp)
    800064cc:	6a42                	ld	s4,16(sp)
    800064ce:	6aa2                	ld	s5,8(sp)
    800064d0:	6121                	addi	sp,sp,64
    800064d2:	8082                	ret
    release(&si->lock);
    800064d4:	854e                	mv	a0,s3
    800064d6:	00001097          	auipc	ra,0x1
    800064da:	d24080e7          	jalr	-732(ra) # 800071fa <release>
    return -1;
    800064de:	59fd                	li	s3,-1
    800064e0:	b7c5                	j	800064c0 <sockread+0xa0>
    mbuffree(m);
    800064e2:	8526                	mv	a0,s1
    800064e4:	fffff097          	auipc	ra,0xfffff
    800064e8:	7f8080e7          	jalr	2040(ra) # 80005cdc <mbuffree>
    return -1;
    800064ec:	89ca                	mv	s3,s2
    800064ee:	bfc9                	j	800064c0 <sockread+0xa0>

00000000800064f0 <sockwrite>:

int
sockwrite(struct sock *si, uint64 addr, int n)
{
    800064f0:	7139                	addi	sp,sp,-64
    800064f2:	fc06                	sd	ra,56(sp)
    800064f4:	f822                	sd	s0,48(sp)
    800064f6:	f426                	sd	s1,40(sp)
    800064f8:	f04a                	sd	s2,32(sp)
    800064fa:	ec4e                	sd	s3,24(sp)
    800064fc:	e852                	sd	s4,16(sp)
    800064fe:	e456                	sd	s5,8(sp)
    80006500:	0080                	addi	s0,sp,64
    80006502:	8aaa                	mv	s5,a0
    80006504:	89ae                	mv	s3,a1
    80006506:	8932                	mv	s2,a2
  struct proc *pr = myproc();
    80006508:	ffffb097          	auipc	ra,0xffffb
    8000650c:	998080e7          	jalr	-1640(ra) # 80000ea0 <myproc>
    80006510:	8a2a                	mv	s4,a0
  struct mbuf *m;

  m = mbufalloc(MBUF_DEFAULT_HEADROOM);
    80006512:	08000513          	li	a0,128
    80006516:	fffff097          	auipc	ra,0xfffff
    8000651a:	76e080e7          	jalr	1902(ra) # 80005c84 <mbufalloc>
  if (!m)
    8000651e:	c12d                	beqz	a0,80006580 <sockwrite+0x90>
    80006520:	84aa                	mv	s1,a0
    return -1;

  if (copyin(pr->pagetable, mbufput(m, n), addr, n) == -1) {
    80006522:	050a3a03          	ld	s4,80(s4)
    80006526:	85ca                	mv	a1,s2
    80006528:	fffff097          	auipc	ra,0xfffff
    8000652c:	700080e7          	jalr	1792(ra) # 80005c28 <mbufput>
    80006530:	85aa                	mv	a1,a0
    80006532:	86ca                	mv	a3,s2
    80006534:	864e                	mv	a2,s3
    80006536:	8552                	mv	a0,s4
    80006538:	ffffa097          	auipc	ra,0xffffa
    8000653c:	6ba080e7          	jalr	1722(ra) # 80000bf2 <copyin>
    80006540:	89aa                	mv	s3,a0
    80006542:	57fd                	li	a5,-1
    80006544:	02f50863          	beq	a0,a5,80006574 <sockwrite+0x84>
    mbuffree(m);
    return -1;
  }
  net_tx_udp(m, si->raddr, si->lport, si->rport);
    80006548:	00ead683          	lhu	a3,14(s5)
    8000654c:	00cad603          	lhu	a2,12(s5)
    80006550:	008aa583          	lw	a1,8(s5)
    80006554:	8526                	mv	a0,s1
    80006556:	fffff097          	auipc	ra,0xfffff
    8000655a:	7f6080e7          	jalr	2038(ra) # 80005d4c <net_tx_udp>
  return n;
    8000655e:	89ca                	mv	s3,s2
}
    80006560:	854e                	mv	a0,s3
    80006562:	70e2                	ld	ra,56(sp)
    80006564:	7442                	ld	s0,48(sp)
    80006566:	74a2                	ld	s1,40(sp)
    80006568:	7902                	ld	s2,32(sp)
    8000656a:	69e2                	ld	s3,24(sp)
    8000656c:	6a42                	ld	s4,16(sp)
    8000656e:	6aa2                	ld	s5,8(sp)
    80006570:	6121                	addi	sp,sp,64
    80006572:	8082                	ret
    mbuffree(m);
    80006574:	8526                	mv	a0,s1
    80006576:	fffff097          	auipc	ra,0xfffff
    8000657a:	766080e7          	jalr	1894(ra) # 80005cdc <mbuffree>
    return -1;
    8000657e:	b7cd                	j	80006560 <sockwrite+0x70>
    return -1;
    80006580:	59fd                	li	s3,-1
    80006582:	bff9                	j	80006560 <sockwrite+0x70>

0000000080006584 <sockrecvudp>:
...
sockrecvudp(struct mbuf *m, uint32 raddr, uint16 lport, uint16 rport)
{
    ...
    80006596:	8a2a                	mv	s4,a0
    80006598:	892e                	mv	s2,a1
    8000659a:	89b2                	mv	s3,a2
    8000659c:	8ab6                	mv	s5,a3
  ...
  acquire(&lock);
    8000659e:	00019517          	auipc	a0,0x19
    800065a2:	d8250513          	addi	a0,a0,-638 # 8001f320 <lock>
    800065a6:	00001097          	auipc	ra,0x1
    800065aa:	ba0080e7          	jalr	-1120(ra) # 80007146 <acquire>
  si = sockets;
    800065ae:	00004497          	auipc	s1,0x4
    800065b2:	a7a4b483          	ld	s1,-1414(s1) # 8000a028 <sockets>
  while (si) {
    800065b6:	c4ad                	beqz	s1,80006620 <sockrecvudp+0x9c>
    if (si->raddr == raddr && si->lport == lport && si->rport == rport)
    800065b8:	0009871b          	sext.w	a4,s3
    800065bc:	000a869b          	sext.w	a3,s5
    800065c0:	a019                	j	800065c6 <sockrecvudp+0x42>
      goto found;
    si = si->next;
    800065c2:	6084                	ld	s1,0(s1)
  while (si) {
    800065c4:	ccb1                	beqz	s1,80006620 <sockrecvudp+0x9c>
    if (si->raddr == raddr && si->lport == lport && si->rport == rport)
    800065c6:	449c                	lw	a5,8(s1)
    800065c8:	ff279de3          	bne	a5,s2,800065c2 <sockrecvudp+0x3e>
    800065cc:	00c4d783          	lhu	a5,12(s1)
    800065d0:	fee799e3          	bne	a5,a4,800065c2 <sockrecvudp+0x3e>
    800065d4:	00e4d783          	lhu	a5,14(s1)
    800065d8:	fed795e3          	bne	a5,a3,800065c2 <sockrecvudp+0x3e>
  release(&lock);
  mbuffree(m);
  return;
...
found:
  acquire(&si->lock);
    800065dc:	01048913          	addi	s2,s1,16
    800065e0:	854a                	mv	a0,s2
    800065e2:	00001097          	auipc	ra,0x1
    800065e6:	b64080e7          	jalr	-1180(ra) # 80007146 <acquire>
  mbufq_pushtail(&si->rxq, m);
    800065ea:	02848493          	addi	s1,s1,40
    800065ee:	85d2                	mv	a1,s4
    800065f0:	8526                	mv	a0,s1
    800065f2:	fffff097          	auipc	ra,0xfffff
    800065f6:	702080e7          	jalr	1794(ra) # 80005cf4 <mbufq_pushtail>
  wakeup(&si->rxq);
    800065fa:	8526                	mv	a0,s1
    800065fc:	ffffb097          	auipc	ra,0xffffb
    80006600:	0ec080e7          	jalr	236(ra) # 800016e8 <wakeup>
  release(&si->lock);
    80006604:	854a                	mv	a0,s2
    80006606:	00001097          	auipc	ra,0x1
    8000660a:	bf4080e7          	jalr	-1036(ra) # 800071fa <release>
  release(&lock);
    8000660e:	00019517          	auipc	a0,0x19
    80006612:	d1250513          	addi	a0,a0,-750 # 8001f320 <lock>
    80006616:	00001097          	auipc	ra,0x1
    8000661a:	be4080e7          	jalr	-1052(ra) # 800071fa <release>
    8000661e:	a831                	j	8000663a <sockrecvudp+0xb6>
  release(&lock);
    80006620:	00019517          	auipc	a0,0x19
    80006624:	d0050513          	addi	a0,a0,-768 # 8001f320 <lock>
    80006628:	00001097          	auipc	ra,0x1
    8000662c:	bd2080e7          	jalr	-1070(ra) # 800071fa <release>
  mbuffree(m);
    80006630:	8552                	mv	a0,s4
    80006632:	fffff097          	auipc	ra,0xfffff
    80006636:	6aa080e7          	jalr	1706(ra) # 80005cdc <mbuffree>
}
    8000663a:	70e2                	ld	ra,56(sp)
    8000663c:	7442                	ld	s0,48(sp)
    8000663e:	74a2                	ld	s1,40(sp)
    80006640:	7902                	ld	s2,32(sp)
    80006642:	69e2                	ld	s3,24(sp)
    80006644:	6a42                	ld	s4,16(sp)
    80006646:	6aa2                	ld	s5,8(sp)
    80006648:	6121                	addi	sp,sp,64
    8000664a:	8082                	ret

000000008000664c <pci_init>:
#include "proc.h"
#include "defs.h"
...
pci_init()
{
    8000664c:	715d                	addi	sp,sp,-80
    8000664e:	e486                	sd	ra,72(sp)
    80006650:	e0a2                	sd	s0,64(sp)
    80006652:	fc26                	sd	s1,56(sp)
    80006654:	f84a                	sd	s2,48(sp)
    80006656:	f44e                	sd	s3,40(sp)
    80006658:	f052                	sd	s4,32(sp)
    8000665a:	ec56                	sd	s5,24(sp)
    8000665c:	e85a                	sd	s6,16(sp)
    8000665e:	e45e                	sd	s7,8(sp)
    80006660:	0880                	addi	s0,sp,80
    80006662:	300004b7          	lui	s1,0x30000
    ...
    if(id == 0x100e8086){
    80006666:	100e8937          	lui	s2,0x100e8
    8000666a:	08690913          	addi	s2,s2,134 # 100e8086 <_entry-0x6ff17f7a>
      // command and status register.
      // bit 0 : I/O access enable
      // bit 1 : memory access enable
      // bit 2 : enable mastering
      base[1] = 7;
    8000666e:	4b9d                	li	s7,7
      for(int i = 0; i < 6; i++){
        uint32 old = base[4+i];
    ...
    80006670:	5afd                	li	s5,-1
      ...
      base[4+0] = e1000_regs;
    80006672:	40000b37          	lui	s6,0x40000
    80006676:	6a09                	lui	s4,0x2
  for(int dev = 0; dev < 32; dev++){
    80006678:	300409b7          	lui	s3,0x30040
    8000667c:	a821                	j	80006694 <pci_init+0x48>
      base[4+0] = e1000_regs;
    8000667e:	0166a823          	sw	s6,16(a3)

      e1000_init((uint32*)e1000_regs);
    80006682:	40000537          	lui	a0,0x40000
    80006686:	fffff097          	auipc	ra,0xfffff
    8000668a:	0da080e7          	jalr	218(ra) # 80005760 <e1000_init>
  for(int dev = 0; dev < 32; dev++){
    8000668e:	94d2                	add	s1,s1,s4
    80006690:	03348a63          	beq	s1,s3,800066c4 <pci_init+0x78>
    volatile uint32 *base = ecam + off;
    80006694:	86a6                	mv	a3,s1
    uint32 id = base[0];
    80006696:	409c                	lw	a5,0(s1)
    80006698:	2781                	sext.w	a5,a5
    if(id == 0x100e8086){
    8000669a:	ff279ae3          	bne	a5,s2,8000668e <pci_init+0x42>
      base[1] = 7;
    8000669e:	0174a223          	sw	s7,4(s1) # 30000004 <_entry-0x4ffffffc>
      __sync_synchronize();
    800066a2:	0ff0000f          	fence
      for(int i = 0; i < 6; i++){
    800066a6:	01048793          	addi	a5,s1,16
    800066aa:	02848613          	addi	a2,s1,40
        uint32 old = base[4+i];
    800066ae:	4398                	lw	a4,0(a5)
    800066b0:	2701                	sext.w	a4,a4
        base[4+i] = 0xffffffff;
    800066b2:	0157a023          	sw	s5,0(a5)
        __sync_synchronize();
    800066b6:	0ff0000f          	fence
        base[4+i] = old;
    800066ba:	c398                	sw	a4,0(a5)
      for(int i = 0; i < 6; i++){
    800066bc:	0791                	addi	a5,a5,4
    800066be:	fec798e3          	bne	a5,a2,800066ae <pci_init+0x62>
    800066c2:	bf75                	j	8000667e <pci_init+0x32>
    }
  }
}
    800066c4:	60a6                	ld	ra,72(sp)
    800066c6:	6406                	ld	s0,64(sp)
    800066c8:	74e2                	ld	s1,56(sp)
    800066ca:	7942                	ld	s2,48(sp)
    800066cc:	79a2                	ld	s3,40(sp)
    800066ce:	7a02                	ld	s4,32(sp)
    800066d0:	6ae2                	ld	s5,24(sp)
    800066d2:	6b42                	ld	s6,16(sp)
    800066d4:	6ba2                	ld	s7,8(sp)
    800066d6:	6161                	addi	sp,sp,80
    800066d8:	8082                	ret

00000000800066da <timerinit>:
...
timerinit()
{
  ...
  asm volatile("csrr %0, mhartid" : "=r" (x) );
    800066e0:	f14027f3          	csrr	a5,mhartid
  ...
  *(uint64*)CLINT_MTIMECMP(id) = *(uint64*)CLINT_MTIME + interval;
    800066e8:	0037979b          	slliw	a5,a5,0x3
    800066ec:	02004737          	lui	a4,0x2004
    800066f0:	97ba                	add	a5,a5,a4
    800066f2:	0200c737          	lui	a4,0x200c
    800066f6:	ff873583          	ld	a1,-8(a4) # 200bff8 <_entry-0x7dff4008>
    800066fa:	000f4637          	lui	a2,0xf4
    800066fe:	24060613          	addi	a2,a2,576 # f4240 <_entry-0x7ff0bdc0>
    80006702:	95b2                	add	a1,a1,a2
    80006704:	e38c                	sd	a1,0(a5)
  ...
  uint64 *scratch = &timer_scratch[id][0];
    80006706:	00269713          	slli	a4,a3,0x2
    8000670a:	9736                	add	a4,a4,a3
    8000670c:	00371693          	slli	a3,a4,0x3
    80006710:	00019717          	auipc	a4,0x19
    80006714:	c3070713          	addi	a4,a4,-976 # 8001f340 <timer_scratch>
    80006718:	9736                	add	a4,a4,a3
  scratch[3] = CLINT_MTIMECMP(id);
    8000671a:	ef1c                	sd	a5,24(a4)
  scratch[4] = interval;
    8000671c:	f310                	sd	a2,32(a4)
  asm volatile("csrw mscratch, %0" : : "r" (x));
    8000671e:	34071073          	csrw	mscratch,a4
  asm volatile("csrw mtvec, %0" : : "r" (x));
    80006722:	fffff797          	auipc	a5,0xfffff
    80006726:	9de78793          	addi	a5,a5,-1570 # 80005100 <timervec>
    8000672a:	30579073          	csrw	mtvec,a5
  ...
  w_mstatus(r_mstatus() | MSTATUS_MIE);
    80006732:	0087e793          	ori	a5,a5,8
  asm volatile("csrw mstatus, %0" : : "r" (x));
    80006736:	30079073          	csrw	mstatus,a5
  asm volatile("csrr %0, mie" : "=r" (x) );
    8000673a:	304027f3          	csrr	a5,mie

  // enable machine-mode timer interrupts.
  w_mie(r_mie() | MIE_MTIE);
    8000673e:	0807e793          	ori	a5,a5,128
  asm volatile("csrw mie, %0" : : "r" (x));
    80006742:	30479073          	csrw	mie,a5
}
    80006746:	6422                	ld	s0,8(sp)
    80006748:	0141                	addi	sp,sp,16
    8000674a:	8082                	ret

000000008000674c <start>:
{
    8000674c:	1141                	addi	sp,sp,-16
    8000674e:	e406                	sd	ra,8(sp)
    80006750:	e022                	sd	s0,0(sp)
    80006752:	0800                	addi	s0,sp,16
  asm volatile("csrr %0, mstatus" : "=r" (x) );
    80006754:	300027f3          	csrr	a5,mstatus
  x &= ~MSTATUS_MPP_MASK;
    80006758:	7779                	lui	a4,0xffffe
    8000675a:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7ffd727f>
    8000675e:	8ff9                	and	a5,a5,a4
  x |= MSTATUS_MPP_S;
    80006760:	6705                	lui	a4,0x1
    80006762:	80070713          	addi	a4,a4,-2048 # 800 <_entry-0x7ffff800>
    80006766:	8fd9                	or	a5,a5,a4
  asm volatile("csrw mstatus, %0" : : "r" (x));
    80006768:	30079073          	csrw	mstatus,a5
  asm volatile("csrw mepc, %0" : : "r" (x));
    8000676c:	ffffa797          	auipc	a5,0xffffa
    80006770:	bba78793          	addi	a5,a5,-1094 # 80000326 <main>
    80006774:	34179073          	csrw	mepc,a5
  asm volatile("csrw satp, %0" : : "r" (x));
    80006778:	4781                	li	a5,0
    8000677a:	18079073          	csrw	satp,a5
  asm volatile("csrw medeleg, %0" : : "r" (x));
    8000677e:	67c1                	lui	a5,0x10
    80006780:	17fd                	addi	a5,a5,-1
    80006782:	30279073          	csrw	medeleg,a5
  asm volatile("csrw mideleg, %0" : : "r" (x));
    80006786:	30379073          	csrw	mideleg,a5
  asm volatile("csrr %0, sie" : "=r" (x) );
    8000678a:	104027f3          	csrr	a5,sie
  w_sie(r_sie() | SIE_SEIE | SIE_STIE | SIE_SSIE);
    8000678e:	2227e793          	ori	a5,a5,546
  asm volatile("csrw sie, %0" : : "r" (x));
    80006792:	10479073          	csrw	sie,a5
  asm volatile("csrw pmpaddr0, %0" : : "r" (x));
    80006796:	57fd                	li	a5,-1
    80006798:	83a9                	srli	a5,a5,0xa
    8000679a:	3b079073          	csrw	pmpaddr0,a5
  asm volatile("csrw pmpcfg0, %0" : : "r" (x));
    8000679e:	47bd                	li	a5,15
    800067a0:	3a079073          	csrw	pmpcfg0,a5
  timerinit();
    800067a4:	00000097          	auipc	ra,0x0
    800067a8:	f36080e7          	jalr	-202(ra) # 800066da <timerinit>
  asm volatile("csrr %0, mhartid" : "=r" (x) );
    800067ac:	f14027f3          	csrr	a5,mhartid
  w_tp(id);
    800067b0:	2781                	sext.w	a5,a5
  asm volatile("mv tp, %0" : : "r" (x));
    800067b2:	823e                	mv	tp,a5
  asm volatile("mret");
...
{
    800067c0:	715d                	addi	sp,sp,-80
    800067c2:	e486                	sd	ra,72(sp)
    800067c4:	e0a2                	sd	s0,64(sp)
    800067c6:	fc26                	sd	s1,56(sp)
    800067c8:	f84a                	sd	s2,48(sp)
    800067ca:	f44e                	sd	s3,40(sp)
    800067cc:	f052                	sd	s4,32(sp)
    800067ce:	ec56                	sd	s5,24(sp)
    800067d0:	0880                	addi	s0,sp,80
  int i;

  for(i = 0; i < n; i++){
    800067d2:	04c05663          	blez	a2,8000681e <consolewrite+0x5e>
    800067d6:	8a2a                	mv	s4,a0
    800067d8:	84ae                	mv	s1,a1
    800067da:	89b2                	mv	s3,a2
    800067dc:	4901                	li	s2,0
    char c;
    if(either_copyin(&c, user_src, src+i, 1) == -1)
    800067de:	5afd                	li	s5,-1
    800067e0:	4685                	li	a3,1
    800067e2:	8626                	mv	a2,s1
    800067e4:	85d2                	mv	a1,s4
    800067e6:	fbf40513          	addi	a0,s0,-65
    800067ea:	ffffb097          	auipc	ra,0xffffb
    800067ee:	16c080e7          	jalr	364(ra) # 80001956 <either_copyin>
    800067f2:	01550c63          	beq	a0,s5,8000680a <consolewrite+0x4a>
      break;
    uartputc(c);
    800067f6:	fbf44503          	lbu	a0,-65(s0)
    800067fa:	00000097          	auipc	ra,0x0
    800067fe:	78e080e7          	jalr	1934(ra) # 80006f88 <uartputc>
  for(i = 0; i < n; i++){
    80006802:	2905                	addiw	s2,s2,1
    80006804:	0485                	addi	s1,s1,1
    80006806:	fd299de3          	bne	s3,s2,800067e0 <consolewrite+0x20>
  }

  return i;
}
    8000680a:	854a                	mv	a0,s2
    8000680c:	60a6                	ld	ra,72(sp)
    8000680e:	6406                	ld	s0,64(sp)
    80006810:	74e2                	ld	s1,56(sp)
    80006812:	7942                	ld	s2,48(sp)
    80006814:	79a2                	ld	s3,40(sp)
    80006816:	7a02                	ld	s4,32(sp)
    80006818:	6ae2                	ld	s5,24(sp)
    8000681a:	6161                	addi	sp,sp,80
    8000681c:	8082                	ret
  for(i = 0; i < n; i++){
    8000681e:	4901                	li	s2,0
    80006820:	b7ed                	j	8000680a <consolewrite+0x4a>

0000000080006822 <consoleread>:
...
consoleread(int user_dst, uint64 dst, int n)
{
    ...
    80006842:	8aae                	mv	s5,a1
    80006844:	8a32                	mv	s4,a2
  uint target;
  int c;
  char cbuf;

  target = n;
    80006846:	00060b9b          	sext.w	s7,a2
  acquire(&cons.lock);
    8000684a:	00021517          	auipc	a0,0x21
    8000684e:	c3650513          	addi	a0,a0,-970 # 80027480 <cons>
    80006852:	00001097          	auipc	ra,0x1
    80006856:	8f4080e7          	jalr	-1804(ra) # 80007146 <acquire>
  while(n > 0){
    // wait until interrupt handler has put some
    // input into cons.buffer.
    while(cons.r == cons.w){
    8000685a:	00021497          	auipc	s1,0x21
    8000685e:	c2648493          	addi	s1,s1,-986 # 80027480 <cons>
      if(myproc()->killed){
        release(&cons.lock);
        return -1;
      }
      sleep(&cons.r, &cons.lock);
    80006862:	89a6                	mv	s3,s1
    80006864:	00021917          	auipc	s2,0x21
    80006868:	cb490913          	addi	s2,s2,-844 # 80027518 <cons+0x98>
    }

    c = cons.buf[cons.r++ % INPUT_BUF];

    if(c == C('D')){  // end-of-file
    8000686c:	4c91                	li	s9,4
      break;
    }
    ...
    if(c == '\n'){
    80006870:	4da9                	li	s11,10
  while(n > 0){
    80006872:	07405863          	blez	s4,800068e2 <consoleread+0xc0>
    while(cons.r == cons.w){
    80006876:	0984a783          	lw	a5,152(s1)
    8000687a:	09c4a703          	lw	a4,156(s1)
    8000687e:	02f71463          	bne	a4,a5,800068a6 <consoleread+0x84>
      if(myproc()->killed){
    80006882:	ffffa097          	auipc	ra,0xffffa
    80006886:	61e080e7          	jalr	1566(ra) # 80000ea0 <myproc>
    8000688a:	551c                	lw	a5,40(a0)
    8000688c:	e7b5                	bnez	a5,800068f8 <consoleread+0xd6>
      sleep(&cons.r, &cons.lock);
    8000688e:	85ce                	mv	a1,s3
    80006890:	854a                	mv	a0,s2
    80006892:	ffffb097          	auipc	ra,0xffffb
    80006896:	cca080e7          	jalr	-822(ra) # 8000155c <sleep>
    while(cons.r == cons.w){
    8000689a:	0984a783          	lw	a5,152(s1)
    8000689e:	09c4a703          	lw	a4,156(s1)
    800068a2:	fef700e3          	beq	a4,a5,80006882 <consoleread+0x60>
    c = cons.buf[cons.r++ % INPUT_BUF];
    800068a6:	0017871b          	addiw	a4,a5,1
    800068aa:	08e4ac23          	sw	a4,152(s1)
    800068ae:	07f7f713          	andi	a4,a5,127
    800068b2:	9726                	add	a4,a4,s1
    800068b4:	01874703          	lbu	a4,24(a4)
    800068b8:	00070c1b          	sext.w	s8,a4
    if(c == C('D')){  // end-of-file
    800068bc:	079c0663          	beq	s8,s9,80006928 <consoleread+0x106>
    cbuf = c;
    800068c0:	f8e407a3          	sb	a4,-113(s0)
    if(either_copyout(user_dst, dst, &cbuf, 1) == -1)
    800068c4:	4685                	li	a3,1
    800068c6:	f8f40613          	addi	a2,s0,-113
    800068ca:	85d6                	mv	a1,s5
    800068cc:	855a                	mv	a0,s6
    800068ce:	ffffb097          	auipc	ra,0xffffb
    800068d2:	032080e7          	jalr	50(ra) # 80001900 <either_copyout>
    800068d6:	01a50663          	beq	a0,s10,800068e2 <consoleread+0xc0>
    dst++;
    800068da:	0a85                	addi	s5,s5,1
    --n;
    800068dc:	3a7d                	addiw	s4,s4,-1
    if(c == '\n'){
    800068de:	f9bc1ae3          	bne	s8,s11,80006872 <consoleread+0x50>
  ...
  release(&cons.lock);
    800068e2:	00021517          	auipc	a0,0x21
    800068e6:	b9e50513          	addi	a0,a0,-1122 # 80027480 <cons>
    800068ea:	00001097          	auipc	ra,0x1
    800068ee:	910080e7          	jalr	-1776(ra) # 800071fa <release>

  return target - n;
    800068f2:	414b853b          	subw	a0,s7,s4
    800068f6:	a811                	j	8000690a <consoleread+0xe8>
        release(&cons.lock);
    800068f8:	00021517          	auipc	a0,0x21
    800068fc:	b8850513          	addi	a0,a0,-1144 # 80027480 <cons>
    80006900:	00001097          	auipc	ra,0x1
    80006904:	8fa080e7          	jalr	-1798(ra) # 800071fa <release>
        return -1;
    80006908:	557d                	li	a0,-1
}
    ...
    80006926:	8082                	ret
      if(n < target){
    80006928:	000a071b          	sext.w	a4,s4
    8000692c:	fb777be3          	bgeu	a4,s7,800068e2 <consoleread+0xc0>
        cons.r--;
    80006930:	00021717          	auipc	a4,0x21
    80006934:	bef72423          	sw	a5,-1048(a4) # 80027518 <cons+0x98>
    80006938:	b76d                	j	800068e2 <consoleread+0xc0>

000000008000693a <consputc>:
{
    8000693a:	1141                	addi	sp,sp,-16
    8000693c:	e406                	sd	ra,8(sp)
    8000693e:	e022                	sd	s0,0(sp)
    80006940:	0800                	addi	s0,sp,16
  if(c == BACKSPACE){
    80006942:	10000793          	li	a5,256
    80006946:	00f50a63          	beq	a0,a5,8000695a <consputc+0x20>
    uartputc_sync(c);
    8000694a:	00000097          	auipc	ra,0x0
    8000694e:	564080e7          	jalr	1380(ra) # 80006eae <uartputc_sync>
}
    ...
    8000695a:	4521                	li	a0,8
    8000695c:	00000097          	auipc	ra,0x0
    80006960:	552080e7          	jalr	1362(ra) # 80006eae <uartputc_sync>
    80006964:	02000513          	li	a0,32
    80006968:	00000097          	auipc	ra,0x0
    8000696c:	546080e7          	jalr	1350(ra) # 80006eae <uartputc_sync>
    80006970:	4521                	li	a0,8
    80006972:	00000097          	auipc	ra,0x0
    80006976:	53c080e7          	jalr	1340(ra) # 80006eae <uartputc_sync>
    8000697a:	bfe1                	j	80006952 <consputc+0x18>

000000008000697c <consoleintr>:
...
consoleintr(int c)
{
  ...
  acquire(&cons.lock);
    ...
    8000698e:	af650513          	addi	a0,a0,-1290 # 80027480 <cons>
    80006992:	00000097          	auipc	ra,0x0
    80006996:	7b4080e7          	jalr	1972(ra) # 80007146 <acquire>

  switch(c){
    8000699a:	47d5                	li	a5,21
    8000699c:	0af48663          	beq	s1,a5,80006a48 <consoleintr+0xcc>
    800069a0:	0297ca63          	blt	a5,s1,800069d4 <consoleintr+0x58>
    800069a4:	47a1                	li	a5,8
    800069a6:	0ef48763          	beq	s1,a5,80006a94 <consoleintr+0x118>
    800069aa:	47c1                	li	a5,16
    800069ac:	10f49a63          	bne	s1,a5,80006ac0 <consoleintr+0x144>
  case C('P'):  // Print process list.
    procdump();
    800069b0:	ffffb097          	auipc	ra,0xffffb
    800069b4:	ffc080e7          	jalr	-4(ra) # 800019ac <procdump>
      }
    }
    break;
  }
  ...
  release(&cons.lock);
    800069b8:	00021517          	auipc	a0,0x21
    800069bc:	ac850513          	addi	a0,a0,-1336 # 80027480 <cons>
    800069c0:	00001097          	auipc	ra,0x1
    800069c4:	83a080e7          	jalr	-1990(ra) # 800071fa <release>
}
    800069c8:	60e2                	ld	ra,24(sp)
    800069ca:	6442                	ld	s0,16(sp)
    800069cc:	64a2                	ld	s1,8(sp)
    800069ce:	6902                	ld	s2,0(sp)
    800069d0:	6105                	addi	sp,sp,32
    800069d2:	8082                	ret
  switch(c){
    800069d4:	07f00793          	li	a5,127
    800069d8:	0af48e63          	beq	s1,a5,80006a94 <consoleintr+0x118>
    if(c != 0 && cons.e-cons.r < INPUT_BUF){
    800069dc:	00021717          	auipc	a4,0x21
    800069e0:	aa470713          	addi	a4,a4,-1372 # 80027480 <cons>
    800069e4:	0a072783          	lw	a5,160(a4)
    800069e8:	09872703          	lw	a4,152(a4)
    800069ec:	9f99                	subw	a5,a5,a4
    800069ee:	07f00713          	li	a4,127
    800069f2:	fcf763e3          	bltu	a4,a5,800069b8 <consoleintr+0x3c>
      c = (c == '\r') ? '\n' : c;
    800069f6:	47b5                	li	a5,13
    800069f8:	0cf48763          	beq	s1,a5,80006ac6 <consoleintr+0x14a>
      consputc(c);
    800069fc:	8526                	mv	a0,s1
    800069fe:	00000097          	auipc	ra,0x0
    80006a02:	f3c080e7          	jalr	-196(ra) # 8000693a <consputc>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    80006a06:	00021797          	auipc	a5,0x21
    80006a0a:	a7a78793          	addi	a5,a5,-1414 # 80027480 <cons>
    80006a0e:	0a07a703          	lw	a4,160(a5)
    80006a12:	0017069b          	addiw	a3,a4,1
    80006a16:	0006861b          	sext.w	a2,a3
    80006a1a:	0ad7a023          	sw	a3,160(a5)
    80006a1e:	07f77713          	andi	a4,a4,127
    80006a22:	97ba                	add	a5,a5,a4
    80006a24:	00978c23          	sb	s1,24(a5)
      if(c == '\n' || c == C('D') || cons.e == cons.r+INPUT_BUF){
    80006a28:	47a9                	li	a5,10
    80006a2a:	0cf48563          	beq	s1,a5,80006af4 <consoleintr+0x178>
    80006a2e:	4791                	li	a5,4
    80006a30:	0cf48263          	beq	s1,a5,80006af4 <consoleintr+0x178>
    80006a34:	00021797          	auipc	a5,0x21
    80006a38:	ae47a783          	lw	a5,-1308(a5) # 80027518 <cons+0x98>
    80006a3c:	0807879b          	addiw	a5,a5,128
    80006a40:	f6f61ce3          	bne	a2,a5,800069b8 <consoleintr+0x3c>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    80006a44:	863e                	mv	a2,a5
    80006a46:	a07d                	j	80006af4 <consoleintr+0x178>
    while(cons.e != cons.w &&
    80006a48:	00021717          	auipc	a4,0x21
    80006a4c:	a3870713          	addi	a4,a4,-1480 # 80027480 <cons>
    80006a50:	0a072783          	lw	a5,160(a4)
    80006a54:	09c72703          	lw	a4,156(a4)
          cons.buf[(cons.e-1) % INPUT_BUF] != '\n'){
    80006a58:	00021497          	auipc	s1,0x21
    80006a5c:	a2848493          	addi	s1,s1,-1496 # 80027480 <cons>
    while(cons.e != cons.w &&
    80006a60:	4929                	li	s2,10
    80006a62:	f4f70be3          	beq	a4,a5,800069b8 <consoleintr+0x3c>
          cons.buf[(cons.e-1) % INPUT_BUF] != '\n'){
    80006a66:	37fd                	addiw	a5,a5,-1
    80006a68:	07f7f713          	andi	a4,a5,127
    80006a6c:	9726                	add	a4,a4,s1
    while(cons.e != cons.w &&
    80006a6e:	01874703          	lbu	a4,24(a4)
    80006a72:	f52703e3          	beq	a4,s2,800069b8 <consoleintr+0x3c>
      cons.e--;
    80006a76:	0af4a023          	sw	a5,160(s1)
      consputc(BACKSPACE);
    80006a7a:	10000513          	li	a0,256
    80006a7e:	00000097          	auipc	ra,0x0
    80006a82:	ebc080e7          	jalr	-324(ra) # 8000693a <consputc>
    while(cons.e != cons.w &&
    80006a86:	0a04a783          	lw	a5,160(s1)
    80006a8a:	09c4a703          	lw	a4,156(s1)
    80006a8e:	fcf71ce3          	bne	a4,a5,80006a66 <consoleintr+0xea>
    80006a92:	b71d                	j	800069b8 <consoleintr+0x3c>
    if(cons.e != cons.w){
    80006a94:	00021717          	auipc	a4,0x21
    80006a98:	9ec70713          	addi	a4,a4,-1556 # 80027480 <cons>
    80006a9c:	0a072783          	lw	a5,160(a4)
    80006aa0:	09c72703          	lw	a4,156(a4)
    80006aa4:	f0f70ae3          	beq	a4,a5,800069b8 <consoleintr+0x3c>
      cons.e--;
    80006aa8:	37fd                	addiw	a5,a5,-1
    80006aaa:	00021717          	auipc	a4,0x21
    80006aae:	a6f72b23          	sw	a5,-1418(a4) # 80027520 <cons+0xa0>
      consputc(BACKSPACE);
    80006ab2:	10000513          	li	a0,256
    80006ab6:	00000097          	auipc	ra,0x0
    80006aba:	e84080e7          	jalr	-380(ra) # 8000693a <consputc>
    80006abe:	bded                	j	800069b8 <consoleintr+0x3c>
    if(c != 0 && cons.e-cons.r < INPUT_BUF){
    80006ac0:	ee048ce3          	beqz	s1,800069b8 <consoleintr+0x3c>
    80006ac4:	bf21                	j	800069dc <consoleintr+0x60>
      consputc(c);
    80006ac6:	4529                	li	a0,10
    80006ac8:	00000097          	auipc	ra,0x0
    80006acc:	e72080e7          	jalr	-398(ra) # 8000693a <consputc>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    80006ad0:	00021797          	auipc	a5,0x21
    80006ad4:	9b078793          	addi	a5,a5,-1616 # 80027480 <cons>
    80006ad8:	0a07a703          	lw	a4,160(a5)
    80006adc:	0017069b          	addiw	a3,a4,1
    80006ae0:	0006861b          	sext.w	a2,a3
    80006ae4:	0ad7a023          	sw	a3,160(a5)
    80006ae8:	07f77713          	andi	a4,a4,127
    80006aec:	97ba                	add	a5,a5,a4
    80006aee:	4729                	li	a4,10
    80006af0:	00e78c23          	sb	a4,24(a5)
        cons.w = cons.e;
    80006af4:	00021797          	auipc	a5,0x21
    80006af8:	a2c7a423          	sw	a2,-1496(a5) # 8002751c <cons+0x9c>
        wakeup(&cons.r);
    80006afc:	00021517          	auipc	a0,0x21
    80006b00:	a1c50513          	addi	a0,a0,-1508 # 80027518 <cons+0x98>
    80006b04:	ffffb097          	auipc	ra,0xffffb
    80006b08:	be4080e7          	jalr	-1052(ra) # 800016e8 <wakeup>
    80006b0c:	b575                	j	800069b8 <consoleintr+0x3c>

0000000080006b0e <consoleinit>:

void
consoleinit(void)
{
    80006b0e:	1141                	addi	sp,sp,-16
    80006b10:	e406                	sd	ra,8(sp)
    80006b12:	e022                	sd	s0,0(sp)
    80006b14:	0800                	addi	s0,sp,16
  initlock(&cons.lock, "cons");
    80006b16:	00003597          	auipc	a1,0x3
    80006b1a:	d1a58593          	addi	a1,a1,-742 # 80009830 <syscalls+0x458>
    80006b1e:	00021517          	auipc	a0,0x21
    80006b22:	96250513          	addi	a0,a0,-1694 # 80027480 <cons>
    80006b26:	00000097          	auipc	ra,0x0
    80006b2a:	590080e7          	jalr	1424(ra) # 800070b6 <initlock>

  uartinit();
    80006b2e:	00000097          	auipc	ra,0x0
    80006b32:	330080e7          	jalr	816(ra) # 80006e5e <uartinit>

  // connect read and write system calls
  // to consoleread and consolewrite.
  devsw[CONSOLE].read = consoleread;
    80006b36:	00013797          	auipc	a5,0x13
    80006b3a:	5b278793          	addi	a5,a5,1458 # 8001a0e8 <devsw>
    80006b3e:	00000717          	auipc	a4,0x0
    80006b42:	ce470713          	addi	a4,a4,-796 # 80006822 <consoleread>
    80006b46:	eb98                	sd	a4,16(a5)
  devsw[CONSOLE].write = consolewrite;
    80006b48:	00000717          	auipc	a4,0x0
    80006b4c:	c7870713          	addi	a4,a4,-904 # 800067c0 <consolewrite>
    80006b50:	ef98                	sd	a4,24(a5)
}
    80006b52:	60a2                	ld	ra,8(sp)
    80006b54:	6402                	ld	s0,0(sp)
    80006b56:	0141                	addi	sp,sp,16
    80006b58:	8082                	ret

0000000080006b5a <printint>:
...
{
    80006b5a:	7179                	addi	sp,sp,-48
    80006b5c:	f406                	sd	ra,40(sp)
    80006b5e:	f022                	sd	s0,32(sp)
    80006b60:	ec26                	sd	s1,24(sp)
    80006b62:	e84a                	sd	s2,16(sp)
  ...
  if(sign && (sign = xx < 0))
    80006b66:	c219                	beqz	a2,80006b6c <printint+0x12>
    80006b68:	08054663          	bltz	a0,80006bf4 <printint+0x9a>
    x = -xx;
  else
    x = xx;
    80006b6c:	2501                	sext.w	a0,a0
    80006b6e:	4881                	li	a7,0
    80006b70:	fd040693          	addi	a3,s0,-48

  i = 0;
    80006b74:	4701                	li	a4,0
  do {
    buf[i++] = digits[x % base];
    80006b76:	2581                	sext.w	a1,a1
    80006b78:	00003617          	auipc	a2,0x3
    80006b7c:	ce860613          	addi	a2,a2,-792 # 80009860 <digits>
    80006b80:	883a                	mv	a6,a4
    80006b82:	2705                	addiw	a4,a4,1
    80006b84:	02b577bb          	remuw	a5,a0,a1
    80006b88:	1782                	slli	a5,a5,0x20
    80006b8a:	9381                	srli	a5,a5,0x20
    80006b8c:	97b2                	add	a5,a5,a2
    80006b8e:	0007c783          	lbu	a5,0(a5)
    80006b92:	00f68023          	sb	a5,0(a3)
  } while((x /= base) != 0);
    80006b96:	0005079b          	sext.w	a5,a0
    80006b9a:	02b5553b          	divuw	a0,a0,a1
    80006b9e:	0685                	addi	a3,a3,1
    80006ba0:	feb7f0e3          	bgeu	a5,a1,80006b80 <printint+0x26>

  if(sign)
    80006ba4:	00088b63          	beqz	a7,80006bba <printint+0x60>
    buf[i++] = '-';
    80006ba8:	fe040793          	addi	a5,s0,-32
    80006bac:	973e                	add	a4,a4,a5
    80006bae:	02d00793          	li	a5,45
    80006bb2:	fef70823          	sb	a5,-16(a4)
    80006bb6:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    80006bba:	02e05763          	blez	a4,80006be8 <printint+0x8e>
    80006bbe:	fd040793          	addi	a5,s0,-48
    80006bc2:	00e784b3          	add	s1,a5,a4
    80006bc6:	fff78913          	addi	s2,a5,-1
    80006bca:	993a                	add	s2,s2,a4
    80006bcc:	377d                	addiw	a4,a4,-1
    80006bce:	1702                	slli	a4,a4,0x20
    80006bd0:	9301                	srli	a4,a4,0x20
    80006bd2:	40e90933          	sub	s2,s2,a4
    consputc(buf[i]);
    80006bd6:	fff4c503          	lbu	a0,-1(s1)
    80006bda:	00000097          	auipc	ra,0x0
    80006bde:	d60080e7          	jalr	-672(ra) # 8000693a <consputc>
  while(--i >= 0)
    80006be2:	14fd                	addi	s1,s1,-1
    80006be4:	ff2499e3          	bne	s1,s2,80006bd6 <printint+0x7c>
}
    80006be8:	70a2                	ld	ra,40(sp)
    80006bea:	7402                	ld	s0,32(sp)
    80006bec:	64e2                	ld	s1,24(sp)
    80006bee:	6942                	ld	s2,16(sp)
    80006bf0:	6145                	addi	sp,sp,48
    80006bf2:	8082                	ret
    x = -xx;
    80006bf4:	40a0053b          	negw	a0,a0
  if(sign && (sign = xx < 0))
    80006bf8:	4885                	li	a7,1
    x = -xx;
    80006bfa:	bf9d                	j	80006b70 <printint+0x16>

0000000080006bfc <panic>:
    release(&pr.lock);
}
...
panic(char *s)
{
  ...
  pr.locking = 0;
    80006c08:	00021797          	auipc	a5,0x21
    80006c0c:	9207ac23          	sw	zero,-1736(a5) # 80027540 <pr+0x18>
  printf("panic: ");
    80006c10:	00003517          	auipc	a0,0x3
    80006c14:	c2850513          	addi	a0,a0,-984 # 80009838 <syscalls+0x460>
    80006c18:	00000097          	auipc	ra,0x0
    80006c1c:	02e080e7          	jalr	46(ra) # 80006c46 <printf>
  printf(s);
    80006c20:	8526                	mv	a0,s1
    80006c22:	00000097          	auipc	ra,0x0
    80006c26:	024080e7          	jalr	36(ra) # 80006c46 <printf>
  printf("\n");
    80006c2a:	00002517          	auipc	a0,0x2
    80006c2e:	41e50513          	addi	a0,a0,1054 # 80009048 <etext+0x48>
    80006c32:	00000097          	auipc	ra,0x0
    80006c36:	014080e7          	jalr	20(ra) # 80006c46 <printf>
  panicked = 1; // freeze uart output from other CPUs
    80006c3a:	4785                	li	a5,1
    80006c3c:	00003717          	auipc	a4,0x3
    80006c40:	3ef72a23          	sw	a5,1012(a4) # 8000a030 <panicked>
  for(;;)
    80006c44:	a001                	j	80006c44 <panic+0x48>

0000000080006c46 <printf>:
{
    80006c46:	7131                	addi	sp,sp,-192
    80006c48:	fc86                	sd	ra,120(sp)
    80006c4a:	f8a2                	sd	s0,112(sp)
    80006c4c:	f4a6                	sd	s1,104(sp)
    80006c4e:	f0ca                	sd	s2,96(sp)
    80006c50:	ecce                	sd	s3,88(sp)
    80006c52:	e8d2                	sd	s4,80(sp)
    80006c54:	e4d6                	sd	s5,72(sp)
    80006c56:	e0da                	sd	s6,64(sp)
    80006c58:	fc5e                	sd	s7,56(sp)
    80006c5a:	f862                	sd	s8,48(sp)
    80006c5c:	f466                	sd	s9,40(sp)
    80006c5e:	f06a                	sd	s10,32(sp)
    80006c60:	ec6e                	sd	s11,24(sp)
    80006c62:	0100                	addi	s0,sp,128
    80006c64:	8a2a                	mv	s4,a0
    80006c66:	e40c                	sd	a1,8(s0)
    80006c68:	e810                	sd	a2,16(s0)
    80006c6a:	ec14                	sd	a3,24(s0)
    80006c6c:	f018                	sd	a4,32(s0)
    80006c6e:	f41c                	sd	a5,40(s0)
    80006c70:	03043823          	sd	a6,48(s0)
    80006c74:	03143c23          	sd	a7,56(s0)
  locking = pr.locking;
    80006c78:	00021d97          	auipc	s11,0x21
    80006c7c:	8c8dad83          	lw	s11,-1848(s11) # 80027540 <pr+0x18>
  if(locking)
    80006c80:	020d9b63          	bnez	s11,80006cb6 <printf+0x70>
  if (fmt == 0)
    80006c84:	040a0263          	beqz	s4,80006cc8 <printf+0x82>
  va_start(ap, fmt);
    80006c88:	00840793          	addi	a5,s0,8
    80006c8c:	f8f43423          	sd	a5,-120(s0)
  for(i = 0; (c = fmt[i] & 0xff) != 0; i++){
    80006c90:	000a4503          	lbu	a0,0(s4) # 2000 <_entry-0x7fffe000>
    80006c94:	16050263          	beqz	a0,80006df8 <printf+0x1b2>
    80006c98:	4481                	li	s1,0
    if(c != '%'){
    80006c9a:	02500a93          	li	s5,37
    switch(c){
    80006c9e:	07000b13          	li	s6,112
  consputc('x');
    80006ca2:	4d41                	li	s10,16
    consputc(digits[x >> (sizeof(uint64) * 8 - 4)]);
    80006ca4:	00003b97          	auipc	s7,0x3
    80006ca8:	bbcb8b93          	addi	s7,s7,-1092 # 80009860 <digits>
    switch(c){
    80006cac:	07300c93          	li	s9,115
    80006cb0:	06400c13          	li	s8,100
    80006cb4:	a82d                	j	80006cee <printf+0xa8>
    acquire(&pr.lock);
    80006cb6:	00021517          	auipc	a0,0x21
    80006cba:	87250513          	addi	a0,a0,-1934 # 80027528 <pr>
    80006cbe:	00000097          	auipc	ra,0x0
    80006cc2:	488080e7          	jalr	1160(ra) # 80007146 <acquire>
    80006cc6:	bf7d                	j	80006c84 <printf+0x3e>
    panic("null fmt");
    80006cc8:	00003517          	auipc	a0,0x3
    80006ccc:	b8050513          	addi	a0,a0,-1152 # 80009848 <syscalls+0x470>
    80006cd0:	00000097          	auipc	ra,0x0
    80006cd4:	f2c080e7          	jalr	-212(ra) # 80006bfc <panic>
      consputc(c);
    80006cd8:	00000097          	auipc	ra,0x0
    80006cdc:	c62080e7          	jalr	-926(ra) # 8000693a <consputc>
  for(i = 0; (c = fmt[i] & 0xff) != 0; i++){
    80006ce0:	2485                	addiw	s1,s1,1
    80006ce2:	009a07b3          	add	a5,s4,s1
    80006ce6:	0007c503          	lbu	a0,0(a5)
    80006cea:	10050763          	beqz	a0,80006df8 <printf+0x1b2>
    if(c != '%'){
    80006cee:	ff5515e3          	bne	a0,s5,80006cd8 <printf+0x92>
    c = fmt[++i] & 0xff;
    80006cf2:	2485                	addiw	s1,s1,1
    80006cf4:	009a07b3          	add	a5,s4,s1
    80006cf8:	0007c783          	lbu	a5,0(a5)
    80006cfc:	0007891b          	sext.w	s2,a5
    if(c == 0)
    80006d00:	cfe5                	beqz	a5,80006df8 <printf+0x1b2>
    switch(c){
    80006d02:	05678a63          	beq	a5,s6,80006d56 <printf+0x110>
    80006d06:	02fb7663          	bgeu	s6,a5,80006d32 <printf+0xec>
    80006d0a:	09978963          	beq	a5,s9,80006d9c <printf+0x156>
    80006d0e:	07800713          	li	a4,120
    80006d12:	0ce79863          	bne	a5,a4,80006de2 <printf+0x19c>
      printint(va_arg(ap, int), 16, 1);
    80006d16:	f8843783          	ld	a5,-120(s0)
    80006d1a:	00878713          	addi	a4,a5,8
    80006d1e:	f8e43423          	sd	a4,-120(s0)
    80006d22:	4605                	li	a2,1
    80006d24:	85ea                	mv	a1,s10
    80006d26:	4388                	lw	a0,0(a5)
    80006d28:	00000097          	auipc	ra,0x0
    80006d2c:	e32080e7          	jalr	-462(ra) # 80006b5a <printint>
      break;
    80006d30:	bf45                	j	80006ce0 <printf+0x9a>
    switch(c){
    80006d32:	0b578263          	beq	a5,s5,80006dd6 <printf+0x190>
    80006d36:	0b879663          	bne	a5,s8,80006de2 <printf+0x19c>
      printint(va_arg(ap, int), 10, 1);
    80006d3a:	f8843783          	ld	a5,-120(s0)
    80006d3e:	00878713          	addi	a4,a5,8
    80006d42:	f8e43423          	sd	a4,-120(s0)
    80006d46:	4605                	li	a2,1
    80006d48:	45a9                	li	a1,10
    80006d4a:	4388                	lw	a0,0(a5)
    80006d4c:	00000097          	auipc	ra,0x0
    80006d50:	e0e080e7          	jalr	-498(ra) # 80006b5a <printint>
      break;
    80006d54:	b771                	j	80006ce0 <printf+0x9a>
      printptr(va_arg(ap, uint64));
    80006d56:	f8843783          	ld	a5,-120(s0)
    80006d5a:	00878713          	addi	a4,a5,8
    80006d5e:	f8e43423          	sd	a4,-120(s0)
    80006d62:	0007b983          	ld	s3,0(a5)
  consputc('0');
    80006d66:	03000513          	li	a0,48
    80006d6a:	00000097          	auipc	ra,0x0
    80006d6e:	bd0080e7          	jalr	-1072(ra) # 8000693a <consputc>
  consputc('x');
    80006d72:	07800513          	li	a0,120
    80006d76:	00000097          	auipc	ra,0x0
    80006d7a:	bc4080e7          	jalr	-1084(ra) # 8000693a <consputc>
    80006d7e:	896a                	mv	s2,s10
    consputc(digits[x >> (sizeof(uint64) * 8 - 4)]);
    80006d80:	03c9d793          	srli	a5,s3,0x3c
    80006d84:	97de                	add	a5,a5,s7
    80006d86:	0007c503          	lbu	a0,0(a5)
    80006d8a:	00000097          	auipc	ra,0x0
    80006d8e:	bb0080e7          	jalr	-1104(ra) # 8000693a <consputc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    80006d92:	0992                	slli	s3,s3,0x4
    80006d94:	397d                	addiw	s2,s2,-1
    80006d96:	fe0915e3          	bnez	s2,80006d80 <printf+0x13a>
    80006d9a:	b799                	j	80006ce0 <printf+0x9a>
      if((s = va_arg(ap, char*)) == 0)
    80006d9c:	f8843783          	ld	a5,-120(s0)
    80006da0:	00878713          	addi	a4,a5,8
    80006da4:	f8e43423          	sd	a4,-120(s0)
    80006da8:	0007b903          	ld	s2,0(a5)
    80006dac:	00090e63          	beqz	s2,80006dc8 <printf+0x182>
      for(; *s; s++)
    80006db0:	00094503          	lbu	a0,0(s2)
    80006db4:	d515                	beqz	a0,80006ce0 <printf+0x9a>
        consputc(*s);
    80006db6:	00000097          	auipc	ra,0x0
    80006dba:	b84080e7          	jalr	-1148(ra) # 8000693a <consputc>
      for(; *s; s++)
    80006dbe:	0905                	addi	s2,s2,1
    80006dc0:	00094503          	lbu	a0,0(s2)
    80006dc4:	f96d                	bnez	a0,80006db6 <printf+0x170>
    80006dc6:	bf29                	j	80006ce0 <printf+0x9a>
        s = "(null)";
    80006dc8:	00003917          	auipc	s2,0x3
    80006dcc:	a7890913          	addi	s2,s2,-1416 # 80009840 <syscalls+0x468>
      for(; *s; s++)
    80006dd0:	02800513          	li	a0,40
    80006dd4:	b7cd                	j	80006db6 <printf+0x170>
      consputc('%');
    80006dd6:	8556                	mv	a0,s5
    80006dd8:	00000097          	auipc	ra,0x0
    80006ddc:	b62080e7          	jalr	-1182(ra) # 8000693a <consputc>
      break;
    80006de0:	b701                	j	80006ce0 <printf+0x9a>
      consputc('%');
    80006de2:	8556                	mv	a0,s5
    80006de4:	00000097          	auipc	ra,0x0
    80006de8:	b56080e7          	jalr	-1194(ra) # 8000693a <consputc>
      consputc(c);
    80006dec:	854a                	mv	a0,s2
    80006dee:	00000097          	auipc	ra,0x0
    80006df2:	b4c080e7          	jalr	-1204(ra) # 8000693a <consputc>
      break;
    80006df6:	b5ed                	j	80006ce0 <printf+0x9a>
  if(locking)
    80006df8:	020d9163          	bnez	s11,80006e1a <printf+0x1d4>
}
    80006dfc:	70e6                	ld	ra,120(sp)
    80006dfe:	7446                	ld	s0,112(sp)
    80006e00:	74a6                	ld	s1,104(sp)
    80006e02:	7906                	ld	s2,96(sp)
    80006e04:	69e6                	ld	s3,88(sp)
    80006e06:	6a46                	ld	s4,80(sp)
    80006e08:	6aa6                	ld	s5,72(sp)
    80006e0a:	6b06                	ld	s6,64(sp)
    80006e0c:	7be2                	ld	s7,56(sp)
    80006e0e:	7c42                	ld	s8,48(sp)
    80006e10:	7ca2                	ld	s9,40(sp)
    80006e12:	7d02                	ld	s10,32(sp)
    80006e14:	6de2                	ld	s11,24(sp)
    80006e16:	6129                	addi	sp,sp,192
    80006e18:	8082                	ret
    release(&pr.lock);
    80006e1a:	00020517          	auipc	a0,0x20
    80006e1e:	70e50513          	addi	a0,a0,1806 # 80027528 <pr>
    80006e22:	00000097          	auipc	ra,0x0
    80006e26:	3d8080e7          	jalr	984(ra) # 800071fa <release>
}
    80006e2a:	bfc9                	j	80006dfc <printf+0x1b6>

0000000080006e2c <printfinit>:
    ;
}
...
printfinit(void)
{
    80006e2c:	1101                	addi	sp,sp,-32
    80006e2e:	ec06                	sd	ra,24(sp)
    80006e30:	e822                	sd	s0,16(sp)
    80006e32:	e426                	sd	s1,8(sp)
    80006e34:	1000                	addi	s0,sp,32
  initlock(&pr.lock, "pr");
    80006e36:	00020497          	auipc	s1,0x20
    80006e3a:	6f248493          	addi	s1,s1,1778 # 80027528 <pr>
    80006e3e:	00003597          	auipc	a1,0x3
    80006e42:	a1a58593          	addi	a1,a1,-1510 # 80009858 <syscalls+0x480>
    80006e46:	8526                	mv	a0,s1
    80006e48:	00000097          	auipc	ra,0x0
    80006e4c:	26e080e7          	jalr	622(ra) # 800070b6 <initlock>
  pr.locking = 1;
    80006e50:	4785                	li	a5,1
    80006e52:	cc9c                	sw	a5,24(s1)
}
...
uartinit(void)
{
    ...
    80006e60:	e406                	sd	ra,8(sp)
    80006e62:	e022                	sd	s0,0(sp)
    80006e64:	0800                	addi	s0,sp,16
  // disable interrupts.
  WriteReg(IER, 0x00);
    80006e66:	100007b7          	lui	a5,0x10000
    80006e6a:	000780a3          	sb	zero,1(a5) # 10000001 <_entry-0x6fffffff>

  // special mode to set baud rate.
  WriteReg(LCR, LCR_BAUD_LATCH);
    80006e6e:	f8000713          	li	a4,-128
    80006e72:	00e781a3          	sb	a4,3(a5)

  // LSB for baud rate of 38.4K.
  WriteReg(0, 0x03);
    80006e76:	470d                	li	a4,3
    80006e78:	00e78023          	sb	a4,0(a5)

  // MSB for baud rate of 38.4K.
  WriteReg(1, 0x00);
    80006e7c:	000780a3          	sb	zero,1(a5)

  // leave set-baud mode,
  // and set word length to 8 bits, no parity.
  WriteReg(LCR, LCR_EIGHT_BITS);
    80006e80:	00e781a3          	sb	a4,3(a5)

  // reset and enable FIFOs.
  WriteReg(FCR, FCR_FIFO_ENABLE | FCR_FIFO_CLEAR);
    80006e84:	469d                	li	a3,7
    80006e86:	00d78123          	sb	a3,2(a5)

  // enable transmit and receive interrupts.
  WriteReg(IER, IER_TX_ENABLE | IER_RX_ENABLE);
    80006e8a:	00e780a3          	sb	a4,1(a5)

  initlock(&uart_tx_lock, "uart");
    80006e8e:	00003597          	auipc	a1,0x3
    80006e92:	9ea58593          	addi	a1,a1,-1558 # 80009878 <digits+0x18>
    80006e96:	00020517          	auipc	a0,0x20
    80006e9a:	6b250513          	addi	a0,a0,1714 # 80027548 <uart_tx_lock>
    80006e9e:	00000097          	auipc	ra,0x0
    80006ea2:	218080e7          	jalr	536(ra) # 800070b6 <initlock>
}
    80006ea6:	60a2                	ld	ra,8(sp)
    80006ea8:	6402                	ld	s0,0(sp)
    80006eaa:	0141                	addi	sp,sp,16
    80006eac:	8082                	ret

0000000080006eae <uartputc_sync>:
...
uartputc_sync(int c)
{
    ...
    80006eb6:	1000                	addi	s0,sp,32
    80006eb8:	84aa                	mv	s1,a0
  push_off();
    80006eba:	00000097          	auipc	ra,0x0
    80006ebe:	240080e7          	jalr	576(ra) # 800070fa <push_off>

  if(panicked){
    80006ec2:	00003797          	auipc	a5,0x3
    80006ec6:	16e7a783          	lw	a5,366(a5) # 8000a030 <panicked>
    for(;;)
      ;
  }
  ...
  while((ReadReg(LSR) & LSR_TX_IDLE) == 0)
    80006eca:	10000737          	lui	a4,0x10000
  if(panicked){
    80006ece:	c391                	beqz	a5,80006ed2 <uartputc_sync+0x24>
    for(;;)
    80006ed0:	a001                	j	80006ed0 <uartputc_sync+0x22>
  while((ReadReg(LSR) & LSR_TX_IDLE) == 0)
    80006ed2:	00574783          	lbu	a5,5(a4) # 10000005 <_entry-0x6ffffffb>
    80006ed6:	0ff7f793          	andi	a5,a5,255
    80006eda:	0207f793          	andi	a5,a5,32
    80006ede:	dbf5                	beqz	a5,80006ed2 <uartputc_sync+0x24>
    ;
  WriteReg(THR, c);
    80006ee0:	0ff4f793          	andi	a5,s1,255
    80006ee4:	10000737          	lui	a4,0x10000
    80006ee8:	00f70023          	sb	a5,0(a4) # 10000000 <_entry-0x70000000>

  pop_off();
    80006eec:	00000097          	auipc	ra,0x0
    80006ef0:	2ae080e7          	jalr	686(ra) # 8000719a <pop_off>
}
    80006ef4:	60e2                	ld	ra,24(sp)
    80006ef6:	6442                	ld	s0,16(sp)
    80006ef8:	64a2                	ld	s1,8(sp)
    80006efa:	6105                	addi	sp,sp,32
    80006efc:	8082                	ret

0000000080006efe <uartstart>:
...
uartstart()
{
  while(1){
    ...
    80006efe:	00003717          	auipc	a4,0x3
    80006f02:	13a73703          	ld	a4,314(a4) # 8000a038 <uart_tx_r>
    80006f06:	00003797          	auipc	a5,0x3
    80006f0a:	13a7b783          	ld	a5,314(a5) # 8000a040 <uart_tx_w>
    80006f0e:	06e78c63          	beq	a5,a4,80006f86 <uartstart+0x88>
{
    80006f12:	7139                	addi	sp,sp,-64
    80006f14:	fc06                	sd	ra,56(sp)
    80006f16:	f822                	sd	s0,48(sp)
    80006f18:	f426                	sd	s1,40(sp)
    80006f1a:	f04a                	sd	s2,32(sp)
    80006f1c:	ec4e                	sd	s3,24(sp)
    80006f1e:	e852                	sd	s4,16(sp)
    80006f20:	e456                	sd	s5,8(sp)
    80006f22:	0080                	addi	s0,sp,64
      // transmit buffer is empty.
      return;
    }
    
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
    80006f24:	10000937          	lui	s2,0x10000
    ...
    80006f28:	00020a17          	auipc	s4,0x20
    80006f2c:	620a0a13          	addi	s4,s4,1568 # 80027548 <uart_tx_lock>
    uart_tx_r += 1;
    80006f30:	00003497          	auipc	s1,0x3
    80006f34:	10848493          	addi	s1,s1,264 # 8000a038 <uart_tx_r>
    if(uart_tx_w == uart_tx_r){
    80006f38:	00003997          	auipc	s3,0x3
    80006f3c:	10898993          	addi	s3,s3,264 # 8000a040 <uart_tx_w>
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
    80006f40:	00594783          	lbu	a5,5(s2) # 10000005 <_entry-0x6ffffffb>
    80006f44:	0ff7f793          	andi	a5,a5,255
    80006f48:	0207f793          	andi	a5,a5,32
    80006f4c:	c785                	beqz	a5,80006f74 <uartstart+0x76>
    int c = uart_tx_buf[uart_tx_r % UART_TX_BUF_SIZE];
    80006f4e:	01f77793          	andi	a5,a4,31
    80006f52:	97d2                	add	a5,a5,s4
    80006f54:	0187ca83          	lbu	s5,24(a5)
    uart_tx_r += 1;
    80006f58:	0705                	addi	a4,a4,1
    80006f5a:	e098                	sd	a4,0(s1)
    
    // maybe uartputc() is waiting for space in the buffer.
    wakeup(&uart_tx_r);
    80006f5c:	8526                	mv	a0,s1
    80006f5e:	ffffa097          	auipc	ra,0xffffa
    80006f62:	78a080e7          	jalr	1930(ra) # 800016e8 <wakeup>
    
    WriteReg(THR, c);
    80006f66:	01590023          	sb	s5,0(s2)
    if(uart_tx_w == uart_tx_r){
    80006f6a:	6098                	ld	a4,0(s1)
    80006f6c:	0009b783          	ld	a5,0(s3)
    80006f70:	fce798e3          	bne	a5,a4,80006f40 <uartstart+0x42>
  }
}
    80006f74:	70e2                	ld	ra,56(sp)
    80006f76:	7442                	ld	s0,48(sp)
    80006f78:	74a2                	ld	s1,40(sp)
    80006f7a:	7902                	ld	s2,32(sp)
    80006f7c:	69e2                	ld	s3,24(sp)
    80006f7e:	6a42                	ld	s4,16(sp)
    80006f80:	6aa2                	ld	s5,8(sp)
    80006f82:	6121                	addi	sp,sp,64
    80006f84:	8082                	ret
    80006f86:	8082                	ret

0000000080006f88 <uartputc>:
{
    80006f88:	7179                	addi	sp,sp,-48
    80006f8a:	f406                	sd	ra,40(sp)
    80006f8c:	f022                	sd	s0,32(sp)
    80006f8e:	ec26                	sd	s1,24(sp)
    80006f90:	e84a                	sd	s2,16(sp)
    80006f92:	e44e                	sd	s3,8(sp)
    80006f94:	e052                	sd	s4,0(sp)
    80006f96:	1800                	addi	s0,sp,48
    80006f98:	89aa                	mv	s3,a0
  acquire(&uart_tx_lock);
    80006f9a:	00020517          	auipc	a0,0x20
    80006f9e:	5ae50513          	addi	a0,a0,1454 # 80027548 <uart_tx_lock>
    80006fa2:	00000097          	auipc	ra,0x0
    80006fa6:	1a4080e7          	jalr	420(ra) # 80007146 <acquire>
  if(panicked){
    80006faa:	00003797          	auipc	a5,0x3
    80006fae:	0867a783          	lw	a5,134(a5) # 8000a030 <panicked>
    80006fb2:	c391                	beqz	a5,80006fb6 <uartputc+0x2e>
    for(;;)
    80006fb4:	a001                	j	80006fb4 <uartputc+0x2c>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80006fb6:	00003797          	auipc	a5,0x3
    80006fba:	08a7b783          	ld	a5,138(a5) # 8000a040 <uart_tx_w>
    80006fbe:	00003717          	auipc	a4,0x3
    80006fc2:	07a73703          	ld	a4,122(a4) # 8000a038 <uart_tx_r>
    80006fc6:	02070713          	addi	a4,a4,32
    80006fca:	02f71b63          	bne	a4,a5,80007000 <uartputc+0x78>
      sleep(&uart_tx_r, &uart_tx_lock);
    80006fce:	00020a17          	auipc	s4,0x20
    80006fd2:	57aa0a13          	addi	s4,s4,1402 # 80027548 <uart_tx_lock>
    80006fd6:	00003497          	auipc	s1,0x3
    80006fda:	06248493          	addi	s1,s1,98 # 8000a038 <uart_tx_r>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80006fde:	00003917          	auipc	s2,0x3
    80006fe2:	06290913          	addi	s2,s2,98 # 8000a040 <uart_tx_w>
      sleep(&uart_tx_r, &uart_tx_lock);
    80006fe6:	85d2                	mv	a1,s4
    80006fe8:	8526                	mv	a0,s1
    80006fea:	ffffa097          	auipc	ra,0xffffa
    80006fee:	572080e7          	jalr	1394(ra) # 8000155c <sleep>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80006ff2:	00093783          	ld	a5,0(s2)
    80006ff6:	6098                	ld	a4,0(s1)
    80006ff8:	02070713          	addi	a4,a4,32
    80006ffc:	fef705e3          	beq	a4,a5,80006fe6 <uartputc+0x5e>
      uart_tx_buf[uart_tx_w % UART_TX_BUF_SIZE] = c;
    80007000:	00020497          	auipc	s1,0x20
    80007004:	54848493          	addi	s1,s1,1352 # 80027548 <uart_tx_lock>
    80007008:	01f7f713          	andi	a4,a5,31
    8000700c:	9726                	add	a4,a4,s1
    8000700e:	01370c23          	sb	s3,24(a4)
      uart_tx_w += 1;
    80007012:	0785                	addi	a5,a5,1
    80007014:	00003717          	auipc	a4,0x3
    80007018:	02f73623          	sd	a5,44(a4) # 8000a040 <uart_tx_w>
      uartstart();
    8000701c:	00000097          	auipc	ra,0x0
    80007020:	ee2080e7          	jalr	-286(ra) # 80006efe <uartstart>
      release(&uart_tx_lock);
    80007024:	8526                	mv	a0,s1
    80007026:	00000097          	auipc	ra,0x0
    8000702a:	1d4080e7          	jalr	468(ra) # 800071fa <release>
}
    8000702e:	70a2                	ld	ra,40(sp)
    80007030:	7402                	ld	s0,32(sp)
    80007032:	64e2                	ld	s1,24(sp)
    80007034:	6942                	ld	s2,16(sp)
    80007036:	69a2                	ld	s3,8(sp)
    80007038:	6a02                	ld	s4,0(sp)
    8000703a:	6145                	addi	sp,sp,48
    8000703c:	8082                	ret

000000008000703e <uartgetc>:
...
uartgetc(void)
{
    8000703e:	1141                	addi	sp,sp,-16
    80007040:	e422                	sd	s0,8(sp)
    80007042:	0800                	addi	s0,sp,16
  if(ReadReg(LSR) & 0x01){
    80007044:	100007b7          	lui	a5,0x10000
    80007048:	0057c783          	lbu	a5,5(a5) # 10000005 <_entry-0x6ffffffb>
    8000704c:	8b85                	andi	a5,a5,1
    8000704e:	cb91                	beqz	a5,80007062 <uartgetc+0x24>
    // input data is ready.
    return ReadReg(RHR);
    80007050:	100007b7          	lui	a5,0x10000
    80007054:	0007c503          	lbu	a0,0(a5) # 10000000 <_entry-0x70000000>
    80007058:	0ff57513          	andi	a0,a0,255
  } else {
    return -1;
  }
}
    ...
    80007060:	8082                	ret
    return -1;
    80007062:	557d                	li	a0,-1
    80007064:	bfe5                	j	8000705c <uartgetc+0x1e>

0000000080007066 <uartintr>:
...
uartintr(void)
{
    80007066:	1101                	addi	sp,sp,-32
    80007068:	ec06                	sd	ra,24(sp)
    8000706a:	e822                	sd	s0,16(sp)
    8000706c:	e426                	sd	s1,8(sp)
    8000706e:	1000                	addi	s0,sp,32
  // read and process incoming characters.
  while(1){
    int c = uartgetc();
    if(c == -1)
    80007070:	54fd                	li	s1,-1
    int c = uartgetc();
    80007072:	00000097          	auipc	ra,0x0
    80007076:	fcc080e7          	jalr	-52(ra) # 8000703e <uartgetc>
    if(c == -1)
    8000707a:	00950763          	beq	a0,s1,80007088 <uartintr+0x22>
      break;
    consoleintr(c);
    8000707e:	00000097          	auipc	ra,0x0
    80007082:	8fe080e7          	jalr	-1794(ra) # 8000697c <consoleintr>
  while(1){
    80007086:	b7f5                	j	80007072 <uartintr+0xc>
  }

  // send buffered characters.
  acquire(&uart_tx_lock);
    80007088:	00020497          	auipc	s1,0x20
    8000708c:	4c048493          	addi	s1,s1,1216 # 80027548 <uart_tx_lock>
    80007090:	8526                	mv	a0,s1
    80007092:	00000097          	auipc	ra,0x0
    80007096:	0b4080e7          	jalr	180(ra) # 80007146 <acquire>
  uartstart();
    8000709a:	00000097          	auipc	ra,0x0
    8000709e:	e64080e7          	jalr	-412(ra) # 80006efe <uartstart>
  release(&uart_tx_lock);
    800070a2:	8526                	mv	a0,s1
    800070a4:	00000097          	auipc	ra,0x0
    800070a8:	156080e7          	jalr	342(ra) # 800071fa <release>
}
    800070ac:	60e2                	ld	ra,24(sp)
    800070ae:	6442                	ld	s0,16(sp)
    800070b0:	64a2                	ld	s1,8(sp)
    800070b2:	6105                	addi	sp,sp,32
    800070b4:	8082                	ret

00000000800070b6 <initlock>:
}
#endif
...
{
    800070b6:	1141                	addi	sp,sp,-16
    800070b8:	e422                	sd	s0,8(sp)
    800070ba:	0800                	addi	s0,sp,16
  lk->name = name;
    800070bc:	e50c                	sd	a1,8(a0)
  lk->locked = 0;
    800070be:	00052023          	sw	zero,0(a0)
  lk->cpu = 0;
    800070c2:	00053823          	sd	zero,16(a0)
#ifdef LAB_LOCK
  lk->nts = 0;
  lk->n = 0;
  findslot(lk);
    ...
    800070c6:	6422                	ld	s0,8(sp)
    800070c8:	0141                	addi	sp,sp,16
    800070ca:	8082                	ret

00000000800070cc <holding>:
...
holding(struct spinlock *lk)
{
  ...
  r = (lk->locked && lk->cpu == mycpu());
    800070cc:	411c                	lw	a5,0(a0)
    800070ce:	e399                	bnez	a5,800070d4 <holding+0x8>
    800070d0:	4501                	li	a0,0
  return r;
}
    800070d2:	8082                	ret
{
    800070d4:	1101                	addi	sp,sp,-32
    800070d6:	ec06                	sd	ra,24(sp)
    800070d8:	e822                	sd	s0,16(sp)
    800070da:	e426                	sd	s1,8(sp)
    800070dc:	1000                	addi	s0,sp,32
  r = (lk->locked && lk->cpu == mycpu());
    800070de:	6904                	ld	s1,16(a0)
    800070e0:	ffffa097          	auipc	ra,0xffffa
    800070e4:	da4080e7          	jalr	-604(ra) # 80000e84 <mycpu>
    800070e8:	40a48533          	sub	a0,s1,a0
    800070ec:	00153513          	seqz	a0,a0
}
    800070f0:	60e2                	ld	ra,24(sp)
    800070f2:	6442                	ld	s0,16(sp)
    800070f4:	64a2                	ld	s1,8(sp)
    800070f6:	6105                	addi	sp,sp,32
    800070f8:	8082                	ret

00000000800070fa <push_off>:
...
push_off(void)
{
    800070fa:	1101                	addi	sp,sp,-32
    800070fc:	ec06                	sd	ra,24(sp)
    800070fe:	e822                	sd	s0,16(sp)
    80007100:	e426                	sd	s1,8(sp)
    80007102:	1000                	addi	s0,sp,32
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    80007104:	100024f3          	csrr	s1,sstatus
    80007108:	100027f3          	csrr	a5,sstatus
  w_sstatus(r_sstatus() & ~SSTATUS_SIE);
    8000710c:	9bf5                	andi	a5,a5,-3
  asm volatile("csrw sstatus, %0" : : "r" (x));
    8000710e:	10079073          	csrw	sstatus,a5
  int old = intr_get();

  intr_off();
  if(mycpu()->noff == 0)
    80007112:	ffffa097          	auipc	ra,0xffffa
    80007116:	d72080e7          	jalr	-654(ra) # 80000e84 <mycpu>
    8000711a:	5d3c                	lw	a5,120(a0)
    8000711c:	cf89                	beqz	a5,80007136 <push_off+0x3c>
    mycpu()->intena = old;
  mycpu()->noff += 1;
    8000711e:	ffffa097          	auipc	ra,0xffffa
    80007122:	d66080e7          	jalr	-666(ra) # 80000e84 <mycpu>
    80007126:	5d3c                	lw	a5,120(a0)
    80007128:	2785                	addiw	a5,a5,1
    8000712a:	dd3c                	sw	a5,120(a0)
}
  ...
  return (x & SSTATUS_SIE) != 0;
    8000713e:	8085                	srli	s1,s1,0x1
    80007140:	8885                	andi	s1,s1,1
    80007142:	dd64                	sw	s1,124(a0)
    80007144:	bfe9                	j	8000711e <push_off+0x24>

0000000080007146 <acquire>:
{
    80007146:	1101                	addi	sp,sp,-32
    80007148:	ec06                	sd	ra,24(sp)
    8000714a:	e822                	sd	s0,16(sp)
    8000714c:	e426                	sd	s1,8(sp)
    8000714e:	1000                	addi	s0,sp,32
    80007150:	84aa                	mv	s1,a0
  push_off(); // disable interrupts to avoid deadlock.
    80007152:	00000097          	auipc	ra,0x0
    80007156:	fa8080e7          	jalr	-88(ra) # 800070fa <push_off>
  if(holding(lk))
    8000715a:	8526                	mv	a0,s1
    8000715c:	00000097          	auipc	ra,0x0
    80007160:	f70080e7          	jalr	-144(ra) # 800070cc <holding>
  while(__sync_lock_test_and_set(&lk->locked, 1) != 0) {
    80007164:	4705                	li	a4,1
  if(holding(lk))
    80007166:	e115                	bnez	a0,8000718a <acquire+0x44>
  while(__sync_lock_test_and_set(&lk->locked, 1) != 0) {
    80007168:	87ba                	mv	a5,a4
    8000716a:	0cf4a7af          	amoswap.w.aq	a5,a5,(s1)
    8000716e:	2781                	sext.w	a5,a5
    80007170:	ffe5                	bnez	a5,80007168 <acquire+0x22>
  __sync_synchronize();
    80007172:	0ff0000f          	fence
  lk->cpu = mycpu();
    80007176:	ffffa097          	auipc	ra,0xffffa
    8000717a:	d0e080e7          	jalr	-754(ra) # 80000e84 <mycpu>
    8000717e:	e888                	sd	a0,16(s1)
}
    80007180:	60e2                	ld	ra,24(sp)
    80007182:	6442                	ld	s0,16(sp)
    80007184:	64a2                	ld	s1,8(sp)
    80007186:	6105                	addi	sp,sp,32
    80007188:	8082                	ret
    panic("acquire");
    8000718a:	00002517          	auipc	a0,0x2
    8000718e:	6f650513          	addi	a0,a0,1782 # 80009880 <digits+0x20>
    80007192:	00000097          	auipc	ra,0x0
    80007196:	a6a080e7          	jalr	-1430(ra) # 80006bfc <panic>

000000008000719a <pop_off>:
...
pop_off(void)
{
  ...
  struct cpu *c = mycpu();
    800071a2:	ffffa097          	auipc	ra,0xffffa
    800071a6:	ce2080e7          	jalr	-798(ra) # 80000e84 <mycpu>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    800071aa:	100027f3          	csrr	a5,sstatus
  return (x & SSTATUS_SIE) != 0;
    800071ae:	8b89                	andi	a5,a5,2
  if(intr_get())
    800071b0:	e78d                	bnez	a5,800071da <pop_off+0x40>
    panic("pop_off - interruptible");
  if(c->noff < 1)
    800071b2:	5d3c                	lw	a5,120(a0)
    800071b4:	02f05b63          	blez	a5,800071ea <pop_off+0x50>
    panic("pop_off");
  c->noff -= 1;
    800071b8:	37fd                	addiw	a5,a5,-1
    800071ba:	0007871b          	sext.w	a4,a5
    800071be:	dd3c                	sw	a5,120(a0)
  if(c->noff == 0 && c->intena)
    800071c0:	eb09                	bnez	a4,800071d2 <pop_off+0x38>
    800071c2:	5d7c                	lw	a5,124(a0)
    800071c4:	c799                	beqz	a5,800071d2 <pop_off+0x38>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    800071c6:	100027f3          	csrr	a5,sstatus
  w_sstatus(r_sstatus() | SSTATUS_SIE);
    800071ca:	0027e793          	ori	a5,a5,2
  asm volatile("csrw sstatus, %0" : : "r" (x));
    800071ce:	10079073          	csrw	sstatus,a5
    intr_on();
}
    800071d2:	60a2                	ld	ra,8(sp)
    800071d4:	6402                	ld	s0,0(sp)
    800071d6:	0141                	addi	sp,sp,16
    800071d8:	8082                	ret
    panic("pop_off - interruptible");
    800071da:	00002517          	auipc	a0,0x2
    800071de:	6ae50513          	addi	a0,a0,1710 # 80009888 <digits+0x28>
    800071e2:	00000097          	auipc	ra,0x0
    800071e6:	a1a080e7          	jalr	-1510(ra) # 80006bfc <panic>
    panic("pop_off");
    800071ea:	00002517          	auipc	a0,0x2
    800071ee:	6b650513          	addi	a0,a0,1718 # 800098a0 <digits+0x40>
    800071f2:	00000097          	auipc	ra,0x0
    800071f6:	a0a080e7          	jalr	-1526(ra) # 80006bfc <panic>

00000000800071fa <release>:
{
    800071fa:	1101                	addi	sp,sp,-32
    800071fc:	ec06                	sd	ra,24(sp)
    800071fe:	e822                	sd	s0,16(sp)
    80007200:	e426                	sd	s1,8(sp)
    80007202:	1000                	addi	s0,sp,32
    80007204:	84aa                	mv	s1,a0
  if(!holding(lk))
    80007206:	00000097          	auipc	ra,0x0
    8000720a:	ec6080e7          	jalr	-314(ra) # 800070cc <holding>
    8000720e:	c115                	beqz	a0,80007232 <release+0x38>
  lk->cpu = 0;
    80007210:	0004b823          	sd	zero,16(s1)
  __sync_synchronize();
    80007214:	0ff0000f          	fence
  __sync_lock_release(&lk->locked);
    80007218:	0f50000f          	fence	iorw,ow
    8000721c:	0804a02f          	amoswap.w	zero,zero,(s1)
  pop_off();
    80007220:	00000097          	auipc	ra,0x0
    80007224:	f7a080e7          	jalr	-134(ra) # 8000719a <pop_off>
}
    80007228:	60e2                	ld	ra,24(sp)
    8000722a:	6442                	ld	s0,16(sp)
    8000722c:	64a2                	ld	s1,8(sp)
    8000722e:	6105                	addi	sp,sp,32
    80007230:	8082                	ret
    panic("release");
    80007232:	00002517          	auipc	a0,0x2
    80007236:	67650513          	addi	a0,a0,1654 # 800098a8 <digits+0x48>
    8000723a:	00000097          	auipc	ra,0x0
    8000723e:	9c2080e7          	jalr	-1598(ra) # 80006bfc <panic>

0000000080007242 <lockfree_read8>:

// Read a shared 64-bit value without holding a lock
uint64
lockfree_read8(uint64 *addr) {
    80007242:	1141                	addi	sp,sp,-16
    80007244:	e422                	sd	s0,8(sp)
    80007246:	0800                	addi	s0,sp,16
  uint64 val;
  __atomic_load(addr, &val, __ATOMIC_SEQ_CST);
    80007248:	0ff0000f          	fence
    8000724c:	6108                	ld	a0,0(a0)
...
0000000080007258 <lockfree_read4>:

// Read a shared 32-bit value without holding a lock
int
lockfree_read4(int *addr) {
    80007258:	1141                	addi	sp,sp,-16
    8000725a:	e422                	sd	s0,8(sp)
    8000725c:	0800                	addi	s0,sp,16
  uint32 val;
  __atomic_load(addr, &val, __ATOMIC_SEQ_CST);
    8000725e:	0ff0000f          	fence
    80007262:	4108                	lw	a0,0(a0)
    80007264:	0ff0000f          	fence
  return val;
}
    80007268:	2501                	sext.w	a0,a0
